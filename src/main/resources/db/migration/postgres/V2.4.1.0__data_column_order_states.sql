...
drop function create_expt_data_column_order_state(bigint, bigint, varchar, varchar, varchar, float8, varchar, boolean, boolean);
drop function function create_protocol_data_column_order_state(bigint, bigint, int, varchar, varchar, varchar, float8, varchar, varchar, varchar);
