...
public class ContainerQueryResultDTO {
    ...
    public String toJsonWithNestedStubs() {
        return new JSONSerializer().exclude("*.class")
                .include("results.lsTags", "results.lsLabels", "results.lsStates.lsValues",
                        "results.firstContainers.firstContainer.lsLabels",
                        "results.secondContainers.secondContainer.lsLabels")
                .transform(new ExcludeNulls(), void.class).serialize(this);
    }
    ...
    public String toJsonWithNestedFull() {
        return new JSONSerializer().exclude("*.class")
                .include("results.lsTags", "results.lsLabels", "results.lsStates.lsValues",
                        "results.firstContainers.firstContainer.lsStates.lsValues",
                        "results.firstContainers.firstContainer.lsLabels",
                        "results.secondContainers.secondContainer.lsStates.lsValues",
                        "results.secondContainers.secondContainer.lsLabels",
                        "results.firstContainers.lsStates.lsValues", "results.firstContainers.lsLabels",
                        "results.secondContainers.lsStates.lsValues", "results.secondContainers.lsLabels")
                .transform(new ExcludeNulls(), void.class).serialize(this);
    }
    ...
    public String toJsonStub() {
        return new JSONSerializer().exclude("*.class", "results.lsStates.lsThing")
                .include("results.lsTags", "results.lsLabels").prettyPrint(false)
                .transform(new ExcludeNulls(), void.class).serialize(this);
    }
