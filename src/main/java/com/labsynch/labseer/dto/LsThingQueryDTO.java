...
public class LsThingQueryDTO {
    ...
    public LsThingQueryDTO(LsThingQueryDTO queryDTO) {
        if (queryDTO.getCombineTermsWithAnd() != null)
            this.combineTermsWithAnd = queryDTO.getCombineTermsWithAnd();
    ...
    public Boolean getCombineTermsWithAnd() {
        return this.combineTermsWithAnd;
    }

    public void setCombineTermsWithAnd(Boolean combineTermsWithAnd) {
