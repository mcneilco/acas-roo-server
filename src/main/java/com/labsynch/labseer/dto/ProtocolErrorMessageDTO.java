...
public class ProtocolErrorMessageDTO {
    ...
    public String toJson() {
        return new JSONSerializer().exclude("*.class")
                .include("protocol.lsTags", "protocol.lsLabels", "protocol.lsStates.lsValues")
                .transform(new ExcludeNulls(), void.class).serialize(this);
    }

    @Transactional
    public String toJsonStub() {
        return new JSONSerializer().exclude("*.class", "protocol.lsStates")
                .include("protocol.lsTags", "protocol.lsLabels").transform(new ExcludeNulls(), void.class)
                .serialize(this);
    }
