...
public class Metalot {
    ...
    public String toJson() {
        String json = new JSONSerializer()
                .include("isosalts", "fileList", "lot", "lot.lotAliases", "lot.saltForm.parent.parentAliases")
                .exclude("*.class", "isosalts.saltForm", "fileList.lot")
    ...
    public static Collection<Metalot> fromJsonArrayToMetalots(String json) {
        return new JSONDeserializer<List<Metalot>>().use(null, ArrayList.class).use("values", Metalot.class)
                .deserialize(json);
    }
