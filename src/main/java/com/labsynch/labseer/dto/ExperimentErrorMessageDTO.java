...
public class ExperimentErrorMessageDTO {
    ...
    public String toJson() {
        return new JSONSerializer()
                .exclude("*.class", "experiment.lsStates.lsValues.lsState", "experiment.lsStates.experiment",
                        "experiment.analysisGroups.experiment", "experiment.lsLabels.experiment")
                .include("experiment.lsTags", "experiment.lsLabels", "experiment.lsStates.lsValues",
                        "experiment.analysisGroups.lsStates.lsValues", "experiment.analysisGroups.lsLabels",
                        "experiment.analysisGroups.treatmentGroups.lsStates.lsValues",
                        "experiment.analysisGroups.treatmentGroups.lsLabels",
                        "experiment.analysisGroups.treatmentGroups.subjects.lsStates.lsValues",
                        "experiment.analysisGroups.treatmentGroups.subjects.lsLabels")
    ...
    public String toPrettyJson() {
        return new JSONSerializer()
                .exclude("*.class", "experiment.lsStates.lsValues.lsState", "experiment.lsStates.experiment",
                        "experiment.analysisGroups.experiments", "experiment.lsLabels.experiment")
                .include("experiment.lsTags", "experiment.lsLabels", "experiment.lsStates.lsValues",
                        "experiment.analysisGroups", "experiment.analysisGroups.lsStates.lsValues",
                        "experiment.analysisGroups.lsLabels",
                        "experiment.analysisGroups.treatmentGroups.lsStates.lsValues",
                        "experiment.analysisGroups.treatmentGroups.lsLabels",
                        "experiment.analysisGroups.treatmentGroups.subjects.lsStates.lsValues",
                        "experiment.analysisGroups.treatmentGroups.subjects.lsLabels")
    ...
    public String toPrettyJsonStub() {
        return new JSONSerializer()
                .exclude("*.class", "experiment.lsStates.lsValues.lsState", "experiment.lsStates.experiment",
                        "experiment.analysisGroups", "experiment.lsLabels.experiment")
                .include("experiment.lsTags", "experiment.lsLabels", "experiment.lsStates.lsValues").prettyPrint(true)
                .transform(new ExcludeNulls(), void.class).serialize(this);
    }
    ...
    public String toJsonStub() {
        return new JSONSerializer()
                .exclude("*.class", "experiment.lsStates.lsValues.lsState", "experiment.lsStates.experiment",
                        "experiment.analysisGroups", "experiment.lsLabels.experiment")
                .include("experiment.lsTags", "experiment.lsLabels", "experiment.lsStates.lsValues").prettyPrint(false)
                .transform(new ExcludeNulls(), void.class).serialize(this);
    }
    ...
    public String toJsonStubWithAnalysisGroups() {
        return new JSONSerializer()
                .exclude("*.class", "experiment.lsStates.lsValues.lsState", "experiment.lsStates.experiment",
                        "experiment.lsLabels.experiment", "experiment.analysisGroups.subjects",
                        "experiment.analysisGroups.experiment")
                .include("experiment.lsTags", "experiment.lsLabels", "experiment.lsStates.lsValues",
    ...
    public String toJsonStubWithAnalysisGroupValues() {
        return new JSONSerializer()
                .exclude("*.class", "experiment.lsStates.lsValues.lsState", "experiment.lsStates.experiment",
                        ...
                        "experiment.analysisGroups.experiment")
                .include("experiment.lsTags", "experiment.lsLabels", "experiment.lsStates.lsValues",
                        "experiment.analysisGroups.lsStates.lsValues")
                .prettyPrint(false).transform(new ExcludeNulls(), void.class).serialize(this);
    }
    ...
    public String toJsonStubWithAnalysisGroupStates() {
        return new JSONSerializer()
                .exclude("*.class", "experiment.lsStates.lsValues.lsState", "experiment.lsStates.experiment",
                        ...
                        "experiment.analysisGroups.experiment")
                .include("experiment.lsTags", "experiment.lsLabels", "experiment.lsStates.lsValues",
                        "experiment.analysisGroups.lsStates")
                .prettyPrint(false).transform(new ExcludeNulls(), void.class).serialize(this);
    }
    ...
    public static String toJsonArray(Collection<ExperimentErrorMessageDTO> collection) {
        return new JSONSerializer()
                .include("experiment.lsTags", "experiment.lsLabels", "experiment.lsStates.lsValues",
                        ...
                        "experiment.analysisGroups.treatmentGroups.subjects.lsLabels")
                .exclude("*.class", "experiment.lsStates.lsValues.lsState", "experiment.lsStates.experiment",
                        "experiment.analysisGroups.experiment", "experiment.analysisGroups.subject",
                        "experiment.lsLabels.experiment")
    ...
    public static String toJsonArrayStub(Collection<ExperimentErrorMessageDTO> collection) {
        return new JSONSerializer().include("experiment.lsTags", "experiment.lsLabels", "experiment.lsStates.lsValues")
                .exclude("*.class", "experiment.analysisGroups", "experiment.lsStates.lsValues.lsState",
                        "experiment.lsStates.experiment", "experiment.analysisGroups.experiment",
                        "experiment.lsLabels.experiment")
                .transform(new ExcludeNulls(), void.class).serialize(collection);
    }
    ...
    public static String toJsonArrayStubWithAG(Collection<ExperimentErrorMessageDTO> collection) {
        return new JSONSerializer()
                .include("experiment.lsTags", "experiment.lsLabels", "experiment.lsStates.lsValues",
                        "experiment.analysisGroups")
                .exclude("*.class", "experiment.lsStates.lsValues.lsState", "experiment.lsStates.experiment",
                        "experiment.analysisGroups.experiment", "experiment.analysisGroups.subjects",
                        "experiment.lsLabels.experiment")
                .transform(new ExcludeNulls(), void.class).serialize(collection);
    }
