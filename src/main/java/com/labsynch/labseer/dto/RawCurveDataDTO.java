...
public class RawCurveDataDTO {
	...
	private Long responseSubjectValueId; // location: subject value, SS: data_results, SV: numericValue_Response, id
											// attribute
	...
	private BigDecimal dose; // location: subject value, SS: data_test compound treatment, SV:
								// numericValue_Dose
