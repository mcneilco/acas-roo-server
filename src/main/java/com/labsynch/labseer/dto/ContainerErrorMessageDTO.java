...
public class ContainerErrorMessageDTO {
    ...
    public String toJson() {
        return new JSONSerializer()
                .include("container.lsStates.lsValues", "container.lsLabels", "definition.lsStates.lsValues",
                        "definition.lsLabels")
    ...
    public static String toJsonArray(Collection<ContainerErrorMessageDTO> collection) {
        return new JSONSerializer()
                .include("container.lsStates.lsValues", "container.lsLabels", "definition.lsStates.lsValues",
                        "definition.lsLabels")
                .exclude("*.class").transform(new ExcludeNulls(), void.class).serialize(collection);
    }
