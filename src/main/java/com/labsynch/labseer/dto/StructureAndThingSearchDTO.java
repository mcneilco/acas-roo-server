...
public class StructureAndThingSearchDTO {
    ...
    public StructureAndThingSearchDTO(LsThingQueryDTO lsThingQueryDTO, String queryMol, String searchType,
    ...
    public String toJson() {
        return new JSONSerializer().exclude("*.class").include("lsThingQueryDTO.labels", "lsThingQueryDTO.values")
                .serialize(this);
    }

    public static StructureAndThingSearchDTO fromJsonToStructureAndThingSearchDTO(String json) {
        return new JSONDeserializer<StructureAndThingSearchDTO>().use(null, StructureAndThingSearchDTO.class)
                .deserialize(json);
    }
    ...
    public static Collection<StructureAndThingSearchDTO> fromJsonArrayToStructureAndThingSearchDTO(String json) {
        return new JSONDeserializer<List<StructureAndThingSearchDTO>>().use(null, ArrayList.class)
                .use("values", StructureAndThingSearchDTO.class).deserialize(json);
    }
