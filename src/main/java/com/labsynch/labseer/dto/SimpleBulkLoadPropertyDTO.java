...
public class SimpleBulkLoadPropertyDTO {
	...
	public String toJson() {
		return new JSONSerializer().exclude("*.class", "class")
				.include("name", "dataType", "required", "displayOrder", "ignored")
	...
	public int hashCode() {
		...
		if (dataType != null)
			dataTypeHashCode += dataType.hashCode();
		if (required != null)
			requiredHashCode += required.hashCode();
		if (displayOrder != null)
			displayOrderHashCode += displayOrder.hashCode();
		if (ignored != null)
			ignoredHashCode += ignored.hashCode();
		return nameHashCode + dataTypeHashCode + requiredHashCode + displayOrderHashCode + ignoredHashCode;
	}

	@Override
	public boolean equals(Object that) {
		if (that.getClass() != SimpleBulkLoadPropertyDTO.class)
			return false;
		else {
			SimpleBulkLoadPropertyDTO thatDTO = (SimpleBulkLoadPropertyDTO) that;
			boolean nameEqual = false;
			if (this.name == null && thatDTO.name == null)
				nameEqual = true;
			else if (this.name == null && thatDTO.name != null)
				nameEqual = false;
			else if (this.name != null && thatDTO.name == null)
				nameEqual = false;
			else if (this.name != null && thatDTO.name != null)
				nameEqual = this.name.equals(thatDTO.name);
			boolean dataTypeEqual = false;
			if (this.dataType == null && thatDTO.dataType == null)
				dataTypeEqual = true;
			else if (this.dataType == null && thatDTO.dataType != null)
				dataTypeEqual = false;
			else if (this.dataType != null && thatDTO.dataType == null)
				dataTypeEqual = false;
			else if (this.dataType != null && thatDTO.dataType != null)
				dataTypeEqual = this.dataType.equals(thatDTO.dataType);
			boolean requiredEqual = false;
			if (this.required == null && thatDTO.required == null)
				requiredEqual = true;
			else if (this.required == null && thatDTO.required != null)
				requiredEqual = false;
			else if (this.required != null && thatDTO.required == null)
				requiredEqual = false;
			else if (this.required != null && thatDTO.required != null)
				requiredEqual = this.required.equals(thatDTO.required);
			boolean displayOrderEqual = false;
			if (this.displayOrder == null && thatDTO.displayOrder == null)
				displayOrderEqual = true;
			else if (this.displayOrder == null && thatDTO.displayOrder != null)
				displayOrderEqual = false;
			else if (this.displayOrder != null && thatDTO.displayOrder == null)
				displayOrderEqual = false;
			else if (this.displayOrder != null && thatDTO.displayOrder != null)
				displayOrderEqual = this.displayOrder.equals(thatDTO.displayOrder);
			boolean ignoredEqual = false;
			if (this.ignored == null && thatDTO.ignored == null)
				ignoredEqual = true;
			else if (this.ignored == null && thatDTO.ignored != null)
				ignoredEqual = false;
			else if (this.ignored != null && thatDTO.ignored == null)
				ignoredEqual = false;
			else if (this.ignored != null && thatDTO.ignored != null)
				ignoredEqual = this.ignored.equals(thatDTO.ignored);
