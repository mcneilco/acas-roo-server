...
public class PreferredNameResultsDTO {
    ...
    public static PreferredNameResultsDTO fromJsonToPreferredNameResultsDTO(String json) {
        return new JSONDeserializer<PreferredNameResultsDTO>().use(null, PreferredNameResultsDTO.class)
                .deserialize(json);
    }
    ...
    public static Collection<PreferredNameResultsDTO> fromJsonArrayToPreferredNameResultsDTO(String json) {
        return new JSONDeserializer<List<PreferredNameResultsDTO>>().use(null, ArrayList.class)
                .use("values", PreferredNameResultsDTO.class).deserialize(json);
    }
