...
public class ContainerLocationTreeDTO {
    ...
    public ContainerLocationTreeDTO(String codeName, String parentCodeName, String labelText, String codeTree,
            String labelTree,
            Integer level, String rootCodeName, String codeNameBreadcrumb, String labelTextBreadcrumb, String lsType,
            String lsKind) {
