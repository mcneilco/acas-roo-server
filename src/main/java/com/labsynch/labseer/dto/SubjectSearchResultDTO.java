...
public class SubjectSearchResultDTO {
    ...
    public String toJsonWithNestedStubs() {
        return new JSONSerializer().exclude("*.class")
                .include("results.lsTags", "results.lsLabels", "results.lsStates.lsValues",
                        "results.firstSubjects.firstSubject.lsLabels", "results.secondSubjects.secondSubject.lsLabels")
                .transform(new ExcludeNulls(), void.class).serialize(this);
    }
    ...
    public String toJsonWithNestedFull() {
        return new JSONSerializer().exclude("*.class").include("results.lsTags", "results.lsLabels",
                "results.lsStates.lsValues", "results.firstSubjects.firstSubject.lsStates.lsValues",
                "results.firstSubjects.firstSubject.lsLabels", "results.secondSubjects.secondSubject.lsStates.lsValues",
                "results.secondSubjects.secondSubject.lsLabels", "results.firstSubjects.lsStates.lsValues",
                "results.firstSubjects.lsLabels", "results.secondSubjects.lsStates.lsValues",
                "results.secondSubjects.lsLabels").transform(new ExcludeNulls(), void.class).serialize(this);
    }

    @Transactional
    public String toPrettyJson() {
        return new JSONSerializer()
                .exclude("*.class", "results.lsStates.lsValues.lsState", "results.lsStates.subject",
                        "results.lsLabels.subject")
