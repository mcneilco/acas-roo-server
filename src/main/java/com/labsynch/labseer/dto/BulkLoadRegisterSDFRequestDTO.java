...
public class BulkLoadRegisterSDFRequestDTO {
    ...
    public BulkLoadRegisterSDFRequestDTO(String filePath, String userName, Date fileDate, Boolean validate,
    ...
    public String toJson() {
        return new JSONSerializer()
                .include("filePath", "fileDate", "userName", "validate", "mappings").exclude("*.class")
