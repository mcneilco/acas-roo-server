...
public class ValidationResponseDTO {
    ...
    public ValidationResponseDTO(String level, int record, String categoryCode, String categoryDescription,
            String message) {
        this.level = level;
        this.record = record;
    ...
    public String toJson() {
        return new JSONSerializer()
                .include("level", "record", "categoryCode", "categoryDescription", "message").exclude("*.class")
