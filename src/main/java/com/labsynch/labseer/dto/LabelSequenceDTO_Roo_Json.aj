...
privileged aspect LabelSequenceDTO_Roo_Json {
    ...
    public String LabelSequenceDTO.toJson(String[] fields) {
        return new JSONSerializer()
    ...
    public static String LabelSequenceDTO.toJsonArray(Collection<LabelSequenceDTO> collection, String[] fields) {
        return new JSONSerializer()
