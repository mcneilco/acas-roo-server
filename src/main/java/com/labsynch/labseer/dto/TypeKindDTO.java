...
public class TypeKindDTO {
	...
	public static Collection<ProtocolKind> getOrCreateProtocolKinds(
		...
		for (TypeKindDTO typeKind : typeKinds) {
			...
			try {
				protocolKind = ProtocolKind
						.findProtocolKindsByLsTypeEqualsAndKindNameEquals(protocolType, typeKind.kindName)
						.getSingleResult();
	...
	public static Collection<ExperimentKind> getOrCreateExperimentKinds(
		...
		for (TypeKindDTO typeKind : typeKinds) {
			...
			try {
				experimentType = ExperimentType.findExperimentTypesByTypeNameEquals(typeKind.typeName)
						.getSingleResult();
			} catch (Exception e) {
			...
			try {
				experimentKind = ExperimentKind
						.findExperimentKindsByLsTypeEqualsAndKindNameEquals(experimentType, typeKind.kindName)
						.getSingleResult();
			} catch (NoResultException e) {
	...
	public static Collection<InteractionKind> getOrCreateInteractionKinds(
		...
		for (TypeKindDTO typeKind : typeKinds) {
			...
			try {
				interactionType = InteractionType.findInteractionTypesByTypeNameEquals(typeKind.typeName)
						.getSingleResult();
			} catch (Exception e) {
			...
			try {
				interactionKind = InteractionKind
						.findInteractionKindsByKindNameEqualsAndLsType(typeKind.kindName, interactionType)
						.getSingleResult();
			} catch (NoResultException e) {
	...
	public static Collection<ContainerKind> getOrCreateContainerKinds(
		...
		for (TypeKindDTO typeKind : typeKinds) {
			...
			try {
				containerKind = ContainerKind
						.findContainerKindsByKindNameEqualsAndLsType(typeKind.kindName, containerType)
						.getSingleResult();
			} catch (NoResultException e) {
	...
	public static Collection<StateKind> getOrCreateStateKinds(
		...
		for (TypeKindDTO typeKind : typeKinds) {
			...
			StateKind stateKind;
			try {
				stateKind = StateKind.findStateKindsByKindNameEqualsAndLsType(typeKind.kindName, stateType)
						.getSingleResult();
			} catch (NoResultException e) {
	...
	public static Collection<ValueKind> getOrCreateValueKinds(
		...
		for (TypeKindDTO typeKind : typeKinds) {
			...
			ValueKind valueKind;
			try {
				valueKind = ValueKind.findValueKindsByKindNameEqualsAndLsType(typeKind.kindName, valueType)
						.getSingleResult();
			} catch (NoResultException e) {
	...
	public static Collection<ThingKind> getOrCreateThingKinds(
		...
		for (TypeKindDTO typeKind : typeKinds) {
			...
			ThingKind thingKind;
			try {
				thingKind = ThingKind.findThingKindsByKindNameEqualsAndLsType(typeKind.kindName, thingType)
						.getSingleResult();
			} catch (NoResultException e) {
	...
	public static Collection<OperatorKind> getOrCreateOperatorKinds(
		...
		for (TypeKindDTO typeKind : typeKinds) {
			...
			try {
				operatorKind = OperatorKind.findOperatorKindsByKindNameEqualsAndLsType(typeKind.kindName, operatorType)
						.getSingleResult();
			} catch (NoResultException e) {
	...
	public static Collection<UnitKind> getOrCreateUnitKinds(
		...
		for (TypeKindDTO typeKind : typeKinds) {
			...
			UnitKind unitKind;
			try {
				unitKind = UnitKind.findUnitKindsByKindNameEqualsAndLsType(typeKind.kindName, unitType)
						.getSingleResult();
			} catch (NoResultException e) {
	...
	public static Collection<DDictKind> getOrCreateDDictKinds(
		...
		for (TypeKindDTO typeKind : typeKinds) {
			...
			DDictKind dDictKind;
			try {
				dDictKind = DDictKind.findDDictKindsByLsTypeEqualsAndNameEquals(dDictType.getName(), typeKind.kindName)
						.getSingleResult();
			} catch (NoResultException e) {
	...
	public static Collection<RoleKind> getOrCreateRoleKinds(
		...
		for (TypeKindDTO typeKind : typeKinds) {
			...
			RoleKind roleKind;
			try {
				roleKind = RoleKind.findRoleKindsByKindNameEqualsAndLsType(typeKind.kindName, roleType)
						.getSingleResult();
			} catch (NoResultException e) {
