...
public class BBChemParentStructure extends AbstractBBChemStructure {
    ...
    public static List<BBChemParentStructure> findBBChemParentStructuresBySubstructure(BitSet substructure,
            int maxResults) {
    ...
    public static long countBBChemParentStructures() {
        return entityManager().createQuery("SELECT COUNT(o) FROM BBChemParentStructure o", Long.class)
                .getSingleResult();
    }

    public static List<BBChemParentStructure> findAllBBChemParentStructures() {
        return entityManager().createQuery("SELECT o FROM BBChemParentStructure o", BBChemParentStructure.class)
                .getResultList();
    }
    ...
    public static List<BBChemParentStructure> findBBChemParentStructureEntries(int firstResult, int maxResults,
        ...
        return entityManager().createQuery(jpaQuery, BBChemParentStructure.class).setFirstResult(firstResult)
    ...
    public static Long countFindBBChemParentStructuresByPreRegEquals(String preReg) {
        ...
        EntityManager em = BBChemParentStructure.entityManager();
        TypedQuery q = em.createQuery("SELECT COUNT(o) FROM BBChemParentStructure AS o WHERE o.preReg = :preReg",
                Long.class);
    ...
    public static TypedQuery<BBChemParentStructure> findBBChemParentStructuresByPreRegEquals(String preReg) {
        if (preReg == null || preReg.length() == 0)
            throw new IllegalArgumentException("The preReg argument is required");
        EntityManager em = BBChemParentStructure.entityManager();
        TypedQuery<BBChemParentStructure> q = em.createQuery(
                "SELECT o FROM BBChemParentStructure AS o WHERE o.preReg = :preReg", BBChemParentStructure.class);
        q.setParameter("preReg", preReg);
        return q;
    }
    ...
    public static TypedQuery<BBChemParentStructure> findBBChemParentStructuresByPreRegEquals(String preReg,
        ...
        StringBuilder queryBuilder = new StringBuilder(
                "SELECT o FROM BBChemParentStructure AS o WHERE o.preReg = :preReg");
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
    ...
    public static TypedQuery<BBChemParentStructure> findBBChemParentStructuresByRegEquals(String reg) {
        ...
        EntityManager em = BBChemParentStructure.entityManager();
        TypedQuery<BBChemParentStructure> q = em.createQuery(
                "SELECT o FROM BBChemParentStructure AS o WHERE o.reg = :reg", BBChemParentStructure.class);
        q.setParameter("reg", reg);
        return q;
    }
