...
public class BBChemSaltStructure extends AbstractBBChemStructure {
    ...
    public static Long countFindBBChemSaltStructuresByPreRegEquals(String preReg) {
        ...
        TypedQuery q = em.createQuery("SELECT COUNT(o) FROM BBChemSaltStructure AS o WHERE o.preReg = :preReg",
                Long.class);
    ...
    public static TypedQuery<BBChemSaltStructure> findBBChemSaltStructuresByPreRegEquals(String preReg) {
        if (preReg == null || preReg.length() == 0)
            throw new IllegalArgumentException("The preReg argument is required");
        EntityManager em = BBChemSaltStructure.entityManager();
        TypedQuery<BBChemSaltStructure> q = em.createQuery(
                "SELECT o FROM BBChemSaltStructure AS o WHERE o.preReg = :preReg", BBChemSaltStructure.class);
        q.setParameter("preReg", preReg);
        return q;
    }
    ...
    public static TypedQuery<BBChemSaltStructure> findBBChemSaltStructuresByPreRegEquals(String preReg,
        ...
        StringBuilder queryBuilder = new StringBuilder(
                "SELECT o FROM BBChemSaltStructure AS o WHERE o.preReg = :preReg");
    ...
    public static TypedQuery<BBChemSaltStructure> findBBChemSaltStructuresByRegEquals(String reg) {
        if (reg == null || reg.length() == 0)
            throw new IllegalArgumentException("The reg argument is required");
        EntityManager em = BBChemSaltStructure.entityManager();
        TypedQuery<BBChemSaltStructure> q = em.createQuery("SELECT o FROM BBChemSaltStructure AS o WHERE o.reg = :reg",
                BBChemSaltStructure.class);
        q.setParameter("reg", reg);
        return q;
    }

    public static TypedQuery<BBChemSaltStructure> findBBChemSaltStructuresByRegEquals(String reg, String sortFieldName,
            String sortOrder) {
        if (reg == null || reg.length() == 0)
            throw new IllegalArgumentException("The reg argument is required");
        EntityManager em = BBChemSaltStructure.entityManager();
    ...
    public static List<BBChemSaltStructure> findAllBBChemSaltStructures() {
        return entityManager().createQuery("SELECT o FROM BBChemSaltStructure o", BBChemSaltStructure.class)
                .getResultList();
    }
    ...
    public static List<BBChemSaltStructure> findBBChemSaltStructureEntries(int firstResult, int maxResults,
        ...
        return entityManager().createQuery(jpaQuery, BBChemSaltStructure.class).setFirstResult(firstResult)
