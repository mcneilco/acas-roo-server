...
public class BBChemDryRunStructure extends AbstractBBChemStructure {
    ...
    public static long countBBChemDryRunStructures() {
        return entityManager().createQuery("SELECT COUNT(o) FROM BBChemDryRunStructure o", Long.class)
                .getSingleResult();
    }

    public static List<BBChemDryRunStructure> findAllBBChemDryRunStructures() {
        return entityManager().createQuery("SELECT o FROM BBChemDryRunStructure o", BBChemDryRunStructure.class)
                .getResultList();
    }
    ...
    public static List<BBChemDryRunStructure> findBBChemDryRunStructureEntries(int firstResult, int maxResults,
        ...
        return entityManager().createQuery(jpaQuery, BBChemDryRunStructure.class).setFirstResult(firstResult)
    ...
    public static Long countFindBBChemDryRunStructuresByPreRegEquals(String preReg) {
        ...
        TypedQuery q = em.createQuery("SELECT COUNT(o) FROM BBChemDryRunStructure AS o WHERE o.preReg = :preReg",
                Long.class);
    ...
    public static TypedQuery<BBChemDryRunStructure> findBBChemDryRunStructuresByPreRegEquals(String preReg) {
        if (preReg == null || preReg.length() == 0)
            throw new IllegalArgumentException("The preReg argument is required");
        EntityManager em = BBChemDryRunStructure.entityManager();
        TypedQuery<BBChemDryRunStructure> q = em.createQuery(
                "SELECT o FROM BBChemDryRunStructure AS o WHERE o.preReg = :preReg", BBChemDryRunStructure.class);
        q.setParameter("preReg", preReg);
        return q;
    }
    ...
    public static TypedQuery<BBChemDryRunStructure> findBBChemDryRunStructuresByPreRegEquals(String preReg,
        ...
        StringBuilder queryBuilder = new StringBuilder(
                "SELECT o FROM BBChemDryRunStructure AS o WHERE o.preReg = :preReg");
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
    ...
    public static TypedQuery<BBChemDryRunStructure> findBBChemDryRunStructuresByRegEquals(String reg) {
        ...
        EntityManager em = BBChemDryRunStructure.entityManager();
        TypedQuery<BBChemDryRunStructure> q = em.createQuery(
                "SELECT o FROM BBChemDryRunStructure AS o WHERE o.reg = :reg", BBChemDryRunStructure.class);
        q.setParameter("reg", reg);
        return q;
    }
