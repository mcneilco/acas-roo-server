...
public class BBChemStandardizationDryRunStructure extends AbstractBBChemStructure {
    ...
    public static Long countFindBBChemStandardizationDryRunStructuresByPreRegEquals(String preReg) {
        ...
        TypedQuery q = em.createQuery(
                "SELECT COUNT(o) FROM BBChemStandardizationDryRunStructure AS o WHERE o.preReg = :preReg", Long.class);
    ...
    public static Long countFindBBChemStandardizationDryRunStructuresByRegEquals(String reg) {
        ...
        EntityManager em = BBChemStandardizationDryRunStructure.entityManager();
        TypedQuery q = em.createQuery(
                "SELECT COUNT(o) FROM BBChemStandardizationDryRunStructure AS o WHERE o.reg = :reg", Long.class);
        q.setParameter("reg", reg);
        return ((Long) q.getSingleResult());
    }

    public static TypedQuery<BBChemStandardizationDryRunStructure> findBBChemStandardizationDryRunStructuresByPreRegEquals(
            String preReg) {
        if (preReg == null || preReg.length() == 0)
            throw new IllegalArgumentException("The preReg argument is required");
        EntityManager em = BBChemStandardizationDryRunStructure.entityManager();
        TypedQuery<BBChemStandardizationDryRunStructure> q = em.createQuery(
                "SELECT o FROM BBChemStandardizationDryRunStructure AS o WHERE o.preReg = :preReg",
                BBChemStandardizationDryRunStructure.class);
        q.setParameter("preReg", preReg);
        return q;
    }

    public static TypedQuery<BBChemStandardizationDryRunStructure> findBBChemStandardizationDryRunStructuresByPreRegEquals(
            String preReg, String sortFieldName, String sortOrder) {
        if (preReg == null || preReg.length() == 0)
            throw new IllegalArgumentException("The preReg argument is required");
        EntityManager em = BBChemStandardizationDryRunStructure.entityManager();
        ...
        TypedQuery<BBChemStandardizationDryRunStructure> q = em.createQuery(queryBuilder.toString(),
                BBChemStandardizationDryRunStructure.class);
        q.setParameter("preReg", preReg);
        return q;
    }

    public static TypedQuery<BBChemStandardizationDryRunStructure> findBBChemStandardizationDryRunStructuresByRegEquals(
            String reg) {
        if (reg == null || reg.length() == 0)
            throw new IllegalArgumentException("The reg argument is required");
        EntityManager em = BBChemStandardizationDryRunStructure.entityManager();
        TypedQuery<BBChemStandardizationDryRunStructure> q = em.createQuery(
                "SELECT o FROM BBChemStandardizationDryRunStructure AS o WHERE o.reg = :reg",
                BBChemStandardizationDryRunStructure.class);
        q.setParameter("reg", reg);
        return q;
    }
    ...
    public static TypedQuery<BBChemStandardizationDryRunStructure> findBBChemStandardizationDryRunStructuresByRegEquals(
            String reg, String sortFieldName, String sortOrder) {
        if (reg == null || reg.length() == 0)
            throw new IllegalArgumentException("The reg argument is required");
        EntityManager em = BBChemStandardizationDryRunStructure.entityManager();
        StringBuilder queryBuilder = new StringBuilder(
    ...
    public static long countBBChemStandardizationDryRunStructures() {
        return entityManager().createQuery("SELECT COUNT(o) FROM BBChemStandardizationDryRunStructure o", Long.class)
                .getSingleResult();
    }

    public static List<BBChemStandardizationDryRunStructure> findAllBBChemStandardizationDryRunStructures() {
        return entityManager().createQuery("SELECT o FROM BBChemStandardizationDryRunStructure o",
                BBChemStandardizationDryRunStructure.class).getResultList();
    }
    ...
    public static List<BBChemStandardizationDryRunStructure> findBBChemStandardizationDryRunStructureEntries(
            int firstResult, int maxResults) {
        return entityManager()
                .createQuery("SELECT o FROM BBChemStandardizationDryRunStructure o",
                        BBChemStandardizationDryRunStructure.class)
    ...
    public static List<BBChemStandardizationDryRunStructure> findBBChemStandardizationDryRunStructureEntries(
        ...
        return entityManager().createQuery(jpaQuery, BBChemStandardizationDryRunStructure.class)
                .setFirstResult(firstResult).setMaxResults(maxResults).getResultList();
    }
    ...
    public static Collection<BBChemStandardizationDryRunStructure> fromJsonArrayToBBChemStandardizationDryRunStructures(
            String json) {
