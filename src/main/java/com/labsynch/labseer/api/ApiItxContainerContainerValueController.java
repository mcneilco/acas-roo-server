...
@Controller
@RequestMapping("api/v1/itxcontainercontainervalues")
@Transactional
public class ApiItxContainerContainerValueController {

    private static final Logger logger = LoggerFactory.getLogger(ApiItxContainerContainerValueController.class);
        ...
        try {
            ...
            while (jsonTokens.more()) {
                ...
                if (delimiter != END_OF_ARRAY) {
                    ...
                    ItxContainerContainerValue itxContainerContainerValue = ItxContainerContainerValue
                            .fromJsonToItxContainerContainerValue(token.toString());
                    itxContainerContainerValue.persist();
                    if (i % batchSize == 0) {
    ...
    public ResponseEntity<java.lang.String> createFromJsonArray(@RequestBody String json) {
        ...
        try {
            ...
            for (ItxContainerContainerValue itxContainerContainerValue : ItxContainerContainerValue
                    .fromJsonArrayToItxContainerContainerValues(br)) {
                itxContainerContainerValue.persist();
                if (i % batchSize == 0) {
                    itxContainerContainerValue.flush();
                    itxContainerContainerValue.clear();
