...
////////////// copied from experiment controller
    ...
    public ResponseEntity<java.lang.String> getGeneCodeData(@RequestBody ExperimentSearchRequestDTO searchRequest, @RequestParam(value = "format", required = false) String format) {
