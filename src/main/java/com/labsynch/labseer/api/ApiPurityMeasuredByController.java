    ...
    public ResponseEntity<String> listJson() {
        ...
        if (propertiesUtilService.getOrderSelectLists()) {
            return new ResponseEntity<String>(
                    PurityMeasuredBy.toJsonArray(PurityMeasuredBy.findAllPurityMeasuredBys("name", "ASC")), headers,
                    HttpStatus.OK);
        } else {
            return new ResponseEntity<String>(PurityMeasuredBy.toJsonArray(PurityMeasuredBy.findAllPurityMeasuredBys()),
