...
public class ApiStateController {
	...
	public ResponseEntity<String> getStateByPath(
		...
		if (entity.equals("experiment")) {
			ExperimentState experimentState = experimentStateService.getExperimentState(idOrCodeName, stateType,
					stateKind);
		...
		if (entity.equals("analysisGroup")) {
			AnalysisGroupState analysisGroupState = analysisGroupStateService.getAnalysisGroupState(idOrCodeName,
					stateType, stateKind);
		...
		if (entity.equals("treatmentGroup")) {
			TreatmentGroupState treatmentGroupState = treatmentGroupStateService.getTreatmentGroupState(idOrCodeName,
					stateType, stateKind);
	...
	public ResponseEntity<String> getStatesByPaths(
		...
		Collection<GenericStatePathRequest> genericRequests = GenericStatePathRequest
				.fromJsonArrayToGenericStatePathRequests(json);
		HttpHeaders headers = new HttpHeaders();
		headers.add("Content-Type", "application/json; charset=utf-8");
		// this if/else if block controls which lsThing is being hit
		logger.debug("ENTITY IS: " + entity);
		...
		if (entity.equals("analysisGroup")) {
			Collection<AnalysisGroupStatePathDTO> results = analysisGroupStateService
					.getAnalysisGroupStates(genericRequests);
			return new ResponseEntity<String>(AnalysisGroupStatePathDTO.toJsonArray(results), headers, HttpStatus.OK);
		}
		if (entity.equals("treatmentGroup")) {
			Collection<TreatmentGroupStatePathDTO> results = treatmentGroupStateService
					.getTreatmentGroupStates(genericRequests);
	...
	public ResponseEntity<String> listProtocolStatesJsonArray() {
		...
		for (ProtocolState protocolState : result) {
			if (!protocolState.isIgnored())
				finalResult.add(protocolState);
		}
	...
	public ResponseEntity<String> listExperimentStatesJsonArray() {
		...
		for (ExperimentState experimentState : result) {
			if (!experimentState.isIgnored())
				finalResult.add(experimentState);
		}
	...
	public ResponseEntity<String> listAnalysisGroupStatesJsonArray() {
		...
		for (AnalysisGroupState analysisGroupState : result) {
			if (!analysisGroupState.isIgnored())
				finalResult.add(analysisGroupState);
		}
	...
	public ResponseEntity<String> listTreatmentGroupStatesJsonArray() {
		...
		for (TreatmentGroupState treatmentGroupState : result) {
			if (!treatmentGroupState.isIgnored())
				finalResult.add(treatmentGroupState);
		}
	...
	public ResponseEntity<String> listSubjectStatesJsonArray() {
		...
		for (SubjectState subjectState : result) {
			if (!subjectState.isIgnored())
				finalResult.add(subjectState);
		}
	...
	public ResponseEntity<String> listLsThingStatesJsonArray() {
		...
		for (LsThingState lsThingState : result) {
			if (!lsThingState.isIgnored())
				finalResult.add(lsThingState);
		}
	...
	public ResponseEntity<String> listContainerStatesJsonArray() {
		...
		for (ContainerState containerState : result) {
			if (!containerState.isIgnored())
				finalResult.add(containerState);
		}
	...
	public ResponseEntity<String> listItxContainerContainerStatesJsonArray() {
		...
		for (ItxContainerContainerState itxContainerContainerState : result) {
			if (!itxContainerContainerState.isIgnored())
				finalResult.add(itxContainerContainerState);
		}
	...
	public ResponseEntity<String> listItxExperimentExperimentStatesJsonArray() {
		...
		for (ItxExperimentExperimentState itxExperimentExperimentState : result) {
			if (!itxExperimentExperimentState.isIgnored())
				finalResult.add(itxExperimentExperimentState);
		}
		return new ResponseEntity<String>(ItxExperimentExperimentState.toJsonArray(finalResult), headers,
				HttpStatus.OK);
	}
	...
	public ResponseEntity<String> listItxProtocolProtocolStatesJsonArray() {
		...
		for (ItxProtocolProtocolState itxProtocolProtocolState : result) {
			if (!itxProtocolProtocolState.isIgnored())
				finalResult.add(itxProtocolProtocolState);
		}
	...
	public ResponseEntity<String> listItxSubjectContainerStatesJsonArray() {
		...
		for (ItxSubjectContainerState itxSubjectContainerState : result) {
			if (!itxSubjectContainerState.isIgnored())
				finalResult.add(itxSubjectContainerState);
		}
	...
	public ResponseEntity<String> showContainerStateJson(@PathVariable("id") Long id) {
		...
		if (containerState == null || containerState.isIgnored())
			return new ResponseEntity<String>(headers, HttpStatus.NOT_FOUND);
		return new ResponseEntity<String>(containerState.toJson(), headers, HttpStatus.OK);
	}
	...
	public ResponseEntity<String> showItxContainerContainerStateJson(@PathVariable("id") Long id) {
		HttpHeaders headers = new HttpHeaders();
		headers.add("Content-Type", "application/json; charset=utf-8");
		ItxContainerContainerState itxContainerContainerState = ItxContainerContainerState
				.findItxContainerContainerState(id);
		if (itxContainerContainerState == null || itxContainerContainerState.isIgnored())
			return new ResponseEntity<String>(headers, HttpStatus.NOT_FOUND);
	...
	public ResponseEntity<String> showItxExperimentExperimentStateJson(@PathVariable("id") Long id) {
		HttpHeaders headers = new HttpHeaders();
		headers.add("Content-Type", "application/json; charset=utf-8");
		ItxExperimentExperimentState itxExperimentExperimentState = ItxExperimentExperimentState
				.findItxExperimentExperimentState(id);
		if (itxExperimentExperimentState == null || itxExperimentExperimentState.isIgnored())
			return new ResponseEntity<String>(headers, HttpStatus.NOT_FOUND);
	...
	public ResponseEntity<String> showItxProtocolProtocolStateJson(@PathVariable("id") Long id) {
		...
		if (itxProtocolProtocolState == null || itxProtocolProtocolState.isIgnored())
			return new ResponseEntity<String>(headers, HttpStatus.NOT_FOUND);
	...
	public ResponseEntity<String> showItxSubjectContainerStateJson(@PathVariable("id") Long id) {
		...
		if (itxSubjectContainerState == null || itxSubjectContainerState.isIgnored())
			return new ResponseEntity<String>(headers, HttpStatus.NOT_FOUND);
	...
	@ResponseBody
	@Transactional
	public ResponseEntity<String> updateTreatmentGroupStateFromJson(
			@RequestBody TreatmentGroupState treatmentGroupState) {
		HttpHeaders headers = new HttpHeaders();
		headers.add("Content-Type", "application/json; charset=utf-8");
	...
	@ResponseBody
	@Transactional
	public ResponseEntity<String> updateItxContainerContainerStateFromJson(
			@RequestBody ItxContainerContainerState itxContainerContainerState) {
		HttpHeaders headers = new HttpHeaders();
		headers.add("Content-Type", "application/json; charset=utf-8");
		if (ItxContainerContainerState.findItxContainerContainerState(itxContainerContainerState.getId()) == null) {
			return new ResponseEntity<String>(headers, HttpStatus.NOT_FOUND);
		}
		itxContainerContainerState = itxContainerContainerStateService
				.updateItxContainerContainerState(itxContainerContainerState);
		return new ResponseEntity<String>(itxContainerContainerState.toJson(), headers, HttpStatus.OK);
	}
	...
	@ResponseBody
	@Transactional
	public ResponseEntity<String> updateItxExperimentExperimentStateFromJson(
			@RequestBody ItxExperimentExperimentState itxExperimentExperimentState) {
		HttpHeaders headers = new HttpHeaders();
		headers.add("Content-Type", "application/json; charset=utf-8");
		if (ItxExperimentExperimentState
				.findItxExperimentExperimentState(itxExperimentExperimentState.getId()) == null) {
			return new ResponseEntity<String>(headers, HttpStatus.NOT_FOUND);
		}
		itxExperimentExperimentState = itxExperimentExperimentStateService
				.updateItxExperimentExperimentState(itxExperimentExperimentState);
		return new ResponseEntity<String>(itxExperimentExperimentState.toJson(), headers, HttpStatus.OK);
	}
	...
	@ResponseBody
	@Transactional
	public ResponseEntity<String> updateItxProtocolProtocolStateFromJson(
			@RequestBody ItxProtocolProtocolState itxProtocolProtocolState) {
		HttpHeaders headers = new HttpHeaders();
		headers.add("Content-Type", "application/json; charset=utf-8");
		if (ItxProtocolProtocolState.findItxProtocolProtocolState(itxProtocolProtocolState.getId()) == null) {
			return new ResponseEntity<String>(headers, HttpStatus.NOT_FOUND);
		}
		itxProtocolProtocolState = itxProtocolProtocolStateService
				.updateItxProtocolProtocolState(itxProtocolProtocolState);
		return new ResponseEntity<String>(itxProtocolProtocolState.toJson(), headers, HttpStatus.OK);
	}
	...
	@ResponseBody
	@Transactional
	public ResponseEntity<String> updateItxSubjectContainerStateFromJson(
			@RequestBody ItxSubjectContainerState itxSubjectContainerState) {
		HttpHeaders headers = new HttpHeaders();
		headers.add("Content-Type", "application/json; charset=utf-8");
		if (ItxSubjectContainerState.findItxSubjectContainerState(itxSubjectContainerState.getId()) == null) {
			return new ResponseEntity<String>(headers, HttpStatus.NOT_FOUND);
		}
		itxSubjectContainerState = itxSubjectContainerStateService
				.updateItxSubjectContainerState(itxSubjectContainerState);
		return new ResponseEntity<String>(itxSubjectContainerState.toJson(), headers, HttpStatus.OK);
	}
	...
	@ResponseBody
	@Transactional
	public ResponseEntity<String> updateExperimentStatesFromJsonArray(
			@RequestBody List<ExperimentState> experimentStates) {
		HttpHeaders headers = new HttpHeaders();
		headers.add("Content-Type", "application/json; charset=utf-8");
	...
	@ResponseBody
	@Transactional
	public ResponseEntity<String> updateAnalysisGroupStatesFromJsonArray(
			@RequestBody List<AnalysisGroupState> analysisGroupStates) {
		HttpHeaders headers = new HttpHeaders();
		headers.add("Content-Type", "application/json; charset=utf-8");
		analysisGroupStates = (List<AnalysisGroupState>) analysisGroupStateService
				.updateAnalysisGroupStates(analysisGroupStates);
	...
	@ResponseBody
	@Transactional
	public ResponseEntity<String> updateTreatmentGroupStatesFromJsonArray(
			@RequestBody List<TreatmentGroupState> treatmentGroupStates) {
		HttpHeaders headers = new HttpHeaders();
		headers.add("Content-Type", "application/json; charset=utf-8");
		treatmentGroupStates = (List<TreatmentGroupState>) treatmentGroupStateService
				.updateTreatmentGroupStates(treatmentGroupStates);
		return new ResponseEntity<String>(TreatmentGroupState.toJsonArray(treatmentGroupStates), headers,
				HttpStatus.OK);
	}
	...
	@ResponseBody
	public ResponseEntity<String> updateContainerStatesFromJsonArray(
			@RequestBody List<ContainerState> containerStates) {
		HttpHeaders headers = new HttpHeaders();
		headers.add("Content-Type", "application/json; charset=utf-8");
		try {
	...
	@ResponseBody
	@Transactional
	public ResponseEntity<String> updateItxContainerContainerStatesFromJsonArray(
			@RequestBody List<ItxContainerContainerState> itxContainerContainerStates) {
		HttpHeaders headers = new HttpHeaders();
		headers.add("Content-Type", "application/json; charset=utf-8");
		itxContainerContainerStates = (List<ItxContainerContainerState>) itxContainerContainerStateService
				.updateItxContainerContainerStates(itxContainerContainerStates);
		return new ResponseEntity<String>(ItxContainerContainerState.toJsonArray(itxContainerContainerStates), headers,
				HttpStatus.OK);
	}
	...
	@ResponseBody
	@Transactional
	public ResponseEntity<String> updateItxExperimentExperimentStatesFromJsonArray(
			@RequestBody List<ItxExperimentExperimentState> itxExperimentExperimentStates) {
		HttpHeaders headers = new HttpHeaders();
		headers.add("Content-Type", "application/json; charset=utf-8");
		itxExperimentExperimentStates = (List<ItxExperimentExperimentState>) itxExperimentExperimentStateService
				.updateItxExperimentExperimentStates(itxExperimentExperimentStates);
		return new ResponseEntity<String>(ItxExperimentExperimentState.toJsonArray(itxExperimentExperimentStates),
	...
	@ResponseBody
	@Transactional
	public ResponseEntity<String> updateItxProtocolProtocolStatesFromJsonArray(
			@RequestBody List<ItxProtocolProtocolState> itxProtocolProtocolStates) {
		HttpHeaders headers = new HttpHeaders();
		headers.add("Content-Type", "application/json; charset=utf-8");
		itxProtocolProtocolStates = (List<ItxProtocolProtocolState>) itxProtocolProtocolStateService
				.updateItxProtocolProtocolStates(itxProtocolProtocolStates);
		return new ResponseEntity<String>(ItxProtocolProtocolState.toJsonArray(itxProtocolProtocolStates), headers,
				HttpStatus.OK);
	}
	...
	@ResponseBody
	@Transactional
	public ResponseEntity<String> updateItxSubjectContainerStatesFromJsonArray(
			@RequestBody List<ItxSubjectContainerState> itxSubjectContainerStates) {
		HttpHeaders headers = new HttpHeaders();
		headers.add("Content-Type", "application/json; charset=utf-8");
		itxSubjectContainerStates = (List<ItxSubjectContainerState>) itxSubjectContainerStateService
				.updateItxSubjectContainerStates(itxSubjectContainerStates);
		return new ResponseEntity<String>(ItxSubjectContainerState.toJsonArray(itxSubjectContainerStates), headers,
				HttpStatus.OK);
	}
	...
	@ResponseBody
	@Transactional
	public ResponseEntity<String> createTreatmentGroupStateFromJson(
			@RequestBody TreatmentGroupState treatmentGroupState) {
		HttpHeaders headers = new HttpHeaders();
		headers.add("Content-Type", "application/json; charset=utf-8");
	...
	@ResponseBody
	@Transactional
	public ResponseEntity<String> createItxContainerContainerStateFromJson(
			@RequestBody ItxContainerContainerState itxContainerContainerState) {
		HttpHeaders headers = new HttpHeaders();
		headers.add("Content-Type", "application/json; charset=utf-8");
		itxContainerContainerState = itxContainerContainerStateService
				.saveItxContainerContainerState(itxContainerContainerState);
		return new ResponseEntity<String>(itxContainerContainerState.toJson(), headers, HttpStatus.OK);
	}
	...
	@ResponseBody
	@Transactional
	public ResponseEntity<String> createItxExperimentExperimentStateFromJson(
			@RequestBody ItxExperimentExperimentState itxExperimentExperimentState) {
		HttpHeaders headers = new HttpHeaders();
		headers.add("Content-Type", "application/json; charset=utf-8");
		itxExperimentExperimentState = itxExperimentExperimentStateService
				.saveItxExperimentExperimentState(itxExperimentExperimentState);
		return new ResponseEntity<String>(itxExperimentExperimentState.toJson(), headers, HttpStatus.OK);
	}
	...
	@ResponseBody
	@Transactional
	public ResponseEntity<String> createItxProtocolProtocolStateFromJson(
			@RequestBody ItxProtocolProtocolState itxProtocolProtocolState) {
		HttpHeaders headers = new HttpHeaders();
		headers.add("Content-Type", "application/json; charset=utf-8");
		itxProtocolProtocolState = itxProtocolProtocolStateService
				.saveItxProtocolProtocolState(itxProtocolProtocolState);
		return new ResponseEntity<String>(itxProtocolProtocolState.toJson(), headers, HttpStatus.OK);
	}
	...
	@ResponseBody
	@Transactional
	public ResponseEntity<String> createItxSubjectContainerStateFromJson(
			@RequestBody ItxSubjectContainerState itxSubjectContainerState) {
		HttpHeaders headers = new HttpHeaders();
		headers.add("Content-Type", "application/json; charset=utf-8");
		itxSubjectContainerState = itxSubjectContainerStateService
				.saveItxSubjectContainerState(itxSubjectContainerState);
		return new ResponseEntity<String>(itxSubjectContainerState.toJson(), headers, HttpStatus.OK);
	}
	...
	@ResponseBody
	@Transactional
	public ResponseEntity<String> createExperimentStatesFromJsonArray(
			@RequestBody List<ExperimentState> experimentStates) {
		HttpHeaders headers = new HttpHeaders();
		headers.add("Content-Type", "application/json; charset=utf-8");
	...
	@ResponseBody
	@Transactional
	public ResponseEntity<String> createAnalysisGroupStatesFromJsonArray(
			@RequestBody List<AnalysisGroupState> analysisGroupStates) {
		HttpHeaders headers = new HttpHeaders();
		headers.add("Content-Type", "application/json; charset=utf-8");
		analysisGroupStates = (List<AnalysisGroupState>) analysisGroupStateService
				.saveAnalysisGroupStates(analysisGroupStates);
		return new ResponseEntity<String>(AnalysisGroupState.toJsonArray(analysisGroupStates), headers, HttpStatus.OK);
	}
	...
	@ResponseBody
	@Transactional
	public ResponseEntity<String> createTreatmentGroupStatesFromJsonArray(
			@RequestBody List<TreatmentGroupState> treatmentGroupStates) {
		HttpHeaders headers = new HttpHeaders();
		headers.add("Content-Type", "application/json; charset=utf-8");
		treatmentGroupStates = (List<TreatmentGroupState>) treatmentGroupStateService
				.saveTreatmentGroupStates(treatmentGroupStates);
		return new ResponseEntity<String>(TreatmentGroupState.toJsonArray(treatmentGroupStates), headers,
				HttpStatus.OK);
	}
	...
	@ResponseBody
	public ResponseEntity<String> createContainerStatesFromJsonArray(
			@RequestBody List<ContainerState> containerStates) {
		HttpHeaders headers = new HttpHeaders();
		headers.add("Content-Type", "application/json; charset=utf-8");
		try {
	...
	@ResponseBody
	@Transactional
	public ResponseEntity<String> createItxContainerContainerStatesFromJsonArray(
			@RequestBody List<ItxContainerContainerState> itxContainerContainerStates) {
		HttpHeaders headers = new HttpHeaders();
		headers.add("Content-Type", "application/json; charset=utf-8");
		itxContainerContainerStates = (List<ItxContainerContainerState>) itxContainerContainerStateService
				.saveItxContainerContainerStates(itxContainerContainerStates);
		return new ResponseEntity<String>(ItxContainerContainerState.toJsonArray(itxContainerContainerStates), headers,
				HttpStatus.OK);
	}
	...
	@ResponseBody
	@Transactional
	public ResponseEntity<String> createItxExperimentExperimentStatesFromJsonArray(
			@RequestBody List<ItxExperimentExperimentState> itxExperimentExperimentStates) {
		HttpHeaders headers = new HttpHeaders();
		headers.add("Content-Type", "application/json; charset=utf-8");
		itxExperimentExperimentStates = (List<ItxExperimentExperimentState>) itxExperimentExperimentStateService
				.saveItxExperimentExperimentStates(itxExperimentExperimentStates);
		return new ResponseEntity<String>(ItxExperimentExperimentState.toJsonArray(itxExperimentExperimentStates),
				headers, HttpStatus.OK);
	}
	...
	@ResponseBody
	@Transactional
	public ResponseEntity<String> createItxProtocolProtocolStatesFromJsonArray(
			@RequestBody List<ItxProtocolProtocolState> itxProtocolProtocolStates) {
		HttpHeaders headers = new HttpHeaders();
		headers.add("Content-Type", "application/json; charset=utf-8");
		itxProtocolProtocolStates = (List<ItxProtocolProtocolState>) itxProtocolProtocolStateService
				.saveItxProtocolProtocolStates(itxProtocolProtocolStates);
		return new ResponseEntity<String>(ItxProtocolProtocolState.toJsonArray(itxProtocolProtocolStates), headers,
				HttpStatus.OK);
	}
	...
	@ResponseBody
	@Transactional
	public ResponseEntity<String> createItxSubjectContainerStatesFromJsonArray(
			@RequestBody List<ItxSubjectContainerState> itxSubjectContainerStates) {
		HttpHeaders headers = new HttpHeaders();
		headers.add("Content-Type", "application/json; charset=utf-8");
		itxSubjectContainerStates = (List<ItxSubjectContainerState>) itxSubjectContainerStateService
				.saveItxSubjectContainerStates(itxSubjectContainerStates);
		return new ResponseEntity<String>(ItxSubjectContainerState.toJsonArray(itxSubjectContainerStates), headers,
				HttpStatus.OK);
	}
