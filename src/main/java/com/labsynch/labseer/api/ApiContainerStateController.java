...
public class ApiContainerStateController {
    ...
    public ResponseEntity<java.lang.String> getContainerStatesFromIDs(@RequestBody String json) {
        ...
        for (Container container : containers) {
            ...
            for (ContainerState cs : ContainerState
                    .findContainerStatesByContainer(Container.findContainer(container.getId())).getResultList()) {
    ...
    public ResponseEntity<java.lang.String> createFromJsonFile(@RequestBody String jsonFile) {
        ...
        return new ResponseEntity<String>(ContainerStateMiniDTO.toJsonArray(savedContainerStates), headers,
                HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<java.lang.String> getContainerStatesByContainerValue(@RequestBody String json,
        ...
        try {
            ...
            Collection<ContainerState> searchResults = csService.getContainerStatesByContainerValue(requestDTO, like,
                    rightLike);
            if (maxResults != null && maxResults > 0 && searchResults.size() > maxResults) {
                ...
                if (with != null && with.equalsIgnoreCase("nestedContainer")) {
                    return new ResponseEntity<String>(ContainerState.toJsonArrayWithNestedContainers(searchResults),
