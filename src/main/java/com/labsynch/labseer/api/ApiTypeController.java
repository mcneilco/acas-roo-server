...
public class ApiTypeController {
    ...
    public ResponseEntity<String> createInteractionTypeFromJsonArray(@RequestBody List<InteractionType> interactionTypes) {
        ...
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        return new ResponseEntity<String>(InteractionType.toJsonArray(newInteractionTypes), headers, HttpStatus.CREATED);
    }
