...
privileged aspect ThingTypeController_Roo_Controller_Json {
    ...
    public ResponseEntity<String> ThingTypeController.createFromJson(@RequestBody String json, UriComponentsBuilder uriBuilder) {
        HttpHeaders headers = new HttpHeaders();
    ...
    public ResponseEntity<String> ThingTypeController.updateFromJson(@RequestBody String json, @PathVariable("id") Long id) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        try {
            ThingType thingType = ThingType.fromJsonToThingType(json);
