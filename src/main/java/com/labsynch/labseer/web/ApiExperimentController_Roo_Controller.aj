...
import com.labsynch.labseer.web.ApiExperimentController;
...
privileged aspect ApiExperimentController_Roo_Controller {
    
    @RequestMapping(method = RequestMethod.POST, produces = "text/html")
    public String ApiExperimentController.create(@Valid Experiment experiment, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String ApiExperimentController.createForm(Model uiModel) {
    ...
    public String ApiExperimentController.show(@PathVariable("id") Long id, Model uiModel) {
    ...
    public String ApiExperimentController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
    ...
    public String ApiExperimentController.update(@Valid Experiment experiment, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, experiment);
    ...
    public String ApiExperimentController.updateForm(@PathVariable("id") Long id, Model uiModel) {
        populateEditForm(uiModel, Experiment.findExperiment(id));
        return "experiments/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String ApiExperimentController.delete(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
    ...
    void ApiExperimentController.addDateTimeFormatPatterns(Model uiModel) {
    ...
    void ApiExperimentController.populateEditForm(Model uiModel, Experiment experiment) {
    ...
    String ApiExperimentController.encodeUrlPathSegment(String pathSegment, HttpServletRequest httpServletRequest) {
