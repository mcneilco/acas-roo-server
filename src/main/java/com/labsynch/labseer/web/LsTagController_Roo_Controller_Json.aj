...
privileged aspect LsTagController_Roo_Controller_Json {
    ...
    public ResponseEntity<String> LsTagController.createFromJson(@RequestBody String json, UriComponentsBuilder uriBuilder) {
        HttpHeaders headers = new HttpHeaders();
    ...
    public ResponseEntity<String> LsTagController.updateFromJson(@RequestBody String json, @PathVariable("id") Long id) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        try {
            LsTag lsTag = LsTag.fromJsonToLsTag(json);
