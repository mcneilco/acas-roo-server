...
public class LsSeqTrtGrpController {
    ...
    public String create(@Valid LsSeqTrtGrp lsSeqTrtGrp, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String update(@Valid LsSeqTrtGrp lsSeqTrtGrp, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, lsSeqTrtGrp);
	...
	void populateEditForm(Model uiModel, LsSeqTrtGrp lsSeqTrtGrp) {
