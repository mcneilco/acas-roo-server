...
public class UpdateLogController {
    ...
    public String create(@Valid UpdateLog updateLog, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String update(@Valid UpdateLog updateLog, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, updateLog);
	...
	void populateEditForm(Model uiModel, UpdateLog updateLog) {
