...
privileged aspect ProtocolController_Roo_Controller {
    ...
    public String ProtocolController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
