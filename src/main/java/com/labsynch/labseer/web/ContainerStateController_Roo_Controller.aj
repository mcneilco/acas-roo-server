...
privileged aspect ContainerStateController_Roo_Controller {
    ...
    public String ContainerStateController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
