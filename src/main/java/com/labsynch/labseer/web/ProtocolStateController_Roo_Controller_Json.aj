...
privileged aspect ProtocolStateController_Roo_Controller_Json {
    ...
    public ResponseEntity<String> ProtocolStateController.createFromJson(@RequestBody String json, UriComponentsBuilder uriBuilder) {
        HttpHeaders headers = new HttpHeaders();
    ...
    public ResponseEntity<String> ProtocolStateController.updateFromJson(@RequestBody String json, @PathVariable("id") Long id) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        try {
            ProtocolState protocolState = ProtocolState.fromJsonToProtocolState(json);
