...
privileged aspect LabelSequenceController_Roo_Controller_Json {
    ...
    public ResponseEntity<String> LabelSequenceController.createFromJson(@RequestBody String json, UriComponentsBuilder uriBuilder) {
        HttpHeaders headers = new HttpHeaders();
    ...
    public ResponseEntity<String> LabelSequenceController.updateFromJson(@RequestBody String json, @PathVariable("id") Long id) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        try {
            LabelSequence labelSequence = LabelSequence.fromJsonToLabelSequence(json);
