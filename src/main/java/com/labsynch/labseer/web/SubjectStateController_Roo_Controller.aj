...
privileged aspect SubjectStateController_Roo_Controller {
    ...
    public String SubjectStateController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
