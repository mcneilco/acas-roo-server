...
privileged aspect FileTypeController_Roo_Controller {
    ...
    public String FileTypeController.show(@PathVariable("id") Long id, Model uiModel) {
    ...
    public String FileTypeController.updateForm(@PathVariable("id") Long id, Model uiModel) {
        populateEditForm(uiModel, FileType.findFileType(id));
        return "filetypes/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String FileTypeController.delete(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
