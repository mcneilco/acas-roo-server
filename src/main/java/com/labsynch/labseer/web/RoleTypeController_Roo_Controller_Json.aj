...
privileged aspect RoleTypeController_Roo_Controller_Json {
    ...
    public ResponseEntity<String> RoleTypeController.createFromJson(@RequestBody String json, UriComponentsBuilder uriBuilder) {
        HttpHeaders headers = new HttpHeaders();
    ...
    public ResponseEntity<String> RoleTypeController.updateFromJson(@RequestBody String json, @PathVariable("id") Long id) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        try {
            RoleType roleType = RoleType.fromJsonToRoleType(json);
