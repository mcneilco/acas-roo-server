...
public class UncertaintyKindController {
    ...
    public String create(@Valid UncertaintyKind uncertaintyKind, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String update(@Valid UncertaintyKind uncertaintyKind, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, uncertaintyKind);
	...
	void populateEditForm(Model uiModel, UncertaintyKind uncertaintyKind) {
