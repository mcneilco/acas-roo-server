...
privileged aspect ParentAnnotationController_Roo_Controller_Finder {
    
    @RequestMapping(params = { "find=ByCodeEquals", "form" }, method = RequestMethod.GET)
    public String ParentAnnotationController.findParentAnnotationsByCodeEqualsForm(Model uiModel) {
