...
privileged aspect ContainerTypeController_Roo_Controller_Json {
    ...
    public ResponseEntity<String> ContainerTypeController.createFromJson(@RequestBody String json, UriComponentsBuilder uriBuilder) {
        HttpHeaders headers = new HttpHeaders();
    ...
    public ResponseEntity<String> ContainerTypeController.updateFromJson(@RequestBody String json, @PathVariable("id") Long id) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        try {
            ContainerType containerType = ContainerType.fromJsonToContainerType(json);
