...
privileged aspect ExperimentLabelController_Roo_Controller_Json {
    ...
    public ResponseEntity<String> ExperimentLabelController.createFromJson(@RequestBody String json, UriComponentsBuilder uriBuilder) {
        HttpHeaders headers = new HttpHeaders();
    ...
    public ResponseEntity<String> ExperimentLabelController.updateFromJson(@RequestBody String json, @PathVariable("id") Long id) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Content-Type", "application/json");
        try {
            ExperimentLabel experimentLabel = ExperimentLabel.fromJsonToExperimentLabel(json);
