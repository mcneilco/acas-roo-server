...
privileged aspect ApiExperimentController_Roo_Controller_Finder {
    
    @RequestMapping(params = { "find=ByCodeNameEquals", "form" }, method = RequestMethod.GET)
    public String ApiExperimentController.findExperimentsByCodeNameEqualsForm(Model uiModel) {
        return "experiments/findExperimentsByCodeNameEquals";
    }
    
    @RequestMapping(params = "find=ByCodeNameEquals", method = RequestMethod.GET)
    public String ApiExperimentController.findExperimentsByCodeNameEquals(@RequestParam("codeName") String codeName, Model uiModel) {
    ...
    public String ApiExperimentController.findExperimentsByLsTransactionForm(Model uiModel) {
        return "experiments/findExperimentsByLsTransaction";
    }
    
    @RequestMapping(params = "find=ByLsTransaction", method = RequestMethod.GET)
    public String ApiExperimentController.findExperimentsByLsTransaction(@RequestParam("lsTransaction") Long lsTransaction, Model uiModel) {
    ...
    public String ApiExperimentController.findExperimentsByProtocolForm(Model uiModel) {
    ...
    public String ApiExperimentController.findExperimentsByProtocol(@RequestParam("protocol") Protocol protocol, Model uiModel) {
