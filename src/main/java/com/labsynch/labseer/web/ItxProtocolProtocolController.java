...
public class ItxProtocolProtocolController {
    ...
    @ResponseBody
    public ResponseEntity<String> jsonFindItxProtocolProtocolsByFirstProtocol(@RequestParam("firstProtocol") Protocol firstProtocol) {
        HttpHeaders headers = new HttpHeaders();
        try {
            headers.add("Content-Type", "application/json; charset=utf-8");
    ...
    @ResponseBody
    public ResponseEntity<String> jsonFindItxProtocolProtocolsBySecondProtocol(@RequestParam("secondProtocol") Protocol secondProtocol) {
        HttpHeaders headers = new HttpHeaders();
        try {
            headers.add("Content-Type", "application/json; charset=utf-8");
    ...
    public String findItxProtocolProtocolsByFirstProtocolForm(Model uiModel) {
    ...
    public String findItxProtocolProtocolsByFirstProtocol(@RequestParam("firstProtocol") Protocol firstProtocol, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, @RequestParam(value = "sortFieldName", required = false) String sortFieldName, @RequestParam(value = "sortOrder", required = false) String sortOrder, Model uiModel) {
    ...
    public String findItxProtocolProtocolsByLsTransactionEqualsForm(Model uiModel) {
    ...
    public String findItxProtocolProtocolsByLsTransactionEquals(@RequestParam("lsTransaction") Long lsTransaction, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, @RequestParam(value = "sortFieldName", required = false) String sortFieldName, @RequestParam(value = "sortOrder", required = false) String sortOrder, Model uiModel) {
        if (page != null || size != null) {
            int sizeNo = size == null ? 10 : size.intValue();
            final int firstResult = page == null ? 0 : (page.intValue() - 1) * sizeNo;
    ...
    public String findItxProtocolProtocolsBySecondProtocolForm(Model uiModel) {
        uiModel.addAttribute("protocols", Protocol.findAllProtocols());
    ...
    public String create(@Valid ItxProtocolProtocol itxProtocolProtocol, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String createForm(Model uiModel) {
        ...
        if (Protocol.countProtocols() == 0) {
            dependencies.add(new String[] { "firstProtocol", "protocols" });
        }
        if (Protocol.countProtocols() == 0) {
            dependencies.add(new String[] { "secondProtocol", "protocols" });
        }
    ...
    public String list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, @RequestParam(value = "sortFieldName", required = false) String sortFieldName, @RequestParam(value = "sortOrder", required = false) String sortOrder, Model uiModel) {
        if (page != null || size != null) {
            int sizeNo = size == null ? 10 : size.intValue();
            final int firstResult = page == null ? 0 : (page.intValue() - 1) * sizeNo;
            uiModel.addAttribute("itxprotocolprotocols", ItxProtocolProtocol.findItxProtocolProtocolEntries(firstResult, sizeNo, sortFieldName, sortOrder));
            float nrOfPages = (float) ItxProtocolProtocol.countItxProtocolProtocols() / sizeNo;
            uiModel.addAttribute("maxPages", (int) ((nrOfPages > (int) nrOfPages || nrOfPages == 0.0) ? nrOfPages + 1 : nrOfPages));
        } else {
            uiModel.addAttribute("itxprotocolprotocols", ItxProtocolProtocol.findAllItxProtocolProtocols(sortFieldName, sortOrder));
        }
        addDateTimeFormatPatterns(uiModel);
        return "itxprotocolprotocols/list";
    }
    ...
    public String update(@Valid ItxProtocolProtocol itxProtocolProtocol, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, itxProtocolProtocol);
