...
privileged aspect ExperimentStateController_Roo_Controller {
    
    @RequestMapping(method = RequestMethod.POST, produces = "text/html")
    public String ExperimentStateController.create(@Valid ExperimentState experimentState, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String ExperimentStateController.createForm(Model uiModel) {
    ...
    public String ExperimentStateController.show(@PathVariable("id") Long id, Model uiModel) {
    ...
    public String ExperimentStateController.list(@RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, @RequestParam(value = "sortFieldName", required = false) String sortFieldName, @RequestParam(value = "sortOrder", required = false) String sortOrder, Model uiModel) {
    ...
    public String ExperimentStateController.update(@Valid ExperimentState experimentState, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
        if (bindingResult.hasErrors()) {
            populateEditForm(uiModel, experimentState);
    ...
    public String ExperimentStateController.updateForm(@PathVariable("id") Long id, Model uiModel) {
        populateEditForm(uiModel, ExperimentState.findExperimentState(id));
        return "experimentstates/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String ExperimentStateController.delete(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
    ...
    void ExperimentStateController.addDateTimeFormatPatterns(Model uiModel) {
    ...
    void ExperimentStateController.populateEditForm(Model uiModel, ExperimentState experimentState) {
    ...
    String ExperimentStateController.encodeUrlPathSegment(String pathSegment, HttpServletRequest httpServletRequest) {
