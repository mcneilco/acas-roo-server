...
public class CodeKind {
    ...
    @Id
    @SequenceGenerator(name = "codeKindGen", sequenceName = "CODE_KIND_PKSEQ", allocationSize = 1)
    ...
    public static List<com.labsynch.labseer.domain.CodeKind> findCodeKindEntries(int firstResult, int maxResults) {
        return entityManager().createQuery("SELECT o FROM CodeKind o", CodeKind.class).setFirstResult(firstResult)
    ...
    public static List<CodeKind> findCodeKindEntries(int firstResult, int maxResults, String sortFieldName,
            String sortOrder) {
        String jpaQuery = "SELECT o FROM CodeKind o";
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
            jpaQuery = jpaQuery + " ORDER BY " + sortFieldName;
        ...
        return entityManager().createQuery(jpaQuery, CodeKind.class).setFirstResult(firstResult)
                .setMaxResults(maxResults).getResultList();
    }
    ...
    public static Long countFindCodeKindsByKindNameEqualsAndLsType(String kindName, CodeType lsType) {
        ...
        TypedQuery q = em.createQuery(
                "SELECT COUNT(o) FROM CodeKind AS o WHERE o.kindName = :kindName  AND o.lsType = :lsType", Long.class);
    ...
    public static Long countFindCodeKindsByLsTypeAndKindEquals(String lsTypeAndKind) {
        ...
        EntityManager em = CodeKind.entityManager();
        TypedQuery q = em.createQuery("SELECT COUNT(o) FROM CodeKind AS o WHERE o.lsTypeAndKind = :lsTypeAndKind",
                Long.class);
    ...
    public static TypedQuery<CodeKind> findCodeKindsByKindNameEqualsAndLsType(String kindName, CodeType lsType) {
        ...
        if (lsType == null)
            throw new IllegalArgumentException("The lsType argument is required");
        EntityManager em = CodeKind.entityManager();
        TypedQuery<CodeKind> q = em.createQuery(
                "SELECT o FROM CodeKind AS o WHERE o.kindName = :kindName  AND o.lsType = :lsType", CodeKind.class);
        q.setParameter("kindName", kindName);
        q.setParameter("lsType", lsType);
        return q;
    }
    ...
    public static TypedQuery<CodeKind> findCodeKindsByKindNameEqualsAndLsType(String kindName, CodeType lsType,
        ...
        StringBuilder queryBuilder = new StringBuilder(
                "SELECT o FROM CodeKind AS o WHERE o.kindName = :kindName  AND o.lsType = :lsType");
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
    ...
    public static TypedQuery<CodeKind> findCodeKindsByLsTypeAndKindEquals(String lsTypeAndKind) {
        if (lsTypeAndKind == null || lsTypeAndKind.length() == 0)
            throw new IllegalArgumentException("The lsTypeAndKind argument is required");
        EntityManager em = CodeKind.entityManager();
        TypedQuery<CodeKind> q = em.createQuery("SELECT o FROM CodeKind AS o WHERE o.lsTypeAndKind = :lsTypeAndKind",
                CodeKind.class);
        q.setParameter("lsTypeAndKind", lsTypeAndKind);
        return q;
    }

    public static TypedQuery<CodeKind> findCodeKindsByLsTypeAndKindEquals(String lsTypeAndKind, String sortFieldName,
            String sortOrder) {
        if (lsTypeAndKind == null || lsTypeAndKind.length() == 0)
            throw new IllegalArgumentException("The lsTypeAndKind argument is required");
        EntityManager em = CodeKind.entityManager();
        StringBuilder queryBuilder = new StringBuilder(
                "SELECT o FROM CodeKind AS o WHERE o.lsTypeAndKind = :lsTypeAndKind");
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
            queryBuilder.append(" ORDER BY ").append(sortFieldName);
            if ("ASC".equalsIgnoreCase(sortOrder) || "DESC".equalsIgnoreCase(sortOrder)) {
                queryBuilder.append(" ").append(sortOrder);
