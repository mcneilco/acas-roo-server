...
public class ItxProtocolProtocolState extends AbstractState {
    ...
    public static ItxProtocolProtocolState update(ItxProtocolProtocolState object) {
        ItxProtocolProtocolState updatedObject = new JSONDeserializer<ItxProtocolProtocolState>()
                .use(null, ItxProtocolProtocolState.class).deserializeInto(object.toJson(),
    ...
    public static final List<String> fieldNames4OrderClauseFilter = java.util.Arrays.asList("itxProtocolProtocol",
            "lsValues");

    public static long countItxProtocolProtocolStates() {
        return entityManager().createQuery("SELECT COUNT(o) FROM ItxProtocolProtocolState o", Long.class)
                .getSingleResult();
    }

    public static List<ItxProtocolProtocolState> findAllItxProtocolProtocolStates() {
        return entityManager().createQuery("SELECT o FROM ItxProtocolProtocolState o", ItxProtocolProtocolState.class)
                .getResultList();
    }

    public static List<ItxProtocolProtocolState> findAllItxProtocolProtocolStates(String sortFieldName,
            String sortOrder) {
    ...
    public static List<ItxProtocolProtocolState> findItxProtocolProtocolStateEntries(int firstResult, int maxResults,
        ...
        return entityManager().createQuery(jpaQuery, ItxProtocolProtocolState.class).setFirstResult(firstResult)
