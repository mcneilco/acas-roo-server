...
public class UnitKind {
    ...
    @Id
    @SequenceGenerator(name = "unitKindGen", sequenceName = "UNITS_KIND_PKSEQ", allocationSize = 1)
    ...
    public static List<UnitKind> findUnitKindEntries(int firstResult, int maxResults) {
        return entityManager().createQuery("SELECT o FROM UnitKind o", UnitKind.class).setFirstResult(firstResult)
    ...
    public static List<UnitKind> findUnitKindEntries(int firstResult, int maxResults, String sortFieldName,
            String sortOrder) {
        String jpaQuery = "SELECT o FROM UnitKind o";
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
            jpaQuery = jpaQuery + " ORDER BY " + sortFieldName;
        ...
        return entityManager().createQuery(jpaQuery, UnitKind.class).setFirstResult(firstResult)
                .setMaxResults(maxResults).getResultList();
    }
    ...
    public static Long countFindUnitKindsByKindNameEqualsAndLsType(String kindName, UnitType lsType) {
        ...
        TypedQuery q = em.createQuery(
                "SELECT COUNT(o) FROM UnitKind AS o WHERE o.kindName = :kindName  AND o.lsType = :lsType", Long.class);
    ...
    public static TypedQuery<UnitKind> findUnitKindsByKindNameEqualsAndLsType(String kindName, UnitType lsType) {
        ...
        if (lsType == null)
            throw new IllegalArgumentException("The lsType argument is required");
        EntityManager em = UnitKind.entityManager();
        TypedQuery<UnitKind> q = em.createQuery(
                "SELECT o FROM UnitKind AS o WHERE o.kindName = :kindName  AND o.lsType = :lsType", UnitKind.class);
        q.setParameter("kindName", kindName);
        q.setParameter("lsType", lsType);
        return q;
    }
    ...
    public static TypedQuery<UnitKind> findUnitKindsByKindNameEqualsAndLsType(String kindName, UnitType lsType,
        ...
        StringBuilder queryBuilder = new StringBuilder(
                "SELECT o FROM UnitKind AS o WHERE o.kindName = :kindName  AND o.lsType = :lsType");
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
