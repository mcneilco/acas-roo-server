...
//    }
	...
	public static TypedQuery<ApplicationSetting> findApplicationSettingsByPropNameEquals(String propName, String sortFieldName, String sortOrder) {
        if (propName == null || propName.length() == 0) throw new IllegalArgumentException("The propName argument is required");
        EntityManager em = ApplicationSetting.entityManager();
	...
	public static TypedQuery<ApplicationSetting> findApplicationSettingsByPropNameEqualsAndIgnoredNot(String propName, boolean ignored) {
        if (propName == null || propName.length() == 0) throw new IllegalArgumentException("The propName argument is required");
        EntityManager em = ApplicationSetting.entityManager();
	...
	public static TypedQuery<ApplicationSetting> findApplicationSettingsByPropNameEqualsAndIgnoredNot(String propName, boolean ignored, String sortFieldName, String sortOrder) {
        if (propName == null || propName.length() == 0) throw new IllegalArgumentException("The propName argument is required");
        EntityManager em = ApplicationSetting.entityManager();
	...
	public static List<ApplicationSetting> findApplicationSettingEntries(int firstResult, int maxResults, String sortFieldName, String sortOrder) {
        String jpaQuery = "SELECT o FROM ApplicationSetting o";
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
            jpaQuery = jpaQuery + " ORDER BY " + sortFieldName;
            if ("ASC".equalsIgnoreCase(sortOrder) || "DESC".equalsIgnoreCase(sortOrder)) {
