...
public class AuthorLabel extends AbstractLabel {
    ...
    public static Collection<AuthorLabel> fromJsonArrayToAuthorLabels(String json) {
        return new JSONDeserializer<List<AuthorLabel>>().use(null, ArrayList.class).use("values", AuthorLabel.class)
                .deserialize(json);
    }
    ...
    public static Long countFindAuthorLabelsByLsTransactionEquals(Long lsTransaction) {
        ...
        EntityManager em = AuthorLabel.entityManager();
        TypedQuery q = em.createQuery("SELECT COUNT(o) FROM AuthorLabel AS o WHERE o.lsTransaction = :lsTransaction",
                Long.class);
    ...
    public static TypedQuery<AuthorLabel> findAuthorLabelsByAuthor(Author author) {
        if (author == null)
            throw new IllegalArgumentException("The author argument is required");
        EntityManager em = AuthorLabel.entityManager();
        TypedQuery<AuthorLabel> q = em.createQuery("SELECT o FROM AuthorLabel AS o WHERE o.author = :author",
                AuthorLabel.class);
        q.setParameter("author", author);
        return q;
    }

    public static TypedQuery<AuthorLabel> findAuthorLabelsByAuthor(Author author, String sortFieldName,
            String sortOrder) {
        if (author == null)
            throw new IllegalArgumentException("The author argument is required");
        EntityManager em = AuthorLabel.entityManager();
    ...
    public static TypedQuery<AuthorLabel> findAuthorLabelsByLsTransactionEquals(Long lsTransaction) {
        if (lsTransaction == null)
            throw new IllegalArgumentException("The lsTransaction argument is required");
        EntityManager em = AuthorLabel.entityManager();
        TypedQuery<AuthorLabel> q = em.createQuery(
                "SELECT o FROM AuthorLabel AS o WHERE o.lsTransaction = :lsTransaction", AuthorLabel.class);
        q.setParameter("lsTransaction", lsTransaction);
        return q;
    }
    ...
    public static TypedQuery<AuthorLabel> findAuthorLabelsByLsTransactionEquals(Long lsTransaction,
        ...
        StringBuilder queryBuilder = new StringBuilder(
                "SELECT o FROM AuthorLabel AS o WHERE o.lsTransaction = :lsTransaction");
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
            queryBuilder.append(" ORDER BY ").append(sortFieldName);
            if ("ASC".equalsIgnoreCase(sortOrder) || "DESC".equalsIgnoreCase(sortOrder)) {
                queryBuilder.append(" ").append(sortOrder);
    ...
    public static List<AuthorLabel> findAuthorLabelEntries(int firstResult, int maxResults) {
        return entityManager().createQuery("SELECT o FROM AuthorLabel o", AuthorLabel.class).setFirstResult(firstResult)
                .setMaxResults(maxResults).getResultList();
    }

    public static List<AuthorLabel> findAuthorLabelEntries(int firstResult, int maxResults, String sortFieldName,
            String sortOrder) {
        String jpaQuery = "SELECT o FROM AuthorLabel o";
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
            jpaQuery = jpaQuery + " ORDER BY " + sortFieldName;
        ...
        return entityManager().createQuery(jpaQuery, AuthorLabel.class).setFirstResult(firstResult)
                .setMaxResults(maxResults).getResultList();
    }
