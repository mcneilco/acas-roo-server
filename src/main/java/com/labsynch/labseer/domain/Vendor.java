...
public class Vendor {
    ...
    public static TypedQuery<Vendor> findVendorsBySearchTerm(String searchTerm) {
        ...
        TypedQuery<Vendor> q = em.createQuery(
                "SELECT DISTINCT o FROM Vendor AS o WHERE (LOWER(o.code) LIKE LOWER(:searchTerm) OR LOWER(o.name) LIKE LOWER(:searchTerm))",
                Vendor.class);
    ...
    public static List<Vendor> findVendorEntries(int firstResult, int maxResults) {
        return entityManager().createQuery("SELECT o FROM Vendor o", Vendor.class).setFirstResult(firstResult)
                .setMaxResults(maxResults).getResultList();
    }

    public static List<Vendor> findVendorEntries(int firstResult, int maxResults, String sortFieldName,
            String sortOrder) {
        String jpaQuery = "SELECT o FROM Vendor o";
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
            jpaQuery = jpaQuery + " ORDER BY " + sortFieldName;
        ...
        return entityManager().createQuery(jpaQuery, Vendor.class).setFirstResult(firstResult).setMaxResults(maxResults)
                .getResultList();
    }
    ...
    public static Long countFindVendorsByCodeLike(String code) {
        ...
        EntityManager em = Vendor.entityManager();
        TypedQuery q = em.createQuery("SELECT COUNT(o) FROM Vendor AS o WHERE LOWER(o.code) LIKE LOWER(:code)",
                Long.class);
        q.setParameter("code", code);
        return ((Long) q.getSingleResult());
    }
    ...
    public static Long countFindVendorsByNameLike(String name) {
        ...
        EntityManager em = Vendor.entityManager();
        TypedQuery q = em.createQuery("SELECT COUNT(o) FROM Vendor AS o WHERE LOWER(o.name) LIKE LOWER(:name)",
                Long.class);
        q.setParameter("name", name);
        return ((Long) q.getSingleResult());
    }
    ...
    public static TypedQuery<Vendor> findVendorsByCodeLike(String code) {
        ...
        EntityManager em = Vendor.entityManager();
        TypedQuery<Vendor> q = em.createQuery("SELECT o FROM Vendor AS o WHERE LOWER(o.code) LIKE LOWER(:code)",
                Vendor.class);
        q.setParameter("code", code);
        return q;
    }
    ...
    public static TypedQuery<Vendor> findVendorsByCodeLike(String code, String sortFieldName, String sortOrder) {
        ...
        StringBuilder queryBuilder = new StringBuilder(
                "SELECT o FROM Vendor AS o WHERE LOWER(o.code) LIKE LOWER(:code)");
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
            queryBuilder.append(" ORDER BY ").append(sortFieldName);
            if ("ASC".equalsIgnoreCase(sortOrder) || "DESC".equalsIgnoreCase(sortOrder)) {
                queryBuilder.append(" ").append(sortOrder);
    ...
    public static TypedQuery<Vendor> findVendorsByNameLike(String name) {
        ...
        EntityManager em = Vendor.entityManager();
        TypedQuery<Vendor> q = em.createQuery("SELECT o FROM Vendor AS o WHERE LOWER(o.name) LIKE LOWER(:name)",
                Vendor.class);
        q.setParameter("name", name);
        return q;
    }
    ...
    public static TypedQuery<Vendor> findVendorsByNameLike(String name, String sortFieldName, String sortOrder) {
        ...
        EntityManager em = Vendor.entityManager();
        StringBuilder queryBuilder = new StringBuilder(
                "SELECT o FROM Vendor AS o WHERE LOWER(o.name) LIKE LOWER(:name)");
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
            queryBuilder.append(" ORDER BY ").append(sortFieldName);
            if ("ASC".equalsIgnoreCase(sortOrder) || "DESC".equalsIgnoreCase(sortOrder)) {
                queryBuilder.append(" ").append(sortOrder);
