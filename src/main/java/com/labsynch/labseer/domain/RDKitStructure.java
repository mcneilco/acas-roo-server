...
@RooToString
@RooJson
@RooJpaActiveRecord(sequenceName = "RDKIT_STRUCTURE_PKSEQ", inheritanceType = "TABLE_PER_CLASS", finders = { "findRDKitStructuresByRegEquals", "findRDKitStructuresByPreRegEquals"})
