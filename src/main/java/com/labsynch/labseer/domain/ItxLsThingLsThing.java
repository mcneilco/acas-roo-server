...
public class ItxLsThingLsThing extends AbstractThing {
    ...
    public static com.labsynch.labseer.domain.ItxLsThingLsThing update(com.labsynch.labseer.domain.ItxLsThingLsThing itxLsThingLsThing) {
    ...
    public static com.labsynch.labseer.domain.ItxLsThingLsThing updateNoMerge(com.labsynch.labseer.domain.ItxLsThingLsThing itxLsThingLsThing) {
        ItxLsThingLsThing updatedItxLsThingLsThing = new ItxLsThingLsThing(itxLsThingLsThing);
        updatedItxLsThingLsThing.setId(itxLsThingLsThing.getId());
        updatedItxLsThingLsThing.setModifiedDate(new Date());
        updatedItxLsThingLsThing.setLsStates(itxLsThingLsThing.getLsStates());
    ...
    public static com.labsynch.labseer.domain.ItxLsThingLsThing fromJsonToItxLsThingLsThing(String json) {
        return new JSONDeserializer<ItxLsThingLsThing>().use(null, ItxLsThingLsThing.class).use(BigDecimal.class, new CustomBigDecimalFactory()).deserialize(json);
    }

    public static String toJsonArray(Collection<com.labsynch.labseer.domain.ItxLsThingLsThing> collection) {
        return new JSONSerializer().include("lsStates.lsValues").exclude("*.class").transform(new ExcludeNulls(), void.class).serialize(collection);
    }

    public static Collection<com.labsynch.labseer.domain.ItxLsThingLsThing> fromJsonArrayToItxLsThingLsThings(String json) {
        return new JSONDeserializer<List<ItxLsThingLsThing>>().use(null, ArrayList.class).use("values", ItxLsThingLsThing.class).use(BigDecimal.class, new CustomBigDecimalFactory()).deserialize(json);
    }

    public static Collection<com.labsynch.labseer.domain.ItxLsThingLsThing> fromJsonArrayToItxLsThingLsThings(Reader json) {
        return new JSONDeserializer<List<ItxLsThingLsThing>>().use(null, ArrayList.class).use("values", ItxLsThingLsThing.class).use(BigDecimal.class, new CustomBigDecimalFactory()).deserialize(json);
    }

    public static TypedQuery<com.labsynch.labseer.domain.ItxLsThingLsThing> findItxLsThingLsThingsByLsTypeEqualsAndLsKindEqualsAndFirstLsThingEquals(String lsType, String lsKind, LsThing firstLsThing) {
        ...
        String query = "SELECT DISTINCT o FROM ItxLsThingLsThing o " + "WHERE o.ignored IS NOT :ignored " + "AND o.lsType = :lsType " + "AND o.lsKind = :lsKind " + "AND o.firstLsThing = :firstLsThing ";
    ...
    public static TypedQuery<com.labsynch.labseer.domain.ItxLsThingLsThing> findItxLsThingLsThingsByLsTypeEqualsAndLsKindEqualsAndSecondLsThingEquals(String lsType, String lsKind, LsThing secondLsThing) {
        if (lsType == null || lsType.length() == 0) throw new IllegalArgumentException("The lsType argument is required");
        if (lsKind == null || lsKind.length() == 0) throw new IllegalArgumentException("The lsKind argument is required");
        if (secondLsThing == null) throw new IllegalArgumentException("The secondLsThing argument is required");
        boolean ignored = true;
        EntityManager em = ItxLsThingLsThing.entityManager();
        String query = "SELECT DISTINCT o FROM ItxLsThingLsThing o " + "WHERE o.ignored IS NOT :ignored " + "AND o.lsType = :lsType " + "AND o.lsKind = :lsKind " + "AND o.secondLsThing = :secondLsThing ";
        TypedQuery<ItxLsThingLsThing> q = em.createQuery(query, ItxLsThingLsThing.class);
        q.setParameter("lsType", lsType);
        q.setParameter("lsKind", lsKind);
    ...
    public static TypedQuery<com.labsynch.labseer.domain.ItxLsThingLsThing> findItxLsThingLsThingsByLsTypeEqualsAndLsKindEqualsAndSecondLsThingEqualsAndOrderEquals(String lsType, String lsKind, LsThing secondLsThing, int order) {
        if (lsType == null || lsType.length() == 0) throw new IllegalArgumentException("The lsType argument is required");
        if (lsKind == null || lsKind.length() == 0) throw new IllegalArgumentException("The lsKind argument is required");
        if (secondLsThing == null) throw new IllegalArgumentException("The secondLsThing argument is required");
        boolean ignored = true;
        EntityManager em = ItxLsThingLsThing.entityManager();
        String query = "SELECT DISTINCT o FROM ItxLsThingLsThing o " + "JOIN o.lsStates itxstate JOIN itxstate.lsValues itxvalue WITH itxvalue.lsKind = 'order' " + "WHERE o.ignored IS NOT :ignored " + "AND o.lsType = :lsType " + "AND o.lsKind = :lsKind " + "AND itxvalue.numericValue = :order " + "AND o.secondLsThing = :secondLsThing ";
        TypedQuery<ItxLsThingLsThing> q = em.createQuery(query, ItxLsThingLsThing.class);
        q.setParameter("lsType", lsType);
        q.setParameter("lsKind", lsKind);
    ...
    public static TypedQuery<com.labsynch.labseer.domain.ItxLsThingLsThing> findItxLsThingLsThingsByLsTypeEqualsAndLsKindEqualsAndFirstLsThingEqualsAndSecondLsThingEquals(String lsType, String lsKind, LsThing firstLsThing, LsThing secondLsThing) {
        if (lsType == null || lsType.length() == 0) throw new IllegalArgumentException("The lsType argument is required");
        if (lsKind == null || lsKind.length() == 0) throw new IllegalArgumentException("The lsKind argument is required");
        if (firstLsThing == null) throw new IllegalArgumentException("The firstLsThing argument is required");
        if (secondLsThing == null) throw new IllegalArgumentException("The secondLsThing argument is required");
        boolean ignored = true;
        EntityManager em = ItxLsThingLsThing.entityManager();
        String query = "SELECT DISTINCT o FROM ItxLsThingLsThing o " + "WHERE o.ignored IS NOT :ignored " + "AND o.lsType = :lsType " + "AND o.lsKind = :lsKind " + "AND o.firstLsThing = :firstLsThing " + "AND o.secondLsThing = :secondLsThing ";
        TypedQuery<ItxLsThingLsThing> q = em.createQuery(query, ItxLsThingLsThing.class);
        q.setParameter("lsType", lsType);
        q.setParameter("lsKind", lsKind);
        q.setParameter("firstLsThing", firstLsThing);
    ...
    public int retrieveOrder() {
        EntityManager em = ItxLsThingLsThing.entityManager();
        String query = "SELECT v.numericValue FROM ItxLsThingLsThingValue v " + "JOIN v.lsState s " + "JOIN s.itxLsThingLsThing iltilt " + "WHERE s.lsType = 'metadata' " + "AND s.lsKind = 'composition' " + "AND v.lsType = 'numericValue' " + "AND v.lsKind = 'order' " + "AND iltilt = :itxLsThingLsThing ";
