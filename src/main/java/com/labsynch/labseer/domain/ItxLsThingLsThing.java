...
public class ItxLsThingLsThing extends AbstractThing {
    ...
    public static ItxLsThingLsThing updateNoStates(ItxLsThingLsThing itxLsThingLsThing) {
        ...
        if (logger.isDebugEnabled())
            logger.debug(updatedItxLsThingLsThing.toJson());
    ...
    public static String toJsonArray(Collection<ItxLsThingLsThing> collection) {
        return new JSONSerializer().include("lsStates.lsValues")
                .exclude("*.class", "lsStates.itxLsThingLsThing", "lsStates.lsValues.lsState")
    ...
    public static TypedQuery<ItxLsThingLsThing> findItxLsThingLsThingsByLsTypeEqualsAndLsKindEquals(String lsType,
            String lsKind) {
    ...
    public static TypedQuery<ItxLsThingLsThing> findItxLsThingLsThingsByTypeAndKindAndFirstLsThingEqualsAndSecondLsThingEquals(
            String lsType, String lsKind, LsThing firstLsThing, LsThing secondLsThing) {
        if (lsType == null || lsType.length() == 0)
            throw new IllegalArgumentException("The lsType argument is required");
        if (lsKind == null || lsKind.length() == 0)
            throw new IllegalArgumentException("The lsKind argument is required");
    ...
    public static TypedQuery<ItxLsThingLsThing> findItxLsThingLsThingsNotTypeAndKindAndFirstLsThingEquals(String lsType,
    ...
    public static TypedQuery<ItxLsThingLsThing> findItxLsThingLsThingsNotTypeAndKindAndSecondLsThingEquals(
            String lsType, String lsKind, LsThing secondLsThing) {
        if (lsType == null || lsType.length() == 0)
            throw new IllegalArgumentException("The lsType argument is required");
        if (lsKind == null || lsKind.length() == 0)
            throw new IllegalArgumentException("The lsKind argument is required");
    ...
    public static TypedQuery<ItxLsThingLsThing> findItxLsThingLsThingsByLsTypeEqualsAndLsKindEqualsAndFirstLsThingEquals(
            String lsType, String lsKind, LsThing firstLsThing) {
        if (lsType == null || lsType.length() == 0)
            throw new IllegalArgumentException("The lsType argument is required");
        if (lsKind == null || lsKind.length() == 0)
            throw new IllegalArgumentException("The lsKind argument is required");
    ...
    public static TypedQuery<ItxLsThingLsThing> findItxLsThingLsThingsByLsTypeEqualsAndLsKindEqualsAndSecondLsThingEquals(
            String lsType, String lsKind, LsThing secondLsThing) {
        if (lsType == null || lsType.length() == 0)
            throw new IllegalArgumentException("The lsType argument is required");
        if (lsKind == null || lsKind.length() == 0)
    ...
    public static TypedQuery<ItxLsThingLsThing> findItxLsThingLsThingsByLsTypeEqualsAndLsKindEqualsAndSecondLsThingEqualsAndOrderEquals(
            String lsType, String lsKind, LsThing secondLsThing, int order) {
        if (lsType == null || lsType.length() == 0)
            throw new IllegalArgumentException("The lsType argument is required");
        if (lsKind == null || lsKind.length() == 0)
            throw new IllegalArgumentException("The lsKind argument is required");
    ...
    public static TypedQuery<ItxLsThingLsThing> findItxLsThingLsThingsByLsTypeEqualsAndLsKindEqualsAndFirstLsThingEqualsAndSecondLsThingEquals(
            String lsType, String lsKind, LsThing firstLsThing, LsThing secondLsThing) {
        if (lsType == null || lsType.length() == 0)
            throw new IllegalArgumentException("The lsType argument is required");
        if (lsKind == null || lsKind.length() == 0)
    ...
    public String toJsonWithNestedFull() {
        return new JSONSerializer()
                .exclude("*.class", "lsStates.lsValues.lsState", "lsStates.itxLsThingLsThing",
                        "lsLabels.itxLsThingLsThing")
                .include("lsStates.lsValues",
    ...
    public String toJsonWithNestedStubs() {
        return new JSONSerializer().exclude("*.class").include("lsStates.lsValues",
                "firstLsThing.lsLabels",
                "secondLsThing.lsLabels").transform(new ExcludeNulls(), void.class).serialize(this);
    ...
    public static String toJsonArrayWithNestedFull(
        ...
        return new JSONSerializer().exclude("*.class").include("lsStates.lsValues",
                ...
                "firstLsThing.lsLabels",
                "secondLsThing.lsStates.lsValues",
                "secondLsThing.lsLabels").transform(new ExcludeNulls(), void.class)
                .serialize(updatedItxLsThingLsThings);
    ...
    public static String toPrettyJsonArray(
        ...
        return new JSONSerializer().exclude("*.class").include("lsStates.lsValues",
                ...
                "firstLsThing.lsLabels",
                "secondLsThing.lsStates.lsValues",
                "secondLsThing.lsLabels").prettyPrint(true).transform(new ExcludeNulls(), void.class)
                .serialize(updatedItxLsThingLsThings);
    }
    ...
    public static TypedQuery<ItxLsThingLsThing> findItxLsThingLsThingsByCodeNameEquals(String codeName) {
        ...
        EntityManager em = ItxLsThingLsThing.entityManager();
        TypedQuery<ItxLsThingLsThing> q = em.createQuery(
                "SELECT o FROM ItxLsThingLsThing AS o WHERE o.codeName = :codeName", ItxLsThingLsThing.class);
    ...
    public static TypedQuery<ItxLsThingLsThing> findItxLsThingLsThingsByFirstLsThing(LsThing firstLsThing) {
        ...
        EntityManager em = ItxLsThingLsThing.entityManager();
        TypedQuery<ItxLsThingLsThing> q = em.createQuery(
                "SELECT o FROM ItxLsThingLsThing AS o WHERE o.firstLsThing = :firstLsThing", ItxLsThingLsThing.class);
        q.setParameter("firstLsThing", firstLsThing);
        return q;
    }
    ...
    public static TypedQuery<ItxLsThingLsThing> findItxLsThingLsThingsBySecondLsThing(LsThing secondLsThing) {
        ...
        EntityManager em = ItxLsThingLsThing.entityManager();
        TypedQuery<ItxLsThingLsThing> q = em.createQuery(
                "SELECT o FROM ItxLsThingLsThing AS o WHERE o.secondLsThing = :secondLsThing", ItxLsThingLsThing.class);
        q.setParameter("secondLsThing", secondLsThing);
        return q;
    }

    public static final List<String> fieldNames4OrderClauseFilter = java.util.Arrays.asList("logger", "firstLsThing",
            "secondLsThing", "lsStates");
    ...
    public static List<ItxLsThingLsThing> findAllItxLsThingLsThings() {
        return entityManager().createQuery("SELECT o FROM ItxLsThingLsThing o", ItxLsThingLsThing.class)
                .getResultList();
    }
    ...
    public static List<ItxLsThingLsThing> findItxLsThingLsThingEntries(int firstResult, int maxResults,
        ...
        return entityManager().createQuery(jpaQuery, ItxLsThingLsThing.class).setFirstResult(firstResult)
    ...
    public static Long countFindItxLsThingLsThingsByCodeNameEquals(String codeName) {
        if (codeName == null || codeName.length() == 0)
            throw new IllegalArgumentException("The codeName argument is required");
        EntityManager em = ItxLsThingLsThing.entityManager();
        TypedQuery q = em.createQuery("SELECT COUNT(o) FROM ItxLsThingLsThing AS o WHERE o.codeName = :codeName",
                Long.class);
        q.setParameter("codeName", codeName);
    ...
    public static Long countFindItxLsThingLsThingsByFirstLsThing(LsThing firstLsThing) {
        ...
        TypedQuery q = em.createQuery(
                "SELECT COUNT(o) FROM ItxLsThingLsThing AS o WHERE o.firstLsThing = :firstLsThing", Long.class);
        q.setParameter("firstLsThing", firstLsThing);
        return ((Long) q.getSingleResult());
    }
    ...
    public static Long countFindItxLsThingLsThingsBySecondLsThing(LsThing secondLsThing) {
        ...
        EntityManager em = ItxLsThingLsThing.entityManager();
        TypedQuery q = em.createQuery(
                "SELECT COUNT(o) FROM ItxLsThingLsThing AS o WHERE o.secondLsThing = :secondLsThing", Long.class);
        q.setParameter("secondLsThing", secondLsThing);
        return ((Long) q.getSingleResult());
    }
    ...
    public static TypedQuery<ItxLsThingLsThing> findItxLsThingLsThingsByCodeNameEquals(String codeName,
        ...
        StringBuilder queryBuilder = new StringBuilder(
                "SELECT o FROM ItxLsThingLsThing AS o WHERE o.codeName = :codeName");
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
    ...
    public static TypedQuery<ItxLsThingLsThing> findItxLsThingLsThingsByFirstLsThing(LsThing firstLsThing,
        ...
        EntityManager em = ItxLsThingLsThing.entityManager();
        StringBuilder queryBuilder = new StringBuilder(
                "SELECT o FROM ItxLsThingLsThing AS o WHERE o.firstLsThing = :firstLsThing");
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
            queryBuilder.append(" ORDER BY ").append(sortFieldName);
            if ("ASC".equalsIgnoreCase(sortOrder) || "DESC".equalsIgnoreCase(sortOrder)) {
                queryBuilder.append(" ").append(sortOrder);
    ...
    public static TypedQuery<ItxLsThingLsThing> findItxLsThingLsThingsBySecondLsThing(LsThing secondLsThing,
        ...
        EntityManager em = ItxLsThingLsThing.entityManager();
        StringBuilder queryBuilder = new StringBuilder(
                "SELECT o FROM ItxLsThingLsThing AS o WHERE o.secondLsThing = :secondLsThing");
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
            queryBuilder.append(" ORDER BY ").append(sortFieldName);
            if ("ASC".equalsIgnoreCase(sortOrder) || "DESC".equalsIgnoreCase(sortOrder)) {
                queryBuilder.append(" ").append(sortOrder);
