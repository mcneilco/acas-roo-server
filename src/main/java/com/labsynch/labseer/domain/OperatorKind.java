...
public class OperatorKind {
	...
	public static List<OperatorKind> findOperatorKindEntries(int firstResult, int maxResults, String sortFieldName, String sortOrder) {
        String jpaQuery = "SELECT o FROM OperatorKind o";
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
            jpaQuery = jpaQuery + " ORDER BY " + sortFieldName;
            if ("ASC".equalsIgnoreCase(sortOrder) || "DESC".equalsIgnoreCase(sortOrder)) {
	...
	public static TypedQuery<OperatorKind> findOperatorKindsByKindNameEqualsAndLsType(String kindName, OperatorType lsType) {
        if (kindName == null || kindName.length() == 0) throw new IllegalArgumentException("The kindName argument is required");
        if (lsType == null) throw new IllegalArgumentException("The lsType argument is required");
        EntityManager em = OperatorKind.entityManager();
	...
	public static TypedQuery<OperatorKind> findOperatorKindsByKindNameEqualsAndLsType(String kindName, OperatorType lsType, String sortFieldName, String sortOrder) {
        if (kindName == null || kindName.length() == 0) throw new IllegalArgumentException("The kindName argument is required");
        if (lsType == null) throw new IllegalArgumentException("The lsType argument is required");
        EntityManager em = OperatorKind.entityManager();
