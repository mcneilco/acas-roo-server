...
public class TreatmentGroupValue extends AbstractValue {
	...
	public static TreatmentGroupValue create(TreatmentGroupValue treatmentGroupValue) {
		TreatmentGroupValue newTreatmentGroupValue = new JSONDeserializer<TreatmentGroupValue>()
				.use(null, TreatmentGroupValue.class).deserializeInto(treatmentGroupValue.toJson(),
	...
	public static List<TreatmentGroupValue> findAllTreatmentGroupValues() {
		return entityManager().createQuery("SELECT o FROM TreatmentGroupValue o", TreatmentGroupValue.class)
				.getResultList();
	}
	...
	public static TreatmentGroupValue update(TreatmentGroupValue treatmentGroupValue) {
		TreatmentGroupValue updatedTreatmentGroupValue = new JSONDeserializer<TreatmentGroupValue>()
				...
				deserializeInto(treatmentGroupValue.toJson(),
						TreatmentGroupValue.findTreatmentGroupValue(treatmentGroupValue.getId()));
	...
	public static String getTreatmentGroupValueCollectionJson(List<Long> idList) {
		...
		for (Long id : idList) {
			...
			if (query != null)
				treatmentGroupValues.add(query);
		}
	...
	public static TreatmentGroupValue fromJsonToTreatmentGroupValue(String json) {
		return new JSONDeserializer<TreatmentGroupValue>().use(null, TreatmentGroupValue.class).

				deserialize(json);
	}

	public static Collection<TreatmentGroupValue> fromJsonArrayToTreatmentGroupValues(String json) {
		return new JSONDeserializer<List<TreatmentGroupValue>>().use(null, ArrayList.class)
	...
	public static TypedQuery<TreatmentGroupValue> findTreatmentGroupValuesByExptIDAndStateTypeKind(Long experimentId,
	...
	public static TypedQuery<TreatmentGroupValue> findTreatmentGroupValuesByAnalysisGroupIDAndStateTypeKind(
	...
	public static TypedQuery<TreatmentGroupValue> findTreatmentGroupValuesByExptIDAndStateTypeKindAndValueTypeKind(
	...
	public Collection<TreatmentGroupValueDTO> makeDTOsByAnalysisGroupIds() {
		...
		Collection<AnalysisGroup> analysisGroups = TreatmentGroup.findTreatmentGroup(this.getTreatmentGroupId())
				.getAnalysisGroups();
	...
	public static Long countFindTreatmentGroupValuesByCodeValueEquals(String codeValue) {
		...
		EntityManager em = TreatmentGroupValue.entityManager();
		TypedQuery q = em.createQuery("SELECT COUNT(o) FROM TreatmentGroupValue AS o WHERE o.codeValue = :codeValue",
				Long.class);
	...
	public static Long countFindTreatmentGroupValuesByLsState(TreatmentGroupState lsState) {
		...
		EntityManager em = TreatmentGroupValue.entityManager();
		TypedQuery q = em.createQuery("SELECT COUNT(o) FROM TreatmentGroupValue AS o WHERE o.lsState = :lsState",
				Long.class);
	...
	public static Long countFindTreatmentGroupValuesByLsTransactionEquals(Long lsTransaction) {
		...
		EntityManager em = TreatmentGroupValue.entityManager();
		TypedQuery q = em.createQuery(
				"SELECT COUNT(o) FROM TreatmentGroupValue AS o WHERE o.lsTransaction = :lsTransaction", Long.class);
	...
	public static TypedQuery<TreatmentGroupValue> findTreatmentGroupValuesByCodeValueEquals(String codeValue) {
		...
		TypedQuery<TreatmentGroupValue> q = em.createQuery(
				"SELECT o FROM TreatmentGroupValue AS o WHERE o.codeValue = :codeValue", TreatmentGroupValue.class);
		q.setParameter("codeValue", codeValue);
		return q;
	}
	...
	public static TypedQuery<TreatmentGroupValue> findTreatmentGroupValuesByCodeValueEquals(String codeValue,
		...
		StringBuilder queryBuilder = new StringBuilder(
				"SELECT o FROM TreatmentGroupValue AS o WHERE o.codeValue = :codeValue");
	...
	public static TypedQuery<TreatmentGroupValue> findTreatmentGroupValuesByIgnoredNotAndCodeValueEquals(
			boolean ignored, String codeValue) {
		if (codeValue == null || codeValue.length() == 0)
			throw new IllegalArgumentException("The codeValue argument is required");
		EntityManager em = TreatmentGroupValue.entityManager();
		TypedQuery<TreatmentGroupValue> q = em.createQuery(
	...
	public static TypedQuery<TreatmentGroupValue> findTreatmentGroupValuesByIgnoredNotAndCodeValueEquals(
			boolean ignored, String codeValue, String sortFieldName, String sortOrder) {
		if (codeValue == null || codeValue.length() == 0)
			throw new IllegalArgumentException("The codeValue argument is required");
		EntityManager em = TreatmentGroupValue.entityManager();
		StringBuilder queryBuilder = new StringBuilder(
	...
	public static TypedQuery<TreatmentGroupValue> findTreatmentGroupValuesByLsState(TreatmentGroupState lsState) {
		...
		EntityManager em = TreatmentGroupValue.entityManager();
		TypedQuery<TreatmentGroupValue> q = em.createQuery(
				"SELECT o FROM TreatmentGroupValue AS o WHERE o.lsState = :lsState", TreatmentGroupValue.class);
		q.setParameter("lsState", lsState);
		return q;
	}
	...
	public static TypedQuery<TreatmentGroupValue> findTreatmentGroupValuesByLsState(TreatmentGroupState lsState,
		...
		EntityManager em = TreatmentGroupValue.entityManager();
		StringBuilder queryBuilder = new StringBuilder(
				"SELECT o FROM TreatmentGroupValue AS o WHERE o.lsState = :lsState");
		if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
			queryBuilder.append(" ORDER BY ").append(sortFieldName);
			if ("ASC".equalsIgnoreCase(sortOrder) || "DESC".equalsIgnoreCase(sortOrder)) {
				queryBuilder.append(" ").append(sortOrder);
	...
	public static TypedQuery<TreatmentGroupValue> findTreatmentGroupValuesByLsTransactionEquals(Long lsTransaction) {
		...
		EntityManager em = TreatmentGroupValue.entityManager();
		TypedQuery<TreatmentGroupValue> q = em.createQuery(
				"SELECT o FROM TreatmentGroupValue AS o WHERE o.lsTransaction = :lsTransaction",
				TreatmentGroupValue.class);
		q.setParameter("lsTransaction", lsTransaction);
		return q;
	}
