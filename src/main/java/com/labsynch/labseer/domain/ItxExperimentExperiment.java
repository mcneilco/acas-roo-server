...
public class ItxExperimentExperiment extends AbstractThing {
    ...
    public static ItxExperimentExperiment update(ItxExperimentExperiment object) {
        ItxExperimentExperiment updatedObject = new JSONDeserializer<ItxExperimentExperiment>()
                .use(null, ItxExperimentExperiment.class).deserializeInto(object.toJson(),
    ...
    public static ItxExperimentExperiment updateNoStates(ItxExperimentExperiment itxExperimentExperiment) {
        ItxExperimentExperiment updatedItxExperimentExperiment = ItxExperimentExperiment
                .findItxExperimentExperiment(itxExperimentExperiment.getId());
        ...
        updatedItxExperimentExperiment.firstExperiment = Experiment
                .findExperiment(itxExperimentExperiment.getFirstExperiment().getId());
        updatedItxExperimentExperiment.secondExperiment = Experiment
                .findExperiment(itxExperimentExperiment.getSecondExperiment().getId());
        ...
        if (logger.isDebugEnabled())
            logger.debug(updatedItxExperimentExperiment.toJson());
    ...
    public static Long countFindItxExperimentExperimentsByFirstExperiment(Experiment firstExperiment) {
        if (firstExperiment == null)
            throw new IllegalArgumentException("The firstExperiment argument is required");
        EntityManager em = ItxExperimentExperiment.entityManager();
        TypedQuery q = em.createQuery(
                "SELECT COUNT(o) FROM ItxExperimentExperiment AS o WHERE o.firstExperiment = :firstExperiment",
                Long.class);
    ...
    public static Long countFindItxExperimentExperimentsByLsTransactionEquals(Long lsTransaction) {
        ...
        EntityManager em = ItxExperimentExperiment.entityManager();
        TypedQuery q = em.createQuery(
                "SELECT COUNT(o) FROM ItxExperimentExperiment AS o WHERE o.lsTransaction = :lsTransaction", Long.class);
        q.setParameter("lsTransaction", lsTransaction);
        return ((Long) q.getSingleResult());
    }

    public static Long countFindItxExperimentExperimentsBySecondExperiment(Experiment secondExperiment) {
        if (secondExperiment == null)
            throw new IllegalArgumentException("The secondExperiment argument is required");
        EntityManager em = ItxExperimentExperiment.entityManager();
        TypedQuery q = em.createQuery(
                "SELECT COUNT(o) FROM ItxExperimentExperiment AS o WHERE o.secondExperiment = :secondExperiment",
                Long.class);
        q.setParameter("secondExperiment", secondExperiment);
        return ((Long) q.getSingleResult());
    }

    public static TypedQuery<ItxExperimentExperiment> findItxExperimentExperimentsByFirstExperiment(
            Experiment firstExperiment) {
        if (firstExperiment == null)
            throw new IllegalArgumentException("The firstExperiment argument is required");
        EntityManager em = ItxExperimentExperiment.entityManager();
        TypedQuery<ItxExperimentExperiment> q = em.createQuery(
                "SELECT o FROM ItxExperimentExperiment AS o WHERE o.firstExperiment = :firstExperiment",
                ItxExperimentExperiment.class);
        q.setParameter("firstExperiment", firstExperiment);
        return q;
    }

    public static TypedQuery<ItxExperimentExperiment> findItxExperimentExperimentsByFirstExperiment(
            Experiment firstExperiment, String sortFieldName, String sortOrder) {
        if (firstExperiment == null)
            throw new IllegalArgumentException("The firstExperiment argument is required");
        EntityManager em = ItxExperimentExperiment.entityManager();
    ...
    public static TypedQuery<ItxExperimentExperiment> findItxExperimentExperimentsByLsTransactionEquals(
            Long lsTransaction) {
        if (lsTransaction == null)
            throw new IllegalArgumentException("The lsTransaction argument is required");
        EntityManager em = ItxExperimentExperiment.entityManager();
        TypedQuery<ItxExperimentExperiment> q = em.createQuery(
                "SELECT o FROM ItxExperimentExperiment AS o WHERE o.lsTransaction = :lsTransaction",
                ItxExperimentExperiment.class);
        q.setParameter("lsTransaction", lsTransaction);
        return q;
    }
    ...
    public static TypedQuery<ItxExperimentExperiment> findItxExperimentExperimentsBySecondExperiment(
            Experiment secondExperiment) {
        if (secondExperiment == null)
            throw new IllegalArgumentException("The secondExperiment argument is required");
        EntityManager em = ItxExperimentExperiment.entityManager();
        TypedQuery<ItxExperimentExperiment> q = em.createQuery(
                "SELECT o FROM ItxExperimentExperiment AS o WHERE o.secondExperiment = :secondExperiment",
                ItxExperimentExperiment.class);
        q.setParameter("secondExperiment", secondExperiment);
        return q;
    }
    ...
    public static TypedQuery<ItxExperimentExperiment> findItxExperimentExperimentsBySecondExperiment(
            Experiment secondExperiment, String sortFieldName, String sortOrder) {
        if (secondExperiment == null)
            throw new IllegalArgumentException("The secondExperiment argument is required");
        EntityManager em = ItxExperimentExperiment.entityManager();
        StringBuilder queryBuilder = new StringBuilder(
    ...
    public static final List<String> fieldNames4OrderClauseFilter = java.util.Arrays.asList("logger", "firstExperiment",
            "secondExperiment", "lsStates");

    public static long countItxExperimentExperiments() {
        return entityManager().createQuery("SELECT COUNT(o) FROM ItxExperimentExperiment o", Long.class)
                .getSingleResult();
    }

    public static List<ItxExperimentExperiment> findAllItxExperimentExperiments() {
        return entityManager().createQuery("SELECT o FROM ItxExperimentExperiment o", ItxExperimentExperiment.class)
                .getResultList();
    }

    public static List<ItxExperimentExperiment> findAllItxExperimentExperiments(String sortFieldName,
            String sortOrder) {
    ...
    public static List<ItxExperimentExperiment> findItxExperimentExperimentEntries(int firstResult, int maxResults,
        ...
        return entityManager().createQuery(jpaQuery, ItxExperimentExperiment.class).setFirstResult(firstResult)
