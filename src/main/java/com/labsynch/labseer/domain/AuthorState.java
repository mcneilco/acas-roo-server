...
public class AuthorState extends AbstractState {
    ...
    public static String toJsonArrayStub(Collection<com.labsynch.labseer.domain.AuthorState> collection) {
        return new JSONSerializer().exclude("*.class", "author").transform(new ExcludeNulls(), void.class)
                .serialize(collection);
    }

    public static Collection<com.labsynch.labseer.domain.AuthorState> fromJsonArrayToAuthorStates(String json) {
        return new JSONDeserializer<List<AuthorState>>().use(null, ArrayList.class).use("values", AuthorState.class)
                .deserialize(json);
    }
    ...
    public static List<AuthorState> findAuthorStateEntries(int firstResult, int maxResults) {
        return entityManager().createQuery("SELECT o FROM AuthorState o", AuthorState.class).setFirstResult(firstResult)
                .setMaxResults(maxResults).getResultList();
    }

    public static List<AuthorState> findAuthorStateEntries(int firstResult, int maxResults, String sortFieldName,
            String sortOrder) {
        String jpaQuery = "SELECT o FROM AuthorState o";
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
            jpaQuery = jpaQuery + " ORDER BY " + sortFieldName;
        ...
        return entityManager().createQuery(jpaQuery, AuthorState.class).setFirstResult(firstResult)
                .setMaxResults(maxResults).getResultList();
    }
    ...
    public static Long countFindAuthorStatesByAuthorAndLsTypeEqualsAndLsKindEqualsAndIgnoredNot(Author author,
            String lsType, String lsKind, boolean ignored) {
        if (author == null)
            throw new IllegalArgumentException("The author argument is required");
    ...
    public static Long countFindAuthorStatesByLsTransactionEquals(Long lsTransaction) {
        ...
        EntityManager em = AuthorState.entityManager();
        TypedQuery q = em.createQuery("SELECT COUNT(o) FROM AuthorState AS o WHERE o.lsTransaction = :lsTransaction",
                Long.class);
    ...
    public static Long countFindAuthorStatesByLsTypeAndKindEquals(String lsTypeAndKind) {
        ...
        EntityManager em = AuthorState.entityManager();
        TypedQuery q = em.createQuery("SELECT COUNT(o) FROM AuthorState AS o WHERE o.lsTypeAndKind = :lsTypeAndKind",
                Long.class);
    ...
    public static Long countFindAuthorStatesByLsTypeEqualsAndLsKindEquals(String lsType, String lsKind) {
        ...
        EntityManager em = AuthorState.entityManager();
        TypedQuery q = em.createQuery(
                "SELECT COUNT(o) FROM AuthorState AS o WHERE o.lsType = :lsType  AND o.lsKind = :lsKind", Long.class);
        q.setParameter("lsType", lsType);
        q.setParameter("lsKind", lsKind);
        return ((Long) q.getSingleResult());
    }
    ...
    public static TypedQuery<AuthorState> findAuthorStatesByAuthor(Author author) {
        if (author == null)
            throw new IllegalArgumentException("The author argument is required");
        EntityManager em = AuthorState.entityManager();
        TypedQuery<AuthorState> q = em.createQuery("SELECT o FROM AuthorState AS o WHERE o.author = :author",
                AuthorState.class);
        q.setParameter("author", author);
        return q;
    }

    public static TypedQuery<AuthorState> findAuthorStatesByAuthor(Author author, String sortFieldName,
            String sortOrder) {
        if (author == null)
            throw new IllegalArgumentException("The author argument is required");
        EntityManager em = AuthorState.entityManager();
    ...
    public static TypedQuery<AuthorState> findAuthorStatesByAuthorAndLsTypeEqualsAndLsKindEqualsAndIgnoredNot(
            Author author, String lsType, String lsKind, boolean ignored) {
        if (author == null)
            throw new IllegalArgumentException("The author argument is required");
        if (lsType == null || lsType.length() == 0)
            throw new IllegalArgumentException("The lsType argument is required");
    ...
    public static TypedQuery<AuthorState> findAuthorStatesByAuthorAndLsTypeEqualsAndLsKindEqualsAndIgnoredNot(
            Author author, String lsType, String lsKind, boolean ignored, String sortFieldName, String sortOrder) {
        if (author == null)
            throw new IllegalArgumentException("The author argument is required");
        if (lsType == null || lsType.length() == 0)
            throw new IllegalArgumentException("The lsType argument is required");
    ...
    public static TypedQuery<AuthorState> findAuthorStatesByLsTransactionEquals(Long lsTransaction) {
        ...
        EntityManager em = AuthorState.entityManager();
        TypedQuery<AuthorState> q = em.createQuery(
                "SELECT o FROM AuthorState AS o WHERE o.lsTransaction = :lsTransaction", AuthorState.class);
        q.setParameter("lsTransaction", lsTransaction);
        return q;
    }
    ...
    public static TypedQuery<AuthorState> findAuthorStatesByLsTransactionEquals(Long lsTransaction,
        ...
        EntityManager em = AuthorState.entityManager();
        StringBuilder queryBuilder = new StringBuilder(
                "SELECT o FROM AuthorState AS o WHERE o.lsTransaction = :lsTransaction");
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
            queryBuilder.append(" ORDER BY ").append(sortFieldName);
            if ("ASC".equalsIgnoreCase(sortOrder) || "DESC".equalsIgnoreCase(sortOrder)) {
                queryBuilder.append(" ").append(sortOrder);
    ...
    public static TypedQuery<AuthorState> findAuthorStatesByLsTypeAndKindEquals(String lsTypeAndKind) {
        ...
        EntityManager em = AuthorState.entityManager();
        TypedQuery<AuthorState> q = em.createQuery(
                "SELECT o FROM AuthorState AS o WHERE o.lsTypeAndKind = :lsTypeAndKind", AuthorState.class);
        q.setParameter("lsTypeAndKind", lsTypeAndKind);
        return q;
    }
    ...
    public static TypedQuery<AuthorState> findAuthorStatesByLsTypeAndKindEquals(String lsTypeAndKind,
        ...
        EntityManager em = AuthorState.entityManager();
        StringBuilder queryBuilder = new StringBuilder(
                "SELECT o FROM AuthorState AS o WHERE o.lsTypeAndKind = :lsTypeAndKind");
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
            queryBuilder.append(" ORDER BY ").append(sortFieldName);
            if ("ASC".equalsIgnoreCase(sortOrder) || "DESC".equalsIgnoreCase(sortOrder)) {
                queryBuilder.append(" ").append(sortOrder);
    ...
    public static TypedQuery<AuthorState> findAuthorStatesByLsTypeEqualsAndLsKindEquals(String lsType, String lsKind) {
        ...
        EntityManager em = AuthorState.entityManager();
        TypedQuery<AuthorState> q = em.createQuery(
                "SELECT o FROM AuthorState AS o WHERE o.lsType = :lsType  AND o.lsKind = :lsKind", AuthorState.class);
        q.setParameter("lsType", lsType);
        q.setParameter("lsKind", lsKind);
        return q;
    }
    ...
    public static TypedQuery<AuthorState> findAuthorStatesByLsTypeEqualsAndLsKindEquals(String lsType, String lsKind,
        ...
        EntityManager em = AuthorState.entityManager();
        StringBuilder queryBuilder = new StringBuilder(
                "SELECT o FROM AuthorState AS o WHERE o.lsType = :lsType  AND o.lsKind = :lsKind");
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
            queryBuilder.append(" ORDER BY ").append(sortFieldName);
            if ("ASC".equalsIgnoreCase(sortOrder) || "DESC".equalsIgnoreCase(sortOrder)) {
                queryBuilder.append(" ").append(sortOrder);
