...
public class CmpdRegAppSetting {
    ...
    public static List<CmpdRegAppSetting> findAllCmpdRegAppSettings() {
        return entityManager().createQuery("SELECT o FROM CmpdRegAppSetting o", CmpdRegAppSetting.class)
                .getResultList();
    }
    ...
    public static List<CmpdRegAppSetting> findCmpdRegAppSettingEntries(int firstResult, int maxResults,
        ...
        return entityManager().createQuery(jpaQuery, CmpdRegAppSetting.class).setFirstResult(firstResult)
