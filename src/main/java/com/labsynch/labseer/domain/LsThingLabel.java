...
public class LsThingLabel extends AbstractLabel {
	...
	public static Long countOfLsThingLabelsByLabel(LsThing lsThing, String labelType, String labelKind,
			String labelText) {
		if (lsThing == null)
			throw new IllegalArgumentException("The lsThing argument is required");
	...
	public static Long countOfLsThingByName(String thingType, String thingKind, String labelType, String labelKind,
			String labelText) {
	...
	public static Long countOfLsThingByPreferredName(String thingType, String thingKind, String labelType,
	...
	public static Long countOfAllLsThingByPreferredName(String thingType, String thingKind, String labelType,
			String labelKind, String labelText) {
		if (thingType == null || thingType.length() == 0)
			throw new IllegalArgumentException("The thingType argument is required");
		if (thingKind == null || thingKind.length() == 0)
	...
	public static TypedQuery<LsThingLabel> findLsThingName(String thingType, String thingKind, String labelType,
			String labelKind, String labelText) {
		if (thingType == null || thingType.length() == 0)
			throw new IllegalArgumentException("The thingType argument is required");
		if (thingKind == null || thingKind.length() == 0)
	...
	public static TypedQuery<LsThingLabel> findLsThingPreferredName(String thingType, String thingKind,
	...
	public static TypedQuery<LsThingLabel> findLsThingPreferredName(Long lsThingId, String labelType,
			String labelKind) {
		if (lsThingId == null || lsThingId == 0)
			throw new IllegalArgumentException("The lsThingId argument is required");
		if (labelType == null || labelType.length() == 0)
			throw new IllegalArgumentException("The labelType argument is required");
		if (labelKind == null || labelKind.length() == 0)
			throw new IllegalArgumentException("The labelKind argument is required");
	...
	public static TypedQuery<LsThingLabel> findLsThingAllPreferredName(Long lsThingId, String labelType,
			String labelKind) {
		if (lsThingId == null || lsThingId == 0)
			throw new IllegalArgumentException("The lsThingId argument is required");
		if (labelType == null || labelType.length() == 0)
	...
	public static Collection<LsThingLabel> fromJsonArrayToLsThingLabels(String json) {
		return new JSONDeserializer<List<LsThingLabel>>().use(null, ArrayList.class).use("values", LsThingLabel.class)
				.deserialize(json);
	}
	...
	@Transactional
	public static LsThingLabel saveLsThingLabel(LsTransaction lsTransaction, String recordedBy, LsThing lsThing,
	...
	@Transactional
	public static List<LsThingLabel> saveLsThingLabels(LsTransaction lsTransaction, String recordedBy, LsThing lsThing,
			String labelType, String labelKind, boolean preferred, String labels, String labelSeparator) {
	...
	public static TypedQuery<PreferredNameDTO> findLsThingPreferredName(String thingType, String thingKind,
			String labelType, String labelKind, Collection<String> requestNameList) {
	...
	public static final List<String> fieldNames4OrderClauseFilter = java.util.Arrays.asList("logger", "lsThing",
			"lsThingTypeAndKind");
	...
	public static List<LsThingLabel> findLsThingLabelEntries(int firstResult, int maxResults) {
		return entityManager().createQuery("SELECT o FROM LsThingLabel o", LsThingLabel.class)
				.setFirstResult(firstResult).setMaxResults(maxResults).getResultList();
	}

	public static List<LsThingLabel> findLsThingLabelEntries(int firstResult, int maxResults, String sortFieldName,
			String sortOrder) {
		String jpaQuery = "SELECT o FROM LsThingLabel o";
		if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
			jpaQuery = jpaQuery + " ORDER BY " + sortFieldName;
		...
		return entityManager().createQuery(jpaQuery, LsThingLabel.class).setFirstResult(firstResult)
	...
	public static Long countFindLsThingLabelsByLabelTextEquals(String labelText) {
		if (labelText == null || labelText.length() == 0)
			throw new IllegalArgumentException("The labelText argument is required");
		EntityManager em = LsThingLabel.entityManager();
		TypedQuery q = em.createQuery("SELECT COUNT(o) FROM LsThingLabel AS o WHERE o.labelText = :labelText",
				Long.class);
		q.setParameter("labelText", labelText);
	...
	public static Long countFindLsThingLabelsByLabelTextLike(String labelText) {
		...
		EntityManager em = LsThingLabel.entityManager();
		TypedQuery q = em.createQuery(
				"SELECT COUNT(o) FROM LsThingLabel AS o WHERE LOWER(o.labelText) LIKE LOWER(:labelText)", Long.class);
		q.setParameter("labelText", labelText);
		return ((Long) q.getSingleResult());
	}
	...
	public static Long countFindLsThingLabelsByLsTransactionEquals(Long lsTransaction) {
		...
		EntityManager em = LsThingLabel.entityManager();
		TypedQuery q = em.createQuery("SELECT COUNT(o) FROM LsThingLabel AS o WHERE o.lsTransaction = :lsTransaction",
				Long.class);
	...
	public static TypedQuery<LsThingLabel> findLsThingLabelsByLabelTextEquals(String labelText) {
		if (labelText == null || labelText.length() == 0)
			throw new IllegalArgumentException("The labelText argument is required");
		EntityManager em = LsThingLabel.entityManager();
		TypedQuery<LsThingLabel> q = em.createQuery("SELECT o FROM LsThingLabel AS o WHERE o.labelText = :labelText",
				LsThingLabel.class);
		q.setParameter("labelText", labelText);
		return q;
	}

	public static TypedQuery<LsThingLabel> findLsThingLabelsByLabelTextEquals(String labelText, String sortFieldName,
			String sortOrder) {
		if (labelText == null || labelText.length() == 0)
			throw new IllegalArgumentException("The labelText argument is required");
		EntityManager em = LsThingLabel.entityManager();
		StringBuilder queryBuilder = new StringBuilder(
				"SELECT o FROM LsThingLabel AS o WHERE o.labelText = :labelText");
		if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
	...
	public static TypedQuery<LsThingLabel> findLsThingLabelsByLabelTextEqualsAndIgnoredNot(String labelText,
			boolean ignored) {
		if (labelText == null || labelText.length() == 0)
			throw new IllegalArgumentException("The labelText argument is required");
		EntityManager em = LsThingLabel.entityManager();
	...
	public static TypedQuery<LsThingLabel> findLsThingLabelsByLabelTextLike(String labelText) {
		...
		EntityManager em = LsThingLabel.entityManager();
		TypedQuery<LsThingLabel> q = em.createQuery(
				"SELECT o FROM LsThingLabel AS o WHERE LOWER(o.labelText) LIKE LOWER(:labelText)", LsThingLabel.class);
		q.setParameter("labelText", labelText);
		return q;
	}

	public static TypedQuery<LsThingLabel> findLsThingLabelsByLabelTextLike(String labelText, String sortFieldName,
			String sortOrder) {
		if (labelText == null || labelText.length() == 0)
			throw new IllegalArgumentException("The labelText argument is required");
		labelText = labelText.replace('*', '%');
		...
		EntityManager em = LsThingLabel.entityManager();
		StringBuilder queryBuilder = new StringBuilder(
				"SELECT o FROM LsThingLabel AS o WHERE LOWER(o.labelText) LIKE LOWER(:labelText)");
		if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
			queryBuilder.append(" ORDER BY ").append(sortFieldName);
			if ("ASC".equalsIgnoreCase(sortOrder) || "DESC".equalsIgnoreCase(sortOrder)) {
				queryBuilder.append(" ").append(sortOrder);
	...
	public static TypedQuery<LsThingLabel> findLsThingLabelsByLsThing(LsThing lsThing) {
		if (lsThing == null)
			throw new IllegalArgumentException("The lsThing argument is required");
		EntityManager em = LsThingLabel.entityManager();
		TypedQuery<LsThingLabel> q = em.createQuery("SELECT o FROM LsThingLabel AS o WHERE o.lsThing = :lsThing",
				LsThingLabel.class);
		q.setParameter("lsThing", lsThing);
		return q;
	}

	public static TypedQuery<LsThingLabel> findLsThingLabelsByLsThing(LsThing lsThing, String sortFieldName,
			String sortOrder) {
		if (lsThing == null)
			throw new IllegalArgumentException("The lsThing argument is required");
		EntityManager em = LsThingLabel.entityManager();
	...
	public static TypedQuery<LsThingLabel> findLsThingLabelsByLsTransactionEquals(Long lsTransaction) {
		...
		EntityManager em = LsThingLabel.entityManager();
		TypedQuery<LsThingLabel> q = em.createQuery(
				"SELECT o FROM LsThingLabel AS o WHERE o.lsTransaction = :lsTransaction", LsThingLabel.class);
		q.setParameter("lsTransaction", lsTransaction);
		return q;
	}
	...
	public static TypedQuery<LsThingLabel> findLsThingLabelsByLsTransactionEquals(Long lsTransaction,
		...
		EntityManager em = LsThingLabel.entityManager();
		StringBuilder queryBuilder = new StringBuilder(
				"SELECT o FROM LsThingLabel AS o WHERE o.lsTransaction = :lsTransaction");
		if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
			queryBuilder.append(" ORDER BY ").append(sortFieldName);
			if ("ASC".equalsIgnoreCase(sortOrder) || "DESC".equalsIgnoreCase(sortOrder)) {
				queryBuilder.append(" ").append(sortOrder);
