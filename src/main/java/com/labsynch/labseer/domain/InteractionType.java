...
public class InteractionType {
    ...
    public static com.labsynch.labseer.domain.InteractionType getOrCreate(String typeVerb, String typeName) {
        ...
        List<InteractionType> itxTypes = InteractionType
                .findInteractionTypesByTypeNameEqualsAndTypeVerbEquals(typeName, typeVerb).getResultList();
        if (itxTypes.size() == 0) {
    ...
    public static final List<String> fieldNames4OrderClauseFilter = java.util.Arrays.asList("logger", "typeName",
            "typeVerb");
    ...
    public static List<InteractionType> findInteractionTypeEntries(int firstResult, int maxResults) {
        return entityManager().createQuery("SELECT o FROM InteractionType o", InteractionType.class)
    ...
    public static List<InteractionType> findInteractionTypeEntries(int firstResult, int maxResults,
        ...
        return entityManager().createQuery(jpaQuery, InteractionType.class).setFirstResult(firstResult)
    ...
    public static Long countFindInteractionTypesByTypeNameEquals(String typeName) {
        ...
        TypedQuery q = em.createQuery("SELECT COUNT(o) FROM InteractionType AS o WHERE o.typeName = :typeName",
                Long.class);
    ...
    public static Long countFindInteractionTypesByTypeNameEqualsAndTypeVerbEquals(String typeName, String typeVerb) {
        if (typeName == null || typeName.length() == 0)
            throw new IllegalArgumentException("The typeName argument is required");
        if (typeVerb == null || typeVerb.length() == 0)
            throw new IllegalArgumentException("The typeVerb argument is required");
        EntityManager em = InteractionType.entityManager();
        TypedQuery q = em.createQuery(
                "SELECT COUNT(o) FROM InteractionType AS o WHERE o.typeName = :typeName  AND o.typeVerb = :typeVerb",
                Long.class);
        q.setParameter("typeName", typeName);
    ...
    public static TypedQuery<InteractionType> findInteractionTypesByTypeNameEquals(String typeName) {
        if (typeName == null || typeName.length() == 0)
            throw new IllegalArgumentException("The typeName argument is required");
        EntityManager em = InteractionType.entityManager();
        TypedQuery<InteractionType> q = em
                .createQuery("SELECT o FROM InteractionType AS o WHERE o.typeName = :typeName", InteractionType.class);
        q.setParameter("typeName", typeName);
        return q;
    }
    ...
    public static TypedQuery<InteractionType> findInteractionTypesByTypeNameEquals(String typeName,
        ...
        StringBuilder queryBuilder = new StringBuilder(
                "SELECT o FROM InteractionType AS o WHERE o.typeName = :typeName");
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
    ...
    public static TypedQuery<InteractionType> findInteractionTypesByTypeNameEqualsAndTypeVerbEquals(String typeName,
            String typeVerb) {
        if (typeName == null || typeName.length() == 0)
            throw new IllegalArgumentException("The typeName argument is required");
        if (typeVerb == null || typeVerb.length() == 0)
            throw new IllegalArgumentException("The typeVerb argument is required");
        EntityManager em = InteractionType.entityManager();
        TypedQuery<InteractionType> q = em.createQuery(
                "SELECT o FROM InteractionType AS o WHERE o.typeName = :typeName  AND o.typeVerb = :typeVerb",
    ...
    public static TypedQuery<InteractionType> findInteractionTypesByTypeNameEqualsAndTypeVerbEquals(String typeName,
            String typeVerb, String sortFieldName, String sortOrder) {
        if (typeName == null || typeName.length() == 0)
            throw new IllegalArgumentException("The typeName argument is required");
        if (typeVerb == null || typeVerb.length() == 0)
            throw new IllegalArgumentException("The typeVerb argument is required");
