...
//31 columns
	...
	public static final List<String> fieldNames4OrderClauseFilter = java.util.Arrays.asList("lsType", "lsKind", "lsTypeAndKind", "codeOrigin", "codeType", "codeKind", "codeTypeAndKind", "stringValue", "codeValue", "fileValue", "urlValue", "dateValue", "clobValue", "blobValue", "operatorType", "operatorKind", "operatorTypeAndKind", "numericValue", "sigFigs", "uncertainty", "numberOfReplicates", "uncertaintyType", "unitType", "unitKind", "unitTypeAndKind", "concentration", "concUnit", "comments", "ignored", "deleted", "lsTransaction", "recordedDate", "recordedBy", "modifiedDate", "modifiedBy", "publicData", "id", "entityManager");
	...
	public static List<AbstractValue> findAbstractValueEntries(int firstResult, int maxResults, String sortFieldName, String sortOrder) {
        String jpaQuery = "SELECT o FROM AbstractValue o";
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
            jpaQuery = jpaQuery + " ORDER BY " + sortFieldName;
            if ("ASC".equalsIgnoreCase(sortOrder) || "DESC".equalsIgnoreCase(sortOrder)) {
