...
public class ProtocolKind {
    ...
    public static List<com.labsynch.labseer.domain.ProtocolKind> findProtocolKindEntries(int firstResult,
            int maxResults) {
        return entityManager().createQuery("SELECT o FROM ProtocolKind o", ProtocolKind.class)
    ...
    public static Long countFindProtocolKindsByLsTypeEqualsAndKindNameEquals(ProtocolType lsType, String kindName) {
        ...
        TypedQuery q = em.createQuery(
                "SELECT COUNT(o) FROM ProtocolKind AS o WHERE o.lsType = :lsType  AND o.kindName = :kindName",
                Long.class);
    ...
    public static TypedQuery<ProtocolKind> findProtocolKindsByLsTypeEqualsAndKindNameEquals(ProtocolType lsType,
            String kindName) {
        if (lsType == null)
            throw new IllegalArgumentException("The lsType argument is required");
        if (kindName == null || kindName.length() == 0)
            throw new IllegalArgumentException("The kindName argument is required");
        EntityManager em = ProtocolKind.entityManager();
        TypedQuery<ProtocolKind> q = em.createQuery(
                "SELECT o FROM ProtocolKind AS o WHERE o.lsType = :lsType  AND o.kindName = :kindName",
                ProtocolKind.class);
        q.setParameter("lsType", lsType);
        q.setParameter("kindName", kindName);
        return q;
    ...
    public static final List<String> fieldNames4OrderClauseFilter = java.util.Arrays.asList("id", "version", "lsType",
            "kindName", "lsTypeAndKind", "entityManager");
    ...
    public static List<ProtocolKind> findProtocolKindEntries(int firstResult, int maxResults, String sortFieldName,
            String sortOrder) {
        String jpaQuery = "SELECT o FROM ProtocolKind o";
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
            jpaQuery = jpaQuery + " ORDER BY " + sortFieldName;
        ...
        return entityManager().createQuery(jpaQuery, ProtocolKind.class).setFirstResult(firstResult)
