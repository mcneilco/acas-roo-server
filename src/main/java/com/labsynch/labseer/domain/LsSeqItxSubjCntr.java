...
public class LsSeqItxSubjCntr {
    ...
    public static List<LsSeqItxSubjCntr> findLsSeqItxSubjCntrEntries(int firstResult, int maxResults) {
        return entityManager().createQuery("SELECT o FROM LsSeqItxSubjCntr o", LsSeqItxSubjCntr.class)
    ...
    public static List<LsSeqItxSubjCntr> findLsSeqItxSubjCntrEntries(int firstResult, int maxResults,
        ...
        return entityManager().createQuery(jpaQuery, LsSeqItxSubjCntr.class).setFirstResult(firstResult)
