...
public class StateKind {
    ...
    public static List<com.labsynch.labseer.domain.StateKind> findStateKindEntries(int firstResult, int maxResults) {
        return entityManager().createQuery("SELECT o FROM StateKind o", StateKind.class).setFirstResult(firstResult)
    ...
    public static List<StateKind> findStateKindEntries(int firstResult, int maxResults, String sortFieldName,
            String sortOrder) {
        String jpaQuery = "SELECT o FROM StateKind o";
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
            jpaQuery = jpaQuery + " ORDER BY " + sortFieldName;
        ...
        return entityManager().createQuery(jpaQuery, StateKind.class).setFirstResult(firstResult)
                .setMaxResults(maxResults).getResultList();
    }
    ...
    public static Long countFindStateKindsByKindNameEqualsAndLsType(String kindName, StateType lsType) {
        ...
        TypedQuery q = em.createQuery(
                "SELECT COUNT(o) FROM StateKind AS o WHERE o.kindName = :kindName  AND o.lsType = :lsType", Long.class);
        q.setParameter("kindName", kindName);
    ...
    public static TypedQuery<StateKind> findStateKindsByKindNameEquals(String kindName) {
        if (kindName == null || kindName.length() == 0)
            throw new IllegalArgumentException("The kindName argument is required");
        EntityManager em = StateKind.entityManager();
        TypedQuery<StateKind> q = em.createQuery("SELECT o FROM StateKind AS o WHERE o.kindName = :kindName",
                StateKind.class);
        q.setParameter("kindName", kindName);
        return q;
    }

    public static TypedQuery<StateKind> findStateKindsByKindNameEquals(String kindName, String sortFieldName,
            String sortOrder) {
        if (kindName == null || kindName.length() == 0)
            throw new IllegalArgumentException("The kindName argument is required");
        EntityManager em = StateKind.entityManager();
    ...
    public static TypedQuery<StateKind> findStateKindsByKindNameEqualsAndLsType(String kindName, StateType lsType) {
        ...
        if (lsType == null)
            throw new IllegalArgumentException("The lsType argument is required");
        EntityManager em = StateKind.entityManager();
        TypedQuery<StateKind> q = em.createQuery(
                "SELECT o FROM StateKind AS o WHERE o.kindName = :kindName  AND o.lsType = :lsType", StateKind.class);
        q.setParameter("kindName", kindName);
        q.setParameter("lsType", lsType);
        return q;
    }
    ...
    public static TypedQuery<StateKind> findStateKindsByKindNameEqualsAndLsType(String kindName, StateType lsType,
        ...
        StringBuilder queryBuilder = new StringBuilder(
                "SELECT o FROM StateKind AS o WHERE o.kindName = :kindName  AND o.lsType = :lsType");
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
            queryBuilder.append(" ORDER BY ").append(sortFieldName);
            if ("ASC".equalsIgnoreCase(sortOrder) || "DESC".equalsIgnoreCase(sortOrder)) {
                queryBuilder.append(" ").append(sortOrder);
    ...
    public static TypedQuery<StateKind> findStateKindsByLsType(StateType lsType) {
        if (lsType == null)
            throw new IllegalArgumentException("The lsType argument is required");
        EntityManager em = StateKind.entityManager();
        TypedQuery<StateKind> q = em.createQuery("SELECT o FROM StateKind AS o WHERE o.lsType = :lsType",
                StateKind.class);
        q.setParameter("lsType", lsType);
        return q;
    }

    public static TypedQuery<StateKind> findStateKindsByLsType(StateType lsType, String sortFieldName,
            String sortOrder) {
        if (lsType == null)
            throw new IllegalArgumentException("The lsType argument is required");
        EntityManager em = StateKind.entityManager();
