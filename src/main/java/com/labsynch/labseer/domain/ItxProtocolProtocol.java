...
public class ItxProtocolProtocol extends AbstractThing {
    ...
    public static ItxProtocolProtocol update(ItxProtocolProtocol object) {
        ItxProtocolProtocol updatedObject = new JSONDeserializer<ItxProtocolProtocol>()
                .use(null, ItxProtocolProtocol.class).deserializeInto(object.toJson(),
    ...
    public static ItxProtocolProtocol updateNoStates(ItxProtocolProtocol itxProtocolProtocol) {
        ItxProtocolProtocol updatedItxProtocolProtocol = ItxProtocolProtocol
                .findItxProtocolProtocol(itxProtocolProtocol.getId());
        ...
        updatedItxProtocolProtocol.firstProtocol = Protocol
                .findProtocol(itxProtocolProtocol.getFirstProtocol().getId());
        updatedItxProtocolProtocol.secondProtocol = Protocol
                .findProtocol(itxProtocolProtocol.getSecondProtocol().getId());
        ...
        if (logger.isDebugEnabled())
            logger.debug(updatedItxProtocolProtocol.toJson());
    ...
    public static TypedQuery<ItxProtocolProtocol> findItxProtocolProtocolsByFirstProtocol(Protocol firstProtocol) {
        if (firstProtocol == null)
            throw new IllegalArgumentException("The firstProtocol argument is required");
        EntityManager em = ItxProtocolProtocol.entityManager();
        TypedQuery<ItxProtocolProtocol> q = em.createQuery(
                "SELECT o FROM ItxProtocolProtocol AS o WHERE o.firstProtocol = :firstProtocol",
                ItxProtocolProtocol.class);
    ...
    public static TypedQuery<ItxProtocolProtocol> findItxProtocolProtocolsByLsTransactionEquals(Long lsTransaction) {
        ...
        EntityManager em = ItxProtocolProtocol.entityManager();
        TypedQuery<ItxProtocolProtocol> q = em.createQuery(
                "SELECT o FROM ItxProtocolProtocol AS o WHERE o.lsTransaction = :lsTransaction",
                ItxProtocolProtocol.class);
    ...
    public static TypedQuery<ItxProtocolProtocol> findItxProtocolProtocolsBySecondProtocol(Protocol secondProtocol) {
        if (secondProtocol == null)
            throw new IllegalArgumentException("The secondProtocol argument is required");
        EntityManager em = ItxProtocolProtocol.entityManager();
        TypedQuery<ItxProtocolProtocol> q = em.createQuery(
                "SELECT o FROM ItxProtocolProtocol AS o WHERE o.secondProtocol = :secondProtocol",
                ItxProtocolProtocol.class);
    ...
    public static Long countFindItxProtocolProtocolsByFirstProtocol(Protocol firstProtocol) {
        ...
        TypedQuery q = em.createQuery(
                "SELECT COUNT(o) FROM ItxProtocolProtocol AS o WHERE o.firstProtocol = :firstProtocol", Long.class);
        q.setParameter("firstProtocol", firstProtocol);
    ...
    public static Long countFindItxProtocolProtocolsByLsTransactionEquals(Long lsTransaction) {
        ...
        EntityManager em = ItxProtocolProtocol.entityManager();
        TypedQuery q = em.createQuery(
                "SELECT COUNT(o) FROM ItxProtocolProtocol AS o WHERE o.lsTransaction = :lsTransaction", Long.class);
        q.setParameter("lsTransaction", lsTransaction);
        return ((Long) q.getSingleResult());
    }
    ...
    public static Long countFindItxProtocolProtocolsBySecondProtocol(Protocol secondProtocol) {
        ...
        EntityManager em = ItxProtocolProtocol.entityManager();
        TypedQuery q = em.createQuery(
                "SELECT COUNT(o) FROM ItxProtocolProtocol AS o WHERE o.secondProtocol = :secondProtocol", Long.class);
        q.setParameter("secondProtocol", secondProtocol);
        return ((Long) q.getSingleResult());
    }
    ...
    public static final List<String> fieldNames4OrderClauseFilter = java.util.Arrays.asList("logger", "firstProtocol",
            "secondProtocol", "lsStates");
    ...
    public static List<ItxProtocolProtocol> findAllItxProtocolProtocols() {
        return entityManager().createQuery("SELECT o FROM ItxProtocolProtocol o", ItxProtocolProtocol.class)
                .getResultList();
    }
    ...
    public static List<ItxProtocolProtocol> findItxProtocolProtocolEntries(int firstResult, int maxResults,
        ...
        return entityManager().createQuery(jpaQuery, ItxProtocolProtocol.class).setFirstResult(firstResult)
