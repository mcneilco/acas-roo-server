...
@RooJpaActiveRecord(sequenceName = "LSSEQ_ITXPROTPROT_PKSEQ" )
public class LsSeqItxProtocolProtocol {
	...
	public static List<LsSeqItxProtocolProtocol> findAllLsSeqItxProtocolProtocols(String sortFieldName, String sortOrder) {
	...
	public static List<LsSeqItxProtocolProtocol> findLsSeqItxProtocolProtocolEntries(int firstResult, int maxResults, String sortFieldName, String sortOrder) {
        String jpaQuery = "SELECT o FROM LsSeqItxProtocolProtocol o";
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
            jpaQuery = jpaQuery + " ORDER BY " + sortFieldName;
            if ("ASC".equalsIgnoreCase(sortOrder) || "DESC".equalsIgnoreCase(sortOrder)) {
