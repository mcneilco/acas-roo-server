...
privileged aspect BBChemSaltStructure_Roo_Finder {
    
    public static Long BBChemSaltStructure.countFindBBChemSaltStructuresByPreRegEquals(String preReg) {
    ...
    public static Long BBChemSaltStructure.countFindBBChemSaltStructuresByRegEquals(String reg) {
    ...
    public static TypedQuery<BBChemSaltStructure> BBChemSaltStructure.findBBChemSaltStructuresByPreRegEquals(String preReg) {
        if (preReg == null || preReg.length() == 0) throw new IllegalArgumentException("The preReg argument is required");
        EntityManager em = BBChemSaltStructure.entityManager();
    ...
    public static TypedQuery<BBChemSaltStructure> BBChemSaltStructure.findBBChemSaltStructuresByPreRegEquals(String preReg, String sortFieldName, String sortOrder) {
        if (preReg == null || preReg.length() == 0) throw new IllegalArgumentException("The preReg argument is required");
        EntityManager em = BBChemSaltStructure.entityManager();
    ...
    public static TypedQuery<BBChemSaltStructure> BBChemSaltStructure.findBBChemSaltStructuresByRegEquals(String reg) {
        if (reg == null || reg.length() == 0) throw new IllegalArgumentException("The reg argument is required");
        EntityManager em = BBChemSaltStructure.entityManager();
    ...
    public static TypedQuery<BBChemSaltStructure> BBChemSaltStructure.findBBChemSaltStructuresByRegEquals(String reg, String sortFieldName, String sortOrder) {
        if (reg == null || reg.length() == 0) throw new IllegalArgumentException("The reg argument is required");
        EntityManager em = BBChemSaltStructure.entityManager();
