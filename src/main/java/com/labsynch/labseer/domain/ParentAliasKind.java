...
public class ParentAliasKind {
    ...
    public static List<ParentAliasKind> findParentAliasKindEntries(int firstResult, int maxResults) {
        return entityManager().createQuery("SELECT o FROM ParentAliasKind o", ParentAliasKind.class)
    ...
    public static List<ParentAliasKind> findParentAliasKindEntries(int firstResult, int maxResults,
        ...
        return entityManager().createQuery(jpaQuery, ParentAliasKind.class).setFirstResult(firstResult)
