...
public class ProtocolValue extends AbstractValue {
    ...
    public static Collection<com.labsynch.labseer.domain.ProtocolValue> fromJsonArrayToProtocolValues(String json) {
        return new JSONDeserializer<List<ProtocolValue>>().use(null, ArrayList.class).use("values", ProtocolValue.class)
                .deserialize(json);
    }
    ...
    public static com.labsynch.labseer.domain.ProtocolValue update(
            com.labsynch.labseer.domain.ProtocolValue protocolValue) {
        ProtocolValue updatedProtocolValue = new JSONDeserializer<ProtocolValue>().use(null, ProtocolValue.class)
    ...
    public static TypedQuery<ProtocolValue> findProtocolValuesByLsKindEqualsAndDateValueLike(String lsKind,
            Date dateValue) {
        ...
        TypedQuery<ProtocolValue> q = em.createQuery(
                "SELECT o FROM ProtocolValue AS o WHERE o.lsKind = :lsKind AND o.ignored = false AND o.dateValue > :beforeDate AND o.dateValue < :afterDate ",
                ProtocolValue.class);
    ...
    public static List<ProtocolValue> findProtocolValueEntries(int firstResult, int maxResults) {
        return entityManager().createQuery("SELECT o FROM ProtocolValue o", ProtocolValue.class)
                .setFirstResult(firstResult).setMaxResults(maxResults).getResultList();
    }

    public static List<ProtocolValue> findProtocolValueEntries(int firstResult, int maxResults, String sortFieldName,
            String sortOrder) {
        String jpaQuery = "SELECT o FROM ProtocolValue o";
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
            jpaQuery = jpaQuery + " ORDER BY " + sortFieldName;
        ...
        return entityManager().createQuery(jpaQuery, ProtocolValue.class).setFirstResult(firstResult)
    ...
    public static Long countFindProtocolValuesByLsKindEqualsAndCodeValueLike(String lsKind, String codeValue) {
        ...
        TypedQuery q = em.createQuery(
                "SELECT COUNT(o) FROM ProtocolValue AS o WHERE o.lsKind = :lsKind  AND LOWER(o.codeValue) LIKE LOWER(:codeValue)",
                Long.class);
        q.setParameter("lsKind", lsKind);
    ...
    public static Long countFindProtocolValuesByLsKindEqualsAndStringValueLike(String lsKind, String stringValue) {
        ...
        EntityManager em = ProtocolValue.entityManager();
        TypedQuery q = em.createQuery(
                "SELECT COUNT(o) FROM ProtocolValue AS o WHERE o.lsKind = :lsKind  AND LOWER(o.stringValue) LIKE LOWER(:stringValue)",
                Long.class);
        q.setParameter("lsKind", lsKind);
    ...
    public static Long countFindProtocolValuesByLsTransactionEquals(Long lsTransaction) {
        ...
        EntityManager em = ProtocolValue.entityManager();
        TypedQuery q = em.createQuery("SELECT COUNT(o) FROM ProtocolValue AS o WHERE o.lsTransaction = :lsTransaction",
                Long.class);
        q.setParameter("lsTransaction", lsTransaction);
        return ((Long) q.getSingleResult());
    }

    public static TypedQuery<ProtocolValue> findProtocolValuesByLsKindEqualsAndCodeValueLike(String lsKind,
            String codeValue) {
        if (lsKind == null || lsKind.length() == 0)
            throw new IllegalArgumentException("The lsKind argument is required");
        if (codeValue == null || codeValue.length() == 0)
        ...
        EntityManager em = ProtocolValue.entityManager();
        TypedQuery<ProtocolValue> q = em.createQuery(
                "SELECT o FROM ProtocolValue AS o WHERE o.lsKind = :lsKind  AND LOWER(o.codeValue) LIKE LOWER(:codeValue)",
                ProtocolValue.class);
        q.setParameter("lsKind", lsKind);
        q.setParameter("codeValue", codeValue);
        return q;
    ...
    public static TypedQuery<ProtocolValue> findProtocolValuesByLsKindEqualsAndStringValueLike(String lsKind,
            String stringValue) {
        if (lsKind == null || lsKind.length() == 0)
            throw new IllegalArgumentException("The lsKind argument is required");
        if (stringValue == null || stringValue.length() == 0)
        ...
        EntityManager em = ProtocolValue.entityManager();
        TypedQuery<ProtocolValue> q = em.createQuery(
                "SELECT o FROM ProtocolValue AS o WHERE o.lsKind = :lsKind  AND LOWER(o.stringValue) LIKE LOWER(:stringValue)",
                ProtocolValue.class);
        q.setParameter("lsKind", lsKind);
        q.setParameter("stringValue", stringValue);
        return q;
    ...
    public static TypedQuery<ProtocolValue> findProtocolValuesByLsState(ProtocolState lsState) {
        if (lsState == null)
            throw new IllegalArgumentException("The lsState argument is required");
        EntityManager em = ProtocolValue.entityManager();
        TypedQuery<ProtocolValue> q = em.createQuery("SELECT o FROM ProtocolValue AS o WHERE o.lsState = :lsState",
                ProtocolValue.class);
        q.setParameter("lsState", lsState);
        return q;
    }

    public static TypedQuery<ProtocolValue> findProtocolValuesByLsState(ProtocolState lsState, String sortFieldName,
            String sortOrder) {
        if (lsState == null)
            throw new IllegalArgumentException("The lsState argument is required");
        EntityManager em = ProtocolValue.entityManager();
    ...
    public static TypedQuery<ProtocolValue> findProtocolValuesByLsTransactionEquals(Long lsTransaction) {
        ...
        EntityManager em = ProtocolValue.entityManager();
        TypedQuery<ProtocolValue> q = em.createQuery(
                "SELECT o FROM ProtocolValue AS o WHERE o.lsTransaction = :lsTransaction", ProtocolValue.class);
        q.setParameter("lsTransaction", lsTransaction);
        return q;
    }
    ...
    public static TypedQuery<ProtocolValue> findProtocolValuesByLsTransactionEquals(Long lsTransaction,
        ...
        EntityManager em = ProtocolValue.entityManager();
        StringBuilder queryBuilder = new StringBuilder(
                "SELECT o FROM ProtocolValue AS o WHERE o.lsTransaction = :lsTransaction");
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
            queryBuilder.append(" ORDER BY ").append(sortFieldName);
            if ("ASC".equalsIgnoreCase(sortOrder) || "DESC".equalsIgnoreCase(sortOrder)) {
                queryBuilder.append(" ").append(sortOrder);
