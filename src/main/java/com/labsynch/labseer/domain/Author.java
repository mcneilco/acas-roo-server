...
@Configurable
@Entity
// (excludeFields = { "password", "modifiedDate", "activationKey",
// "activationDate", "emailAddress", "recordedDate", "modifiedDate", "enabled",
// "locked" })
// (excludeFields = { "password", "authorRoles"})
...
public class Author extends AbstractThing {
    ...
    public String toString() {
        ...
        // ToStringStyle.SHORT_PREFIX_STYLE).setExcludeFieldNames("password",
    ...
    public String toJson() {
        return new JSONSerializer().exclude("*.class", "password")
                .include("lsStates.lsValues", "authorRoles", "lsLabels").transform(new ExcludeNulls(), void.class)
                .serialize(this);
    }
    ...
    public static String toJsonArray(Collection<Author> collection) {
        return new JSONSerializer().exclude("*.class", "password")
                .include("authorRoles", "lsLabels", "lsStates.lsValues").transform(new ExcludeNulls(), void.class)
                .serialize(collection);
    }

    public static Collection<Author> fromJsonArrayToAuthors(String json) {
        return new JSONDeserializer<List<Author>>().use(null, ArrayList.class).use("values", Author.class)
                .deserialize(json);
    }

    @Transactional
    public static TypedQuery<Author> findAuthorsByActivationKeyAndEmailAddress(String activationKey,
            String emailAddress) {
        if (activationKey == null || activationKey.length() == 0)
            throw new IllegalArgumentException("The activationKey argument is required");
        ...
        TypedQuery<Author> q = em.createQuery(
                "SELECT o FROM Author AS o WHERE o.ignored = FALSE AND o.activationKey = :activationKey AND o.emailAddress = :emailAddress",
                Author.class);
    ...
    public static TypedQuery<Author> findAuthorsByEmailAddress(String emailAddress) {
        ...
        EntityManager em = Author.entityManager();
        TypedQuery<Author> q = em.createQuery(
                "SELECT o FROM Author AS o WHERE o.ignored = FALSE AND o.emailAddress = :emailAddress", Author.class);
        q.setParameter("emailAddress", emailAddress);
        return q;
    }
    ...
    public static TypedQuery<Author> findAuthorsByUserName(String userName) {
        ...
        EntityManager em = Author.entityManager();
        TypedQuery<Author> q = em.createQuery(
                "SELECT o FROM Author AS o WHERE o.ignored = FALSE AND LOWER(o.userName) = LOWER(:userName)",
                Author.class);
    ...
    public static final List<String> fieldNames4OrderClauseFilter = java.util.Arrays.asList("firstName", "lastName",
            "userName", "emailAddress", "password", "activationDate", "activationKey", "enabled", "locked",
            "authorRoles", "lsStates", "lsLabels");
    ...
    public static List<Author> findAuthorEntries(int firstResult, int maxResults) {
        return entityManager().createQuery("SELECT o FROM Author o", Author.class).setFirstResult(firstResult)
                .setMaxResults(maxResults).getResultList();
    }

    public static List<Author> findAuthorEntries(int firstResult, int maxResults, String sortFieldName,
            String sortOrder) {
        String jpaQuery = "SELECT o FROM Author o";
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
            jpaQuery = jpaQuery + " ORDER BY " + sortFieldName;
        ...
        return entityManager().createQuery(jpaQuery, Author.class).setFirstResult(firstResult).setMaxResults(maxResults)
                .getResultList();
    }
    ...
    public static Long countFindAuthorsByActivationKeyAndEmailAddress(String activationKey, String emailAddress) {
        ...
        TypedQuery q = em.createQuery(
                "SELECT COUNT(o) FROM Author AS o WHERE o.activationKey = :activationKey AND o.emailAddress = :emailAddress",
                Long.class);
        q.setParameter("activationKey", activationKey);
        q.setParameter("emailAddress", emailAddress);
    ...
    public static Long countFindAuthorsByEmailAddress(String emailAddress) {
        if (emailAddress == null || emailAddress.length() == 0)
            throw new IllegalArgumentException("The emailAddress argument is required");
        EntityManager em = Author.entityManager();
        TypedQuery q = em.createQuery("SELECT COUNT(o) FROM Author AS o WHERE o.emailAddress = :emailAddress",
                Long.class);
        q.setParameter("emailAddress", emailAddress);
        return ((Long) q.getSingleResult());
    }
    ...
    public static TypedQuery<Author> findAuthorsByActivationKeyAndEmailAddress(String activationKey,
            String emailAddress, String sortFieldName, String sortOrder) {
        if (activationKey == null || activationKey.length() == 0)
            throw new IllegalArgumentException("The activationKey argument is required");
        if (emailAddress == null || emailAddress.length() == 0)
            throw new IllegalArgumentException("The emailAddress argument is required");
        ...
        StringBuilder queryBuilder = new StringBuilder(
                "SELECT o FROM Author AS o WHERE o.activationKey = :activationKey AND o.emailAddress = :emailAddress");
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
    ...
    public static TypedQuery<Author> findAuthorsByEmailAddress(String emailAddress, String sortFieldName,
            String sortOrder) {
        if (emailAddress == null || emailAddress.length() == 0)
            throw new IllegalArgumentException("The emailAddress argument is required");
        EntityManager em = Author.entityManager();
        StringBuilder queryBuilder = new StringBuilder(
                "SELECT o FROM Author AS o WHERE o.emailAddress = :emailAddress");
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
            queryBuilder.append(" ORDER BY ").append(sortFieldName);
            if ("ASC".equalsIgnoreCase(sortOrder) || "DESC".equalsIgnoreCase(sortOrder)) {
                queryBuilder.append(" ").append(sortOrder);
