...
privileged aspect LsInteraction_Roo_Jpa_ActiveRecord {
    ...
    public static final List<String> LsInteraction.fieldNames4OrderClauseFilter = java.util.Arrays.asList("firstThing", "secondThing");
    ...
    public static List<LsInteraction> LsInteraction.findAllLsInteractions(String sortFieldName, String sortOrder) {
    ...
    public static List<LsInteraction> LsInteraction.findLsInteractionEntries(int firstResult, int maxResults, String sortFieldName, String sortOrder) {
        String jpaQuery = "SELECT o FROM LsInteraction o";
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
            jpaQuery = jpaQuery + " ORDER BY " + sortFieldName;
            if ("ASC".equalsIgnoreCase(sortOrder) || "DESC".equalsIgnoreCase(sortOrder)) {
