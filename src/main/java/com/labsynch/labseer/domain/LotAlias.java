...
public class LotAlias {
    ...
    public static final List<String> fieldNames4OrderClauseFilter = java.util.Arrays.asList("logger", "lot", "lsType",
            "lsKind", "aliasName", "preferred", "ignored", "deleted");
    ...
    public static List<LotAlias> findLotAliasEntries(int firstResult, int maxResults) {
        return entityManager().createQuery("SELECT o FROM LotAlias o", LotAlias.class).setFirstResult(firstResult)
                .setMaxResults(maxResults).getResultList();
    }

    public static List<LotAlias> findLotAliasEntries(int firstResult, int maxResults, String sortFieldName,
            String sortOrder) {
        String jpaQuery = "SELECT o FROM LotAlias o";
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
            jpaQuery = jpaQuery + " ORDER BY " + sortFieldName;
        ...
        return entityManager().createQuery(jpaQuery, LotAlias.class).setFirstResult(firstResult)
                .setMaxResults(maxResults).getResultList();
    }
    ...
    public static Long countFindLotAliasesByAliasNameEqualsAndLsTypeEqualsAndLsKindEquals(String aliasName,
        ...
        TypedQuery q = em.createQuery(
                "SELECT COUNT(o) FROM LotAlias AS o WHERE o.aliasName = :aliasName  AND o.lsType = :lsType  AND o.lsKind = :lsKind",
                Long.class);
    ...
    public static Long countFindLotAliasesByLotAndLsTypeEqualsAndLsKindEquals(Lot lot, String lsType, String lsKind) {
        ...
        EntityManager em = LotAlias.entityManager();
        TypedQuery q = em.createQuery(
                "SELECT COUNT(o) FROM LotAlias AS o WHERE o.lot = :lot AND o.lsType = :lsType  AND o.lsKind = :lsKind",
                Long.class);
        q.setParameter("lot", lot);
        q.setParameter("lsType", lsType);
        q.setParameter("lsKind", lsKind);
    ...
    public static TypedQuery<LotAlias> findLotAliasesByAliasNameEqualsAndLsTypeEqualsAndLsKindEquals(String aliasName,
            String lsType, String lsKind) {
        if (aliasName == null || aliasName.length() == 0)
            throw new IllegalArgumentException("The aliasName argument is required");
        if (lsType == null || lsType.length() == 0)
        ...
        if (lsKind == null || lsKind.length() == 0)
            throw new IllegalArgumentException("The lsKind argument is required");
        EntityManager em = LotAlias.entityManager();
        TypedQuery<LotAlias> q = em.createQuery(
                "SELECT o FROM LotAlias AS o WHERE o.aliasName = :aliasName  AND o.lsType = :lsType  AND o.lsKind = :lsKind",
                LotAlias.class);
        q.setParameter("aliasName", aliasName);
        q.setParameter("lsType", lsType);
        q.setParameter("lsKind", lsKind);
    ...
    public static TypedQuery<LotAlias> findLotAliasesByLotAndLsTypeEqualsAndLsKindEquals(Lot lot, String lsType,
            String lsKind) {
        if (lot == null)
            throw new IllegalArgumentException("The lot argument is required");
        if (lsType == null || lsType.length() == 0)
        ...
        EntityManager em = LotAlias.entityManager();
        TypedQuery<LotAlias> q = em.createQuery(
                "SELECT o FROM LotAlias AS o WHERE o.lot = :lot AND o.lsType = :lsType  AND o.lsKind = :lsKind",
                LotAlias.class);
        q.setParameter("lot", lot);
        q.setParameter("lsType", lsType);
        q.setParameter("lsKind", lsKind);
