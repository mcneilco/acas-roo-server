...
public class SaltFormAliasKind {
    ...
    public static List<SaltFormAliasKind> findAllSaltFormAliasKinds() {
        return entityManager().createQuery("SELECT o FROM SaltFormAliasKind o", SaltFormAliasKind.class)
                .getResultList();
    }
    ...
    public static List<SaltFormAliasKind> findSaltFormAliasKindEntries(int firstResult, int maxResults,
        ...
        return entityManager().createQuery(jpaQuery, SaltFormAliasKind.class).setFirstResult(firstResult)
