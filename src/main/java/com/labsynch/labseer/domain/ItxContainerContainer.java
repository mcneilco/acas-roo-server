...
public class ItxContainerContainer extends AbstractThing {
    ...
    public static ItxContainerContainer update(ItxContainerContainer object) {
        ItxContainerContainer updatedObject = new JSONDeserializer<ItxContainerContainer>()
                .use(null, ItxContainerContainer.class).deserializeInto(object.toJson(),
    ...
    public static ItxContainerContainer updateNoStates(ItxContainerContainer itxContainerContainer) {
        ItxContainerContainer updatedItxContainerContainer = ItxContainerContainer
                .findItxContainerContainer(itxContainerContainer.getId());
        ...
        updatedItxContainerContainer.firstContainer = Container
                .findContainer(itxContainerContainer.getFirstContainer().getId());
        updatedItxContainerContainer.secondContainer = Container
                .findContainer(itxContainerContainer.getSecondContainer().getId());
        ...
        if (logger.isDebugEnabled())
            logger.debug(updatedItxContainerContainer.toJson());

        return updatedItxContainerContainer;
    }

    public static TypedQuery<ItxContainerContainer> findItxContainerContainersByLsTypeEqualsAndLsKindEqualsAndFirstContainerEquals(
            String lsType, String lsKind, Container firstContainer) {
        ...
        if (firstContainer == null)
            throw new IllegalArgumentException("The firstContainer argument is required");
    ...
    public static TypedQuery<ItxContainerContainer> findItxContainerContainersByLsTypeEqualsAndLsKindEqualsAndSecondContainerEquals(
            String lsType, String lsKind, Container secondContainer) {
        if (lsType == null || lsType.length() == 0)
            throw new IllegalArgumentException("The lsType argument is required");
        if (lsKind == null || lsKind.length() == 0)
            throw new IllegalArgumentException("The lsKind argument is required");
        if (secondContainer == null)
            throw new IllegalArgumentException("The secondContainer argument is required");
    ...
    public static TypedQuery<ItxContainerContainer> findItxContainerContainersByLsTypeEqualsAndLsKindEqualsAndSecondContainerEqualsAndOrderEquals(
            String lsType, String lsKind, Container secondContainer, int order) {
        if (lsType == null || lsType.length() == 0)
            throw new IllegalArgumentException("The lsType argument is required");
        if (lsKind == null || lsKind.length() == 0)
            throw new IllegalArgumentException("The lsKind argument is required");
    ...
    public static TypedQuery<ItxContainerContainer> findItxContainerContainersByLsTypeEqualsAndLsKindEqualsAndFirstContainerEqualsAndSecondContainerEquals(
            String lsType, String lsKind, Container firstContainer, Container secondContainer) {
        if (lsType == null || lsType.length() == 0)
            throw new IllegalArgumentException("The lsType argument is required");
        if (lsKind == null || lsKind.length() == 0)
            throw new IllegalArgumentException("The lsKind argument is required");
    ...
    public static Long countFindItxContainerContainersByLsTransactionEquals(Long lsTransaction) {
        ...
        TypedQuery q = em.createQuery(
                "SELECT COUNT(o) FROM ItxContainerContainer AS o WHERE o.lsTransaction = :lsTransaction", Long.class);
        q.setParameter("lsTransaction", lsTransaction);
        return ((Long) q.getSingleResult());
    }

    public static Long countFindItxContainerContainersByLsTypeEqualsAndFirstContainerEquals(String lsType,
        ...
        EntityManager em = ItxContainerContainer.entityManager();
        TypedQuery q = em.createQuery(
                "SELECT COUNT(o) FROM ItxContainerContainer AS o WHERE o.lsType = :lsType  AND o.firstContainer = :firstContainer",
                Long.class);
        q.setParameter("lsType", lsType);
        q.setParameter("firstContainer", firstContainer);
        return ((Long) q.getSingleResult());
    ...
    public static Long countFindItxContainerContainersByLsTypeEqualsAndSecondContainerEquals(String lsType,
        ...
        EntityManager em = ItxContainerContainer.entityManager();
        TypedQuery q = em.createQuery(
                "SELECT COUNT(o) FROM ItxContainerContainer AS o WHERE o.lsType = :lsType  AND o.secondContainer = :secondContainer",
                Long.class);
        q.setParameter("lsType", lsType);
        q.setParameter("secondContainer", secondContainer);
        return ((Long) q.getSingleResult());
    ...
    public static TypedQuery<ItxContainerContainer> findItxContainerContainersByLsTransactionEquals(
            Long lsTransaction) {
        if (lsTransaction == null)
            throw new IllegalArgumentException("The lsTransaction argument is required");
        EntityManager em = ItxContainerContainer.entityManager();
        TypedQuery<ItxContainerContainer> q = em.createQuery(
                "SELECT o FROM ItxContainerContainer AS o WHERE o.lsTransaction = :lsTransaction",
                ItxContainerContainer.class);
        q.setParameter("lsTransaction", lsTransaction);
        return q;
    }
    ...
    public static TypedQuery<ItxContainerContainer> findItxContainerContainersByLsTypeEqualsAndFirstContainerEquals(
            String lsType, Container firstContainer) {
        if (lsType == null || lsType.length() == 0)
            throw new IllegalArgumentException("The lsType argument is required");
        if (firstContainer == null)
            throw new IllegalArgumentException("The firstContainer argument is required");
        EntityManager em = ItxContainerContainer.entityManager();
        TypedQuery<ItxContainerContainer> q = em.createQuery(
                "SELECT o FROM ItxContainerContainer AS o WHERE o.lsType = :lsType  AND o.firstContainer = :firstContainer",
                ItxContainerContainer.class);
        q.setParameter("lsType", lsType);
        q.setParameter("firstContainer", firstContainer);
        return q;
    ...
    public static TypedQuery<ItxContainerContainer> findItxContainerContainersByLsTypeEqualsAndFirstContainerEquals(
            String lsType, Container firstContainer, String sortFieldName, String sortOrder) {
        if (lsType == null || lsType.length() == 0)
            throw new IllegalArgumentException("The lsType argument is required");
        if (firstContainer == null)
            throw new IllegalArgumentException("The firstContainer argument is required");
    ...
    public static TypedQuery<ItxContainerContainer> findItxContainerContainersByLsTypeEqualsAndSecondContainerEquals(
            String lsType, Container secondContainer) {
        if (lsType == null || lsType.length() == 0)
            throw new IllegalArgumentException("The lsType argument is required");
        if (secondContainer == null)
            throw new IllegalArgumentException("The secondContainer argument is required");
        EntityManager em = ItxContainerContainer.entityManager();
        TypedQuery<ItxContainerContainer> q = em.createQuery(
                "SELECT o FROM ItxContainerContainer AS o WHERE o.lsType = :lsType  AND o.secondContainer = :secondContainer",
                ItxContainerContainer.class);
        q.setParameter("lsType", lsType);
        q.setParameter("secondContainer", secondContainer);
        return q;
    ...
    public static TypedQuery<ItxContainerContainer> findItxContainerContainersByLsTypeEqualsAndSecondContainerEquals(
            String lsType, Container secondContainer, String sortFieldName, String sortOrder) {
        if (lsType == null || lsType.length() == 0)
            throw new IllegalArgumentException("The lsType argument is required");
        if (secondContainer == null)
            throw new IllegalArgumentException("The secondContainer argument is required");
    ...
    public static final List<String> fieldNames4OrderClauseFilter = java.util.Arrays.asList("logger", "firstContainer",
            "secondContainer", "lsStates");

    public static long countItxContainerContainers() {
        return entityManager().createQuery("SELECT COUNT(o) FROM ItxContainerContainer o", Long.class)
                .getSingleResult();
    }

    public static List<ItxContainerContainer> findAllItxContainerContainers() {
        return entityManager().createQuery("SELECT o FROM ItxContainerContainer o", ItxContainerContainer.class)
                .getResultList();
    }
    ...
    public static List<ItxContainerContainer> findItxContainerContainerEntries(int firstResult, int maxResults,
        ...
        return entityManager().createQuery(jpaQuery, ItxContainerContainer.class).setFirstResult(firstResult)
