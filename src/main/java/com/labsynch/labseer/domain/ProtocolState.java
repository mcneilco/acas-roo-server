...
public class ProtocolState extends AbstractState {
    ...
    public String toJson() {
        return new JSONSerializer().include("lsValues").exclude("*.class", "protocol")
    ...
    public static Collection<ProtocolState> fromJsonArrayToProtocolStates(String json) {
        return new JSONDeserializer<List<ProtocolState>>().use(null, ArrayList.class).use("values", ProtocolState.class)
                .deserialize(json);
    }
    ...
    public static Long countFindProtocolStatesByLsTransactionEquals(Long lsTransaction) {
        ...
        TypedQuery q = em.createQuery("SELECT COUNT(o) FROM ProtocolState AS o WHERE o.lsTransaction = :lsTransaction",
                Long.class);
    ...
    public static Long countFindProtocolStatesByProtocol(Protocol protocol) {
        ...
        EntityManager em = ProtocolState.entityManager();
        TypedQuery q = em.createQuery("SELECT COUNT(o) FROM ProtocolState AS o WHERE o.protocol = :protocol",
                Long.class);
    ...
    public static TypedQuery<ProtocolState> findProtocolStatesByLsTransactionEquals(Long lsTransaction) {
        if (lsTransaction == null)
            throw new IllegalArgumentException("The lsTransaction argument is required");
        EntityManager em = ProtocolState.entityManager();
        TypedQuery<ProtocolState> q = em.createQuery(
                "SELECT o FROM ProtocolState AS o WHERE o.lsTransaction = :lsTransaction", ProtocolState.class);
        q.setParameter("lsTransaction", lsTransaction);
        return q;
    }
    ...
    public static TypedQuery<ProtocolState> findProtocolStatesByLsTransactionEquals(Long lsTransaction,
        ...
        StringBuilder queryBuilder = new StringBuilder(
                "SELECT o FROM ProtocolState AS o WHERE o.lsTransaction = :lsTransaction");
    ...
    public static TypedQuery<ProtocolState> findProtocolStatesByProtocol(Protocol protocol) {
        if (protocol == null)
            throw new IllegalArgumentException("The protocol argument is required");
        EntityManager em = ProtocolState.entityManager();
        TypedQuery<ProtocolState> q = em.createQuery("SELECT o FROM ProtocolState AS o WHERE o.protocol = :protocol",
                ProtocolState.class);
        q.setParameter("protocol", protocol);
        return q;
    }

    public static TypedQuery<ProtocolState> findProtocolStatesByProtocol(Protocol protocol, String sortFieldName,
            String sortOrder) {
        if (protocol == null)
            throw new IllegalArgumentException("The protocol argument is required");
        EntityManager em = ProtocolState.entityManager();
    ...
    public static List<ProtocolState> findProtocolStateEntries(int firstResult, int maxResults) {
        return entityManager().createQuery("SELECT o FROM ProtocolState o", ProtocolState.class)
                .setFirstResult(firstResult).setMaxResults(maxResults).getResultList();
    }

    public static List<ProtocolState> findProtocolStateEntries(int firstResult, int maxResults, String sortFieldName,
            String sortOrder) {
        String jpaQuery = "SELECT o FROM ProtocolState o";
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
            jpaQuery = jpaQuery + " ORDER BY " + sortFieldName;
        ...
        return entityManager().createQuery(jpaQuery, ProtocolState.class).setFirstResult(firstResult)
