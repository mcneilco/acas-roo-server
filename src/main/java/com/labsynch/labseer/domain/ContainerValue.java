...
public class ContainerValue extends AbstractValue {
    ...
    public static long countContainerValuesByLsState(ContainerState lsState) {
        EntityManager em = ContainerValue.entityManager();
        TypedQuery<Long> q = em.createQuery("SELECT COUNT(o) FROM ContainerValue AS o WHERE o.lsState = :lsState",
                Long.class);
        q.setParameter("lsState", lsState);
        return q.getSingleResult();
    }
    ...
    public static List<ContainerValue> findAllContainerValuesByLsState(ContainerState lsState, int maxResults) {
        ...
        EntityManager em = ContainerValue.entityManager();
        TypedQuery<ContainerValue> q = em
                .createQuery("SELECT o FROM ContainerValue AS o WHERE o.lsState = :lsState", ContainerValue.class)
    ...
    public static List<ContainerValue> findAllContainerValuesByLsState(ContainerState lsState) {
        ...
        // Query q = session.createQuery("SELECT o FROM ContainerValue AS o WHERE
        // o.lsState = :lsState");

        TypedQuery<ContainerValue> q = em.createQuery("SELECT o FROM ContainerValue AS o WHERE o.lsState = :lsState",
                ContainerValue.class);
        q.setParameter("lsState", lsState);
        return q.getResultList();
    }

    public static List<com.labsynch.labseer.domain.ContainerValue> findContainerValueEntries(int firstResult,
            int maxResults) {
        return entityManager().createQuery("SELECT o FROM ContainerValue o", ContainerValue.class)
    ...
    public static Collection<com.labsynch.labseer.domain.ContainerValue> fromJsonArrayToContainerValues(String json) {
        return new JSONDeserializer<List<ContainerValue>>().use(null, ArrayList.class)
                .use("values", ContainerValue.class).deserialize(json);
    }
    ...
    public static com.labsynch.labseer.domain.ContainerValue update(
            com.labsynch.labseer.domain.ContainerValue containerValue) {
        ContainerValue updatedContainerValue = new JSONDeserializer<ContainerValue>().use(null, ArrayList.class)
                .use("values", ContainerValue.class)
                .deserializeInto(containerValue.toJson(), ContainerValue.findContainerValue(containerValue.getId()));
    ...
    public static TypedQuery<ContainerValue> findContainerValuesByContainerIDAndStateTypeKindAndValueTypeKind(
            Long containerId, String stateType,
    ...
    public static TypedQuery<ContainerValue> findContainerValuesByContainerCodeNameAndStateTypeKindAndValueTypeKind(
            String codeName, String stateType,
            String stateKind, String valueType, String valueKind) {
    ...
    public static Long countFindContainerValuesByLsState(ContainerState lsState) {
        if (lsState == null)
            throw new IllegalArgumentException("The lsState argument is required");
        EntityManager em = ContainerValue.entityManager();
        TypedQuery q = em.createQuery("SELECT COUNT(o) FROM ContainerValue AS o WHERE o.lsState = :lsState",
                Long.class);
        q.setParameter("lsState", lsState);
        return ((Long) q.getSingleResult());
    }
    ...
    public static TypedQuery<ContainerValue> findContainerValuesByIgnoredNot(boolean ignored, String sortFieldName,
            String sortOrder) {
        EntityManager em = ContainerValue.entityManager();
    ...
    public static TypedQuery<ContainerValue> findContainerValuesByLsState(ContainerState lsState, String sortFieldName,
            String sortOrder) {
        if (lsState == null)
            throw new IllegalArgumentException("The lsState argument is required");
        EntityManager em = ContainerValue.entityManager();
    ...
    public static List<ContainerValue> findContainerValueEntries(int firstResult, int maxResults, String sortFieldName,
            String sortOrder) {
        String jpaQuery = "SELECT o FROM ContainerValue o";
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
            jpaQuery = jpaQuery + " ORDER BY " + sortFieldName;
