...
public class ContainerState extends AbstractState {
    ...
    // public static com.labsynch.labseer.domain.ContainerState
    // update(com.labsynch.labseer.domain.ContainerState containerState) {
    // ContainerState updatedContainerState = new
    // JSONDeserializer<ContainerState>().use(null, ArrayList.class).use("values",
    // ContainerState.class).deserializeInto(containerState.toJson(),
    // ContainerState.findContainerState(containerState.getId()));
    ...
    public String toJson() {
        return new JSONSerializer().exclude("*.class", "container").include("lsValues")
    ...
    public static String toJsonArray(Collection<com.labsynch.labseer.domain.ContainerState> collection) {
        return new JSONSerializer().exclude("*.class", "container", "lsValues.lsState").include("lsValues")
    ...
    public static String toJsonArrayStub(Collection<com.labsynch.labseer.domain.ContainerState> collection) {
        return new JSONSerializer().exclude("*.class", "container").transform(new ExcludeNulls(), void.class)
                .serialize(collection);
    }

    @Transactional
    public static String toJsonArrayWithNestedContainers(Collection<ContainerState> collection) {
        return new JSONSerializer().exclude("*.class", "lsValues.lsState").include("lsValues", "container.lsLabels")
                .transform(new ExcludeNulls(), void.class).serialize(collection);
    }

    public static Collection<com.labsynch.labseer.domain.ContainerState> fromJsonArrayToContainerStates(String json) {
        return new JSONDeserializer<List<ContainerState>>().use(null, ArrayList.class)
                .use("values", ContainerState.class).deserialize(json);
    }
    ...
    public static int ignoreStates(Long transactionId) {
        boolean ignored = true;
        EntityManager em = ContainerState.entityManager();
        Query q = em.createQuery("UPDATE versioned ContainerState AS o set o.ignored = :ignored WHERE o.id "
                + "IN (  SELECT thing FROM UpdateLog " + "WHERE lsTransaction = :transactionId)");
        q.setParameter("ignored", ignored);
    ...
    public static List<ContainerState> findContainerStateEntries(int firstResult, int maxResults) {
        return entityManager().createQuery("SELECT o FROM ContainerState o", ContainerState.class)
                .setFirstResult(firstResult).setMaxResults(maxResults).getResultList();
    }

    public static List<ContainerState> findContainerStateEntries(int firstResult, int maxResults, String sortFieldName,
            String sortOrder) {
        String jpaQuery = "SELECT o FROM ContainerState o";
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
            jpaQuery = jpaQuery + " ORDER BY " + sortFieldName;
        ...
        return entityManager().createQuery(jpaQuery, ContainerState.class).setFirstResult(firstResult)
    ...
    public static Long countFindContainerStatesByContainer(Container container) {
        ...
        EntityManager em = ContainerState.entityManager();
        TypedQuery q = em.createQuery("SELECT COUNT(o) FROM ContainerState AS o WHERE o.container = :container",
                Long.class);
        q.setParameter("container", container);
        return ((Long) q.getSingleResult());
    }

    public static Long countFindContainerStatesByContainerAndLsKindEqualsAndIgnoredNot(Container container,
            String lsKind, boolean ignored) {
        if (container == null)
            throw new IllegalArgumentException("The container argument is required");
    ...
    public static TypedQuery<ContainerState> findContainerStatesByContainer(Container container) {
        ...
        TypedQuery<ContainerState> q = em
                .createQuery("SELECT o FROM ContainerState AS o WHERE o.container = :container", ContainerState.class);
        q.setParameter("container", container);
        return q;
    }

    public static TypedQuery<ContainerState> findContainerStatesByContainer(Container container, String sortFieldName,
            String sortOrder) {
        if (container == null)
            throw new IllegalArgumentException("The container argument is required");
        EntityManager em = ContainerState.entityManager();
        StringBuilder queryBuilder = new StringBuilder(
                "SELECT o FROM ContainerState AS o WHERE o.container = :container");
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
    ...
    public static TypedQuery<ContainerState> findContainerStatesByContainerAndLsKindEqualsAndIgnoredNot(
            Container container, String lsKind, boolean ignored) {
        if (container == null)
            throw new IllegalArgumentException("The container argument is required");
        if (lsKind == null || lsKind.length() == 0)
            throw new IllegalArgumentException("The lsKind argument is required");
    ...
    public static TypedQuery<ContainerState> findContainerStatesByContainerAndLsKindEqualsAndIgnoredNot(
            Container container, String lsKind, boolean ignored, String sortFieldName, String sortOrder) {
        if (container == null)
            throw new IllegalArgumentException("The container argument is required");
        if (lsKind == null || lsKind.length() == 0)
            throw new IllegalArgumentException("The lsKind argument is required");
    ...
    public static TypedQuery<ContainerState> findContainerStatesByIgnoredNot(boolean ignored, String sortFieldName,
            String sortOrder) {
        EntityManager em = ContainerState.entityManager();
        StringBuilder queryBuilder = new StringBuilder(
