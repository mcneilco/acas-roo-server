...
public class RoleKind {
    ...
    public void persist() {
        ...
        this.setLsTypeAndKind(
                new StringBuilder().append(this.lsType.getTypeName()).append("_").append(this.kindName).toString());
    ...
    public static List<RoleKind> findRoleKindEntries(int firstResult, int maxResults) {
        return entityManager().createQuery("SELECT o FROM RoleKind o", RoleKind.class).setFirstResult(firstResult)
                .setMaxResults(maxResults).getResultList();
    }

    public static List<RoleKind> findRoleKindEntries(int firstResult, int maxResults, String sortFieldName,
            String sortOrder) {
        String jpaQuery = "SELECT o FROM RoleKind o";
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
            jpaQuery = jpaQuery + " ORDER BY " + sortFieldName;
        ...
        return entityManager().createQuery(jpaQuery, RoleKind.class).setFirstResult(firstResult)
                .setMaxResults(maxResults).getResultList();
    }
    ...
    public static Long countFindRoleKindsByKindNameEqualsAndLsType(String kindName, RoleType lsType) {
        ...
        TypedQuery q = em.createQuery(
                "SELECT COUNT(o) FROM RoleKind AS o WHERE o.kindName = :kindName  AND o.lsType = :lsType", Long.class);
    ...
    public static TypedQuery<RoleKind> findRoleKindsByKindNameEqualsAndLsType(String kindName, RoleType lsType) {
        ...
        if (lsType == null)
            throw new IllegalArgumentException("The lsType argument is required");
        EntityManager em = RoleKind.entityManager();
        TypedQuery<RoleKind> q = em.createQuery(
                "SELECT o FROM RoleKind AS o WHERE o.kindName = :kindName  AND o.lsType = :lsType", RoleKind.class);
        q.setParameter("kindName", kindName);
        q.setParameter("lsType", lsType);
        return q;
    }
    ...
    public static TypedQuery<RoleKind> findRoleKindsByKindNameEqualsAndLsType(String kindName, RoleType lsType,
        ...
        StringBuilder queryBuilder = new StringBuilder(
                "SELECT o FROM RoleKind AS o WHERE o.kindName = :kindName  AND o.lsType = :lsType");
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
