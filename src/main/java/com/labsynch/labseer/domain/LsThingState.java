...
public class LsThingState extends AbstractState {
    ...
    public String toJson() {
        return new JSONSerializer().include("lsValues").exclude("*.class", "lsThing")
    ...
    public static Collection<LsThingState> fromJsonArrayToLsThingStates(String json) {
        return new JSONDeserializer<List<LsThingState>>().use(null, ArrayList.class).use("values", LsThingState.class)
                .deserialize(json);
    }
    ...
    public static List<LsThingState> findLsThingStateEntries(int firstResult, int maxResults) {
        return entityManager().createQuery("SELECT o FROM LsThingState o", LsThingState.class)
                .setFirstResult(firstResult).setMaxResults(maxResults).getResultList();
    }

    public static List<LsThingState> findLsThingStateEntries(int firstResult, int maxResults, String sortFieldName,
            String sortOrder) {
        String jpaQuery = "SELECT o FROM LsThingState o";
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
            jpaQuery = jpaQuery + " ORDER BY " + sortFieldName;
        ...
        return entityManager().createQuery(jpaQuery, LsThingState.class).setFirstResult(firstResult)
    ...
    public static Long countFindLsThingStatesByLsTransactionEquals(Long lsTransaction) {
        ...
        EntityManager em = LsThingState.entityManager();
        TypedQuery q = em.createQuery("SELECT COUNT(o) FROM LsThingState AS o WHERE o.lsTransaction = :lsTransaction",
                Long.class);
    ...
    public static TypedQuery<LsThingState> findLsThingStatesByLsThing(LsThing lsThing) {
        if (lsThing == null)
            throw new IllegalArgumentException("The lsThing argument is required");
        EntityManager em = LsThingState.entityManager();
        TypedQuery<LsThingState> q = em.createQuery("SELECT o FROM LsThingState AS o WHERE o.lsThing = :lsThing",
                LsThingState.class);
        q.setParameter("lsThing", lsThing);
        return q;
    }

    public static TypedQuery<LsThingState> findLsThingStatesByLsThing(LsThing lsThing, String sortFieldName,
            String sortOrder) {
        if (lsThing == null)
            throw new IllegalArgumentException("The lsThing argument is required");
        EntityManager em = LsThingState.entityManager();
    ...
    public static TypedQuery<LsThingState> findLsThingStatesByLsTransactionEquals(Long lsTransaction) {
        if (lsTransaction == null)
            throw new IllegalArgumentException("The lsTransaction argument is required");
        EntityManager em = LsThingState.entityManager();
        TypedQuery<LsThingState> q = em.createQuery(
                "SELECT o FROM LsThingState AS o WHERE o.lsTransaction = :lsTransaction", LsThingState.class);
        q.setParameter("lsTransaction", lsTransaction);
        return q;
    }
    ...
    public static TypedQuery<LsThingState> findLsThingStatesByLsTransactionEquals(Long lsTransaction,
        ...
        StringBuilder queryBuilder = new StringBuilder(
                "SELECT o FROM LsThingState AS o WHERE o.lsTransaction = :lsTransaction");
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
            queryBuilder.append(" ORDER BY ").append(sortFieldName);
            if ("ASC".equalsIgnoreCase(sortOrder) || "DESC".equalsIgnoreCase(sortOrder)) {
                queryBuilder.append(" ").append(sortOrder);
