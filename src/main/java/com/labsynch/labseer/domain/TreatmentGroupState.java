...
public class TreatmentGroupState extends AbstractState {
    ...
    public static TreatmentGroupState update(TreatmentGroupState treatmentGroupState) {
        TreatmentGroupState updatedTreatmentGroupState = TreatmentGroupState
                .findTreatmentGroupState(treatmentGroupState.getId());
    ...
    public static List<TreatmentGroupState> findAllTreatmentGroupStates() {
        return entityManager().createQuery("SELECT o FROM TreatmentGroupState o", TreatmentGroupState.class)
                .getResultList();
    }
    ...
    public static String getTreatmentGroupStateCollectionJson(List<Long> idList) {
        ...
        for (Long id : idList) {
            ...
            if (query != null)
                treatmentGroupStates.add(query);
        }
    ...
    public static TypedQuery<TreatmentGroupState> findTreatmentGroupStatesByTreatmentGroupIDAndStateTypeKind(
            Long treatmentGroupId,
            String stateType,
            String stateKind) {
    ...
    public static Long countFindTreatmentGroupStatesByLsTransactionEquals(Long lsTransaction) {
        ...
        TypedQuery q = em.createQuery(
                "SELECT COUNT(o) FROM TreatmentGroupState AS o WHERE o.lsTransaction = :lsTransaction", Long.class);
    ...
    public static Long countFindTreatmentGroupStatesByLsTypeAndKindEquals(String lsTypeAndKind) {
        ...
        EntityManager em = TreatmentGroupState.entityManager();
        TypedQuery q = em.createQuery(
                "SELECT COUNT(o) FROM TreatmentGroupState AS o WHERE o.lsTypeAndKind = :lsTypeAndKind", Long.class);
    ...
    public static Long countFindTreatmentGroupStatesByTreatmentGroup(TreatmentGroup treatmentGroup) {
        if (treatmentGroup == null)
            throw new IllegalArgumentException("The treatmentGroup argument is required");
        EntityManager em = TreatmentGroupState.entityManager();
        TypedQuery q = em.createQuery(
                "SELECT COUNT(o) FROM TreatmentGroupState AS o WHERE o.treatmentGroup = :treatmentGroup", Long.class);
    ...
    public static TypedQuery<TreatmentGroupState> findTreatmentGroupStatesByLsTransactionEquals(Long lsTransaction) {
        if (lsTransaction == null)
            throw new IllegalArgumentException("The lsTransaction argument is required");
        EntityManager em = TreatmentGroupState.entityManager();
        TypedQuery<TreatmentGroupState> q = em.createQuery(
                "SELECT o FROM TreatmentGroupState AS o WHERE o.lsTransaction = :lsTransaction",
                TreatmentGroupState.class);
        q.setParameter("lsTransaction", lsTransaction);
        return q;
    }
    ...
    public static TypedQuery<TreatmentGroupState> findTreatmentGroupStatesByLsTypeAndKindEquals(String lsTypeAndKind) {
        ...
        EntityManager em = TreatmentGroupState.entityManager();
        TypedQuery<TreatmentGroupState> q = em.createQuery(
                "SELECT o FROM TreatmentGroupState AS o WHERE o.lsTypeAndKind = :lsTypeAndKind",
                TreatmentGroupState.class);
        q.setParameter("lsTypeAndKind", lsTypeAndKind);
        return q;
    }
    ...
    public static TypedQuery<TreatmentGroupState> findTreatmentGroupStatesByTreatmentGroup(
            TreatmentGroup treatmentGroup) {
        if (treatmentGroup == null)
            throw new IllegalArgumentException("The treatmentGroup argument is required");
        EntityManager em = TreatmentGroupState.entityManager();
        TypedQuery<TreatmentGroupState> q = em.createQuery(
                "SELECT o FROM TreatmentGroupState AS o WHERE o.treatmentGroup = :treatmentGroup",
                TreatmentGroupState.class);
        q.setParameter("treatmentGroup", treatmentGroup);
        return q;
    }
    ...
    public static TypedQuery<TreatmentGroupState> findTreatmentGroupStatesByTreatmentGroup(
            TreatmentGroup treatmentGroup, String sortFieldName, String sortOrder) {
        if (treatmentGroup == null)
            throw new IllegalArgumentException("The treatmentGroup argument is required");
        EntityManager em = TreatmentGroupState.entityManager();
        StringBuilder queryBuilder = new StringBuilder(
    ...
    public static List<TreatmentGroupState> findTreatmentGroupStateEntries(int firstResult, int maxResults,
        ...
        return entityManager().createQuery(jpaQuery, TreatmentGroupState.class).setFirstResult(firstResult)
