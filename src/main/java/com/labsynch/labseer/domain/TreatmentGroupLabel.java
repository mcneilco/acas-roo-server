...
public class TreatmentGroupLabel extends AbstractLabel {
    ...
    public static TreatmentGroupLabel update(TreatmentGroupLabel treatmentGroupLabel) {
        TreatmentGroupLabel updatedTreatmentGroupLabel = TreatmentGroupLabel
                .findTreatmentGroupLabel(treatmentGroupLabel.getId());
        ...
        updatedTreatmentGroupLabel
                .setLsTypeAndKind(treatmentGroupLabel.getLsType() + "_" + treatmentGroupLabel.getLsKind());
    ...
    public static Collection<TreatmentGroupLabel> fromJsonArrayToTreatmentGroupLabels(String json) {
        return new JSONDeserializer<List<TreatmentGroupLabel>>().use(null, ArrayList.class)
                .use("values", TreatmentGroupLabel.class).deserialize(json);
    }
    ...
    public static Long countFindTreatmentGroupLabelsByLsTransactionEquals(Long lsTransaction) {
        ...
        TypedQuery q = em.createQuery(
                "SELECT COUNT(o) FROM TreatmentGroupLabel AS o WHERE o.lsTransaction = :lsTransaction", Long.class);
    ...
    public static Long countFindTreatmentGroupLabelsByTreatmentGroup(TreatmentGroup treatmentGroup) {
        ...
        EntityManager em = TreatmentGroupLabel.entityManager();
        TypedQuery q = em.createQuery(
                "SELECT COUNT(o) FROM TreatmentGroupLabel AS o WHERE o.treatmentGroup = :treatmentGroup", Long.class);
    ...
    public static TypedQuery<TreatmentGroupLabel> findTreatmentGroupLabelsByLsTransactionEquals(Long lsTransaction) {
        if (lsTransaction == null)
            throw new IllegalArgumentException("The lsTransaction argument is required");
        EntityManager em = TreatmentGroupLabel.entityManager();
        TypedQuery<TreatmentGroupLabel> q = em.createQuery(
                "SELECT o FROM TreatmentGroupLabel AS o WHERE o.lsTransaction = :lsTransaction",
                TreatmentGroupLabel.class);
        q.setParameter("lsTransaction", lsTransaction);
        return q;
    }
    ...
    public static TypedQuery<TreatmentGroupLabel> findTreatmentGroupLabelsByTreatmentGroup(
            TreatmentGroup treatmentGroup) {
        if (treatmentGroup == null)
            throw new IllegalArgumentException("The treatmentGroup argument is required");
        EntityManager em = TreatmentGroupLabel.entityManager();
        TypedQuery<TreatmentGroupLabel> q = em.createQuery(
                "SELECT o FROM TreatmentGroupLabel AS o WHERE o.treatmentGroup = :treatmentGroup",
                TreatmentGroupLabel.class);
        q.setParameter("treatmentGroup", treatmentGroup);
        return q;
    }
    ...
    public static List<TreatmentGroupLabel> findAllTreatmentGroupLabels() {
        return entityManager().createQuery("SELECT o FROM TreatmentGroupLabel o", TreatmentGroupLabel.class)
                .getResultList();
    }
    ...
    public static List<TreatmentGroupLabel> findTreatmentGroupLabelEntries(int firstResult, int maxResults,
        ...
        return entityManager().createQuery(jpaQuery, TreatmentGroupLabel.class).setFirstResult(firstResult)
