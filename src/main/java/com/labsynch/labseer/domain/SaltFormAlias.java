...
public class SaltFormAlias {
    ...
    public SaltFormAlias(SaltFormAliasDTO saltFormAliasDTO) throws SaltFormNotFoundException {
        try {
            SaltForm saltForm = SaltForm.findSaltFormsByCorpNameEquals(saltFormAliasDTO.getSaltFormCorpName())
                    .getSingleResult();
            this.saltForm = saltForm;
        } catch (Exception e) {
            logger.error("SaltForm" + saltFormAliasDTO.getSaltFormCorpName() + " could not be found.", e);
            throw new SaltFormNotFoundException(
                    "SaltForm " + saltFormAliasDTO.getSaltFormCorpName() + " could not be found.");
        }
    ...
    public static Long countFindSaltFormAliasesByAliasNameEqualsAndLsTypeEqualsAndLsKindEquals(String aliasName,
        ...
        TypedQuery q = em.createQuery(
                "SELECT COUNT(o) FROM SaltFormAlias AS o WHERE o.aliasName = :aliasName  AND o.lsType = :lsType  AND o.lsKind = :lsKind",
                Long.class);
    ...
    public static Long countFindSaltFormAliasesBySaltForm(SaltForm saltForm) {
        ...
        EntityManager em = SaltFormAlias.entityManager();
        TypedQuery q = em.createQuery("SELECT COUNT(o) FROM SaltFormAlias AS o WHERE o.saltForm = :saltForm",
                Long.class);
        q.setParameter("saltForm", saltForm);
        return ((Long) q.getSingleResult());
    }

    public static TypedQuery<SaltFormAlias> findSaltFormAliasesByAliasNameEqualsAndLsTypeEqualsAndLsKindEquals(
        ...
        if (lsKind == null || lsKind.length() == 0)
            throw new IllegalArgumentException("The lsKind argument is required");
        EntityManager em = SaltFormAlias.entityManager();
        TypedQuery<SaltFormAlias> q = em.createQuery(
                "SELECT o FROM SaltFormAlias AS o WHERE o.aliasName = :aliasName  AND o.lsType = :lsType  AND o.lsKind = :lsKind",
                SaltFormAlias.class);
        q.setParameter("aliasName", aliasName);
        q.setParameter("lsType", lsType);
        q.setParameter("lsKind", lsKind);
    ...
    public static TypedQuery<SaltFormAlias> findSaltFormAliasesBySaltForm(SaltForm saltForm) {
        if (saltForm == null)
            throw new IllegalArgumentException("The saltForm argument is required");
        EntityManager em = SaltFormAlias.entityManager();
        TypedQuery<SaltFormAlias> q = em.createQuery("SELECT o FROM SaltFormAlias AS o WHERE o.saltForm = :saltForm",
                SaltFormAlias.class);
        q.setParameter("saltForm", saltForm);
        return q;
    }

    public static TypedQuery<SaltFormAlias> findSaltFormAliasesBySaltForm(SaltForm saltForm, String sortFieldName,
            String sortOrder) {
        if (saltForm == null)
            throw new IllegalArgumentException("The saltForm argument is required");
        EntityManager em = SaltFormAlias.entityManager();
    ...
    public static final List<String> fieldNames4OrderClauseFilter = java.util.Arrays.asList("logger", "saltForm",
            "lsType", "lsKind", "aliasName", "preferred", "ignored", "deleted");
    ...
    public static List<SaltFormAlias> findSaltFormAliasEntries(int firstResult, int maxResults) {
        return entityManager().createQuery("SELECT o FROM SaltFormAlias o", SaltFormAlias.class)
                .setFirstResult(firstResult).setMaxResults(maxResults).getResultList();
    }

    public static List<SaltFormAlias> findSaltFormAliasEntries(int firstResult, int maxResults, String sortFieldName,
            String sortOrder) {
        String jpaQuery = "SELECT o FROM SaltFormAlias o";
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
            jpaQuery = jpaQuery + " ORDER BY " + sortFieldName;
        ...
        return entityManager().createQuery(jpaQuery, SaltFormAlias.class).setFirstResult(firstResult)
