...
public class ExperimentKind {
	...
	public static List<ExperimentKind> findExperimentKindEntries(int firstResult, int maxResults, String sortFieldName, String sortOrder) {
        String jpaQuery = "SELECT o FROM ExperimentKind o";
        if (fieldNames4OrderClauseFilter.contains(sortFieldName)) {
            jpaQuery = jpaQuery + " ORDER BY " + sortFieldName;
            if ("ASC".equalsIgnoreCase(sortOrder) || "DESC".equalsIgnoreCase(sortOrder)) {
	...
	public static TypedQuery<ExperimentKind> findExperimentKindsByLsTypeEqualsAndKindNameEquals(ExperimentType lsType, String kindName) {
        if (lsType == null) throw new IllegalArgumentException("The lsType argument is required");
        if (kindName == null || kindName.length() == 0) throw new IllegalArgumentException("The kindName argument is required");
        EntityManager em = ExperimentKind.entityManager();
	...
	public static TypedQuery<ExperimentKind> findExperimentKindsByLsTypeEqualsAndKindNameEquals(ExperimentType lsType, String kindName, String sortFieldName, String sortOrder) {
        if (lsType == null) throw new IllegalArgumentException("The lsType argument is required");
        if (kindName == null || kindName.length() == 0) throw new IllegalArgumentException("The kindName argument is required");
        EntityManager em = ExperimentKind.entityManager();
