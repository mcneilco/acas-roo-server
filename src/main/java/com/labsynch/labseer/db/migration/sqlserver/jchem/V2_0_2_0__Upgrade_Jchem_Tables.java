package com.labsynch.labseer.db.migration.sqlserver.jchem;
...
public class V2_0_2_0__Upgrade_Jchem_Tables implements JdbcMigration {
 
	Logger logger = LoggerFactory.getLogger(V2_0_2_0__Upgrade_Jchem_Tables.class);
