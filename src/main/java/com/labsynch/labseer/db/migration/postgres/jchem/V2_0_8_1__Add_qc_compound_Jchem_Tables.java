...
public class V2_0_8_1__Add_qc_compound_Jchem_Tables implements JdbcMigration {
 
	Logger logger = LoggerFactory.getLogger(V2_0_8_1__Add_qc_compound_Jchem_Tables.class);
	...
	public void migrate(Connection conn) throws Exception {
		...
		createJChemTable(conn, "qc_compound_structure", true);
