...
//		logger.info("here is ignore value before the update: " + jsonItxLsThingLsThing.isIgnored());
...
//		logger.info("here is ignore value after the update: " + updatedItxLsThingLsThing.isIgnored());
//
