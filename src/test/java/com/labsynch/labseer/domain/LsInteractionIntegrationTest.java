...
public class LsInteractionIntegrationTest {
    ...
    public void testCountLsInteractions() {
        Assert.assertNotNull("Data on demand for 'LsInteraction' failed to initialize correctly",
                dod.getRandomLsInteraction());
    ...
    public void testFindAllLsInteractions() {
        Assert.assertNotNull("Data on demand for 'LsInteraction' failed to initialize correctly",
                dod.getRandomLsInteraction());
        long count = LsInteraction.countLsInteractions();
        Assert.assertTrue("Too expensive to perform a find all test for 'LsInteraction', as there are " + count
    ...
    public void testFindLsInteractionEntries() {
        ...
        Assert.assertEquals("Find entries method for 'LsInteraction' returned an incorrect number of entries", count,
                result.size());
    }
    ...
    public void testFlush() {
        ...
        obj.flush();
        Assert.assertTrue("Version for 'LsInteraction' failed to increment on flush directive",
    ...
    public void testMergeUpdate() {
        ...
        Assert.assertEquals("Identifier of merged object not the same as identifier of original object", merged.getId(),
                id);
        Assert.assertTrue("Version for 'LsInteraction' failed to increment on merge and flush directive",
                (currentVersion != null && obj.getVersion() > currentVersion) || !modified);
    }
    ...
    public void testRemove() {
        ...
        obj.remove();
        obj.flush();
        Assert.assertNull("Failed to remove 'LsInteraction' with identifier '" + id + "'",
                LsInteraction.findLsInteraction(id));
    }
}
