...
import com.labsynch.labseer.domain.ItxContainerContainerIntegrationTest;
...
privileged aspect ItxContainerContainerIntegrationTest_Roo_IntegrationTest {
    
    declare @type: ItxContainerContainerIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: ItxContainerContainerIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: ItxContainerContainerIntegrationTest: @Transactional;
    
    @Autowired
    ItxContainerContainerDataOnDemand ItxContainerContainerIntegrationTest.dod;
    
    @Test
    public void ItxContainerContainerIntegrationTest.testCountItxContainerContainers() {
    ...
    @Test
    public void ItxContainerContainerIntegrationTest.testFindItxContainerContainer() {
    ...
    @Test
    public void ItxContainerContainerIntegrationTest.testFindAllItxContainerContainers() {
        Assert.assertNotNull("Data on demand for 'ItxContainerContainer' failed to initialize correctly", dod.getRandomItxContainerContainer());
        long count = ItxContainerContainer.countItxContainerContainers();
    ...
    @Test
    public void ItxContainerContainerIntegrationTest.testFindItxContainerContainerEntries() {
        Assert.assertNotNull("Data on demand for 'ItxContainerContainer' failed to initialize correctly", dod.getRandomItxContainerContainer());
        long count = ItxContainerContainer.countItxContainerContainers();
    ...
    @Test
    public void ItxContainerContainerIntegrationTest.testFlush() {
        ItxContainerContainer obj = dod.getRandomItxContainerContainer();
        Assert.assertNotNull("Data on demand for 'ItxContainerContainer' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'ItxContainerContainer' failed to provide an identifier", id);
    ...
    @Test
    public void ItxContainerContainerIntegrationTest.testMergeUpdate() {
        ItxContainerContainer obj = dod.getRandomItxContainerContainer();
        Assert.assertNotNull("Data on demand for 'ItxContainerContainer' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'ItxContainerContainer' failed to provide an identifier", id);
    ...
    @Test
    public void ItxContainerContainerIntegrationTest.testPersist() {
        Assert.assertNotNull("Data on demand for 'ItxContainerContainer' failed to initialize correctly", dod.getRandomItxContainerContainer());
    ...
    @Test
    public void ItxContainerContainerIntegrationTest.testRemove() {
        ItxContainerContainer obj = dod.getRandomItxContainerContainer();
        Assert.assertNotNull("Data on demand for 'ItxContainerContainer' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'ItxContainerContainer' failed to provide an identifier", id);
