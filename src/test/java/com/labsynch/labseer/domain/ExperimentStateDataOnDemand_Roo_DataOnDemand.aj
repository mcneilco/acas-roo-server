...
privileged aspect ExperimentStateDataOnDemand_Roo_DataOnDemand {
    
    declare @type: ExperimentStateDataOnDemand: @Component;
    
    private Random ExperimentStateDataOnDemand.rnd = new SecureRandom();
    
    private List<ExperimentState> ExperimentStateDataOnDemand.data;
    
    @Autowired
    ExperimentDataOnDemand ExperimentStateDataOnDemand.experimentDataOnDemand;
    ...
    public void ExperimentStateDataOnDemand.setComments(ExperimentState obj, int index) {
    ...
    public void ExperimentStateDataOnDemand.setIgnored(ExperimentState obj, int index) {
        Boolean ignored = true;
        obj.setIgnored(ignored);
    }
    
    public void ExperimentStateDataOnDemand.setLsKind(ExperimentState obj, int index) {
    ...
    public void ExperimentStateDataOnDemand.setLsTransaction(ExperimentState obj, int index) {
        Long lsTransaction = new Integer(index).longValue();
        obj.setLsTransaction(lsTransaction);
    }
    
    public void ExperimentStateDataOnDemand.setLsType(ExperimentState obj, int index) {
    ...
    public void ExperimentStateDataOnDemand.setLsTypeAndKind(ExperimentState obj, int index) {
    ...
    public void ExperimentStateDataOnDemand.setModifiedBy(ExperimentState obj, int index) {
    ...
    public void ExperimentStateDataOnDemand.setModifiedDate(ExperimentState obj, int index) {
        Date modifiedDate = new GregorianCalendar(Calendar.getInstance().get(Calendar.YEAR), Calendar.getInstance().get(Calendar.MONTH), Calendar.getInstance().get(Calendar.DAY_OF_MONTH), Calendar.getInstance().get(Calendar.HOUR_OF_DAY), Calendar.getInstance().get(Calendar.MINUTE), Calendar.getInstance().get(Calendar.SECOND) + new Double(Math.random() * 1000).intValue()).getTime();
        obj.setModifiedDate(modifiedDate);
    }
    
    public void ExperimentStateDataOnDemand.setRecordedBy(ExperimentState obj, int index) {
    ...
    public void ExperimentStateDataOnDemand.setRecordedDate(ExperimentState obj, int index) {
        Date recordedDate = new GregorianCalendar(Calendar.getInstance().get(Calendar.YEAR), Calendar.getInstance().get(Calendar.MONTH), Calendar.getInstance().get(Calendar.DAY_OF_MONTH), Calendar.getInstance().get(Calendar.HOUR_OF_DAY), Calendar.getInstance().get(Calendar.MINUTE), Calendar.getInstance().get(Calendar.SECOND) + new Double(Math.random() * 1000).intValue()).getTime();
        obj.setRecordedDate(recordedDate);
    }
    
    public ExperimentState ExperimentStateDataOnDemand.getSpecificExperimentState(int index) {
        init();
        if (index < 0) {
            index = 0;
        }
    ...
    public ExperimentState ExperimentStateDataOnDemand.getRandomExperimentState() {
        init();
    ...
    public boolean ExperimentStateDataOnDemand.modifyExperimentState(ExperimentState obj) {
        return false;
    }
    
    public void ExperimentStateDataOnDemand.init() {
        int from = 0;
        int to = 10;
