...
@Component
@Configurable
public class ItxContainerContainerValueDataOnDemand {

    private Random rnd = new SecureRandom();

    private List<ItxContainerContainerValue> data;

    @Autowired
    ItxContainerContainerStateDataOnDemand itxContainerContainerStateDataOnDemand;

    public ItxContainerContainerValue getNewTransientItxContainerContainerValue(int index) {
    ...
    public void setBlobValue(ItxContainerContainerValue obj, int index) {
        byte[] blobValue = String.valueOf(index).getBytes();
        obj.setBlobValue(blobValue);
    }

    public void setClobValue(ItxContainerContainerValue obj, int index) {
        String clobValue = "clobValue_" + index;
        obj.setClobValue(clobValue);
    }

    public void setCodeKind(ItxContainerContainerValue obj, int index) {
    ...
    public void setCodeOrigin(ItxContainerContainerValue obj, int index) {
    ...
    public void setCodeType(ItxContainerContainerValue obj, int index) {
    ...
    public void setCodeTypeAndKind(ItxContainerContainerValue obj, int index) {
    ...
    public void setCodeValue(ItxContainerContainerValue obj, int index) {
    ...
    public void setComments(ItxContainerContainerValue obj, int index) {
    ...
    public void setConcUnit(ItxContainerContainerValue obj, int index) {
    ...
    public void setConcentration(ItxContainerContainerValue obj, int index) {
        Double concentration = new Integer(index).doubleValue();
        obj.setConcentration(concentration);
    }

    public void setDateValue(ItxContainerContainerValue obj, int index) {
    ...
    public void setDeleted(ItxContainerContainerValue obj, int index) {
        Boolean deleted = true;
        obj.setDeleted(deleted);
    }

    public void setFileValue(ItxContainerContainerValue obj, int index) {
    ...
    public void setIgnored(ItxContainerContainerValue obj, int index) {
        Boolean ignored = true;
        obj.setIgnored(ignored);
    }

    public void setLsKind(ItxContainerContainerValue obj, int index) {
    ...
    public void setLsTransaction(ItxContainerContainerValue obj, int index) {
        Long lsTransaction = new Integer(index).longValue();
        obj.setLsTransaction(lsTransaction);
    }

    public void setLsType(ItxContainerContainerValue obj, int index) {
    ...
    public void setLsTypeAndKind(ItxContainerContainerValue obj, int index) {
    ...
    public void setModifiedBy(ItxContainerContainerValue obj, int index) {
    ...
    public void setModifiedDate(ItxContainerContainerValue obj, int index) {
    ...
    public void setNumberOfReplicates(ItxContainerContainerValue obj, int index) {
        Integer numberOfReplicates = new Integer(index);
        obj.setNumberOfReplicates(numberOfReplicates);
    }

    public void setNumericValue(ItxContainerContainerValue obj, int index) {
    ...
    public void setOperatorKind(ItxContainerContainerValue obj, int index) {
    ...
    public void setOperatorType(ItxContainerContainerValue obj, int index) {
    ...
    public void setOperatorTypeAndKind(ItxContainerContainerValue obj, int index) {
    ...
    public void setPublicData(ItxContainerContainerValue obj, int index) {
        Boolean publicData = true;
        obj.setPublicData(publicData);
    }

    public void setRecordedBy(ItxContainerContainerValue obj, int index) {
    ...
    public void setRecordedDate(ItxContainerContainerValue obj, int index) {
    ...
    public void setSigFigs(ItxContainerContainerValue obj, int index) {
        Integer sigFigs = new Integer(index);
        obj.setSigFigs(sigFigs);
    }

    public void setStringValue(ItxContainerContainerValue obj, int index) {
    ...
    public void setUncertainty(ItxContainerContainerValue obj, int index) {
    ...
    public void setUncertaintyType(ItxContainerContainerValue obj, int index) {
    ...
    public void setUnitKind(ItxContainerContainerValue obj, int index) {
    ...
    public void setUnitType(ItxContainerContainerValue obj, int index) {
    ...
    public void setUnitTypeAndKind(ItxContainerContainerValue obj, int index) {
    ...
    public void setUrlValue(ItxContainerContainerValue obj, int index) {
    ...
    public ItxContainerContainerValue getSpecificItxContainerContainerValue(int index) {
        init();
        if (index < 0) {
            index = 0;
        }
    ...
    public ItxContainerContainerValue getRandomItxContainerContainerValue() {
        init();
    ...
    public boolean modifyItxContainerContainerValue(ItxContainerContainerValue obj) {
        return false;
    }
    ...
    public void init() {
        ...
        if (data == null) {
            throw new IllegalStateException(
                    "Find entries implementation for 'ItxContainerContainerValue' illegally returned null");
        }
        if (!data.isEmpty()) {
            return;
        }
