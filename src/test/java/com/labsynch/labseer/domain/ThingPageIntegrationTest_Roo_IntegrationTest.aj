...
import com.labsynch.labseer.domain.ThingPageIntegrationTest;
...
privileged aspect ThingPageIntegrationTest_Roo_IntegrationTest {
    
    declare @type: ThingPageIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: ThingPageIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: ThingPageIntegrationTest: @Transactional;
    
    @Autowired
    ThingPageDataOnDemand ThingPageIntegrationTest.dod;
    
    @Test
    public void ThingPageIntegrationTest.testCountThingPages() {
    ...
    @Test
    public void ThingPageIntegrationTest.testFindThingPage() {
    ...
    @Test
    public void ThingPageIntegrationTest.testFindAllThingPages() {
        Assert.assertNotNull("Data on demand for 'ThingPage' failed to initialize correctly", dod.getRandomThingPage());
        long count = ThingPage.countThingPages();
    ...
    @Test
    public void ThingPageIntegrationTest.testFindThingPageEntries() {
        Assert.assertNotNull("Data on demand for 'ThingPage' failed to initialize correctly", dod.getRandomThingPage());
        long count = ThingPage.countThingPages();
    ...
    @Test
    public void ThingPageIntegrationTest.testFlush() {
        ThingPage obj = dod.getRandomThingPage();
        Assert.assertNotNull("Data on demand for 'ThingPage' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'ThingPage' failed to provide an identifier", id);
    ...
    @Test
    public void ThingPageIntegrationTest.testMergeUpdate() {
        ThingPage obj = dod.getRandomThingPage();
        Assert.assertNotNull("Data on demand for 'ThingPage' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'ThingPage' failed to provide an identifier", id);
    ...
    @Test
    public void ThingPageIntegrationTest.testPersist() {
        Assert.assertNotNull("Data on demand for 'ThingPage' failed to initialize correctly", dod.getRandomThingPage());
    ...
    @Test
    public void ThingPageIntegrationTest.testRemove() {
        ThingPage obj = dod.getRandomThingPage();
        Assert.assertNotNull("Data on demand for 'ThingPage' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'ThingPage' failed to provide an identifier", id);
