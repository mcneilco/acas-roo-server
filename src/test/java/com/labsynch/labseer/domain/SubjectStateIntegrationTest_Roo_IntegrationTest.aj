...
import com.labsynch.labseer.domain.SubjectStateIntegrationTest;
...
privileged aspect SubjectStateIntegrationTest_Roo_IntegrationTest {
    
    declare @type: SubjectStateIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: SubjectStateIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: SubjectStateIntegrationTest: @Transactional;
    
    @Autowired
    SubjectStateDataOnDemand SubjectStateIntegrationTest.dod;
    
    @Test
    public void SubjectStateIntegrationTest.testCountSubjectStates() {
    ...
    @Test
    public void SubjectStateIntegrationTest.testFindSubjectState() {
    ...
    @Test
    public void SubjectStateIntegrationTest.testFindAllSubjectStates() {
        Assert.assertNotNull("Data on demand for 'SubjectState' failed to initialize correctly", dod.getRandomSubjectState());
        long count = SubjectState.countSubjectStates();
    ...
    @Test
    public void SubjectStateIntegrationTest.testFindSubjectStateEntries() {
        Assert.assertNotNull("Data on demand for 'SubjectState' failed to initialize correctly", dod.getRandomSubjectState());
        long count = SubjectState.countSubjectStates();
    ...
    @Test
    public void SubjectStateIntegrationTest.testFlush() {
        SubjectState obj = dod.getRandomSubjectState();
        Assert.assertNotNull("Data on demand for 'SubjectState' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'SubjectState' failed to provide an identifier", id);
    ...
    @Test
    public void SubjectStateIntegrationTest.testMergeUpdate() {
        SubjectState obj = dod.getRandomSubjectState();
        Assert.assertNotNull("Data on demand for 'SubjectState' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'SubjectState' failed to provide an identifier", id);
    ...
    @Test
    public void SubjectStateIntegrationTest.testPersist() {
        Assert.assertNotNull("Data on demand for 'SubjectState' failed to initialize correctly", dod.getRandomSubjectState());
    ...
    @Test
    public void SubjectStateIntegrationTest.testRemove() {
        SubjectState obj = dod.getRandomSubjectState();
        Assert.assertNotNull("Data on demand for 'SubjectState' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'SubjectState' failed to provide an identifier", id);
