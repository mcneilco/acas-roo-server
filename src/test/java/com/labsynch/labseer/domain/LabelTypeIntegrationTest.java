...
public class LabelTypeIntegrationTest {
    ...
    public void testFindAllLabelTypes() {
        Assert.assertNotNull("Data on demand for 'LabelType' failed to initialize correctly", dod.getRandomLabelType());
        long count = LabelType.countLabelTypes();
        Assert.assertTrue("Too expensive to perform a find all test for 'LabelType', as there are " + count
    ...
    public void testFindLabelTypeEntries() {
        ...
        Assert.assertEquals("Find entries method for 'LabelType' returned an incorrect number of entries", count,
                result.size());
    }
    ...
    public void testFlush() {
        ...
        obj.flush();
        Assert.assertTrue("Version for 'LabelType' failed to increment on flush directive",
    ...
    public void testMergeUpdate() {
        ...
        Assert.assertEquals("Identifier of merged object not the same as identifier of original object", merged.getId(),
                id);
        Assert.assertTrue("Version for 'LabelType' failed to increment on merge and flush directive",
                (currentVersion != null && obj.getVersion() > currentVersion) || !modified);
    }
