...
public class AnalysisGroupIntegrationTest {
    ...
    public void testCountAnalysisGroups() {
        Assert.assertNotNull("Data on demand for 'AnalysisGroup' failed to initialize correctly",
                dod.getRandomAnalysisGroup());
    ...
    public void testFindAllAnalysisGroups() {
        Assert.assertNotNull("Data on demand for 'AnalysisGroup' failed to initialize correctly",
                dod.getRandomAnalysisGroup());
        long count = AnalysisGroup.countAnalysisGroups();
        Assert.assertTrue("Too expensive to perform a find all test for 'AnalysisGroup', as there are " + count
    ...
    public void testFindAnalysisGroupEntries() {
        ...
        Assert.assertEquals("Find entries method for 'AnalysisGroup' returned an incorrect number of entries", count,
                result.size());
    }
    ...
    public void testFlush() {
        ...
        obj.flush();
        Assert.assertTrue("Version for 'AnalysisGroup' failed to increment on flush directive",
    ...
    public void testMergeUpdate() {
        ...
        Assert.assertEquals("Identifier of merged object not the same as identifier of original object", merged.getId(),
                id);
        Assert.assertTrue("Version for 'AnalysisGroup' failed to increment on merge and flush directive",
                (currentVersion != null && obj.getVersion() > currentVersion) || !modified);
    }
    ...
    public void testRemove() {
        ...
        obj.remove();
        obj.flush();
        Assert.assertNull("Failed to remove 'AnalysisGroup' with identifier '" + id + "'",
                AnalysisGroup.findAnalysisGroup(id));
    }
}
