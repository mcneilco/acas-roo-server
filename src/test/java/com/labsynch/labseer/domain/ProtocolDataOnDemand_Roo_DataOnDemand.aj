...
privileged aspect ProtocolDataOnDemand_Roo_DataOnDemand {
    
    declare @type: ProtocolDataOnDemand: @Component;
    
    private Random ProtocolDataOnDemand.rnd = new SecureRandom();
    
    private List<Protocol> ProtocolDataOnDemand.data;
    ...
    public void ProtocolDataOnDemand.setCodeName(Protocol obj, int index) {
    ...
    public void ProtocolDataOnDemand.setLsKind(Protocol obj, int index) {
    ...
    public void ProtocolDataOnDemand.setLsTransaction(Protocol obj, int index) {
        Long lsTransaction = new Integer(index).longValue();
        obj.setLsTransaction(lsTransaction);
    }
    
    public void ProtocolDataOnDemand.setLsType(Protocol obj, int index) {
    ...
    public void ProtocolDataOnDemand.setLsTypeAndKind(Protocol obj, int index) {
    ...
    public void ProtocolDataOnDemand.setModifiedBy(Protocol obj, int index) {
    ...
    public void ProtocolDataOnDemand.setModifiedDate(Protocol obj, int index) {
        Date modifiedDate = new GregorianCalendar(Calendar.getInstance().get(Calendar.YEAR), Calendar.getInstance().get(Calendar.MONTH), Calendar.getInstance().get(Calendar.DAY_OF_MONTH), Calendar.getInstance().get(Calendar.HOUR_OF_DAY), Calendar.getInstance().get(Calendar.MINUTE), Calendar.getInstance().get(Calendar.SECOND) + new Double(Math.random() * 1000).intValue()).getTime();
        obj.setModifiedDate(modifiedDate);
    }
    
    public void ProtocolDataOnDemand.setRecordedBy(Protocol obj, int index) {
    ...
    public void ProtocolDataOnDemand.setRecordedDate(Protocol obj, int index) {
        Date recordedDate = new GregorianCalendar(Calendar.getInstance().get(Calendar.YEAR), Calendar.getInstance().get(Calendar.MONTH), Calendar.getInstance().get(Calendar.DAY_OF_MONTH), Calendar.getInstance().get(Calendar.HOUR_OF_DAY), Calendar.getInstance().get(Calendar.MINUTE), Calendar.getInstance().get(Calendar.SECOND) + new Double(Math.random() * 1000).intValue()).getTime();
        obj.setRecordedDate(recordedDate);
    }
    
    public void ProtocolDataOnDemand.setShortDescription(Protocol obj, int index) {
    ...
    public Protocol ProtocolDataOnDemand.getSpecificProtocol(int index) {
        init();
        if (index < 0) {
            index = 0;
        }
    ...
    public Protocol ProtocolDataOnDemand.getRandomProtocol() {
        init();
    ...
    public boolean ProtocolDataOnDemand.modifyProtocol(Protocol obj) {
        return false;
    }
    
    public void ProtocolDataOnDemand.init() {
        int from = 0;
        int to = 10;
