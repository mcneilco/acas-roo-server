...
public class OperatorTypeIntegrationTest {
    ...
    public void testCountOperatorTypes() {
        Assert.assertNotNull("Data on demand for 'OperatorType' failed to initialize correctly",
                dod.getRandomOperatorType());
    ...
    public void testFindAllOperatorTypes() {
        Assert.assertNotNull("Data on demand for 'OperatorType' failed to initialize correctly",
                dod.getRandomOperatorType());
        long count = OperatorType.countOperatorTypes();
        Assert.assertTrue("Too expensive to perform a find all test for 'OperatorType', as there are " + count
    ...
    public void testFindOperatorTypeEntries() {
        ...
        Assert.assertEquals("Find entries method for 'OperatorType' returned an incorrect number of entries", count,
                result.size());
    }
    ...
    public void testFlush() {
        ...
        obj.flush();
        Assert.assertTrue("Version for 'OperatorType' failed to increment on flush directive",
    ...
    public void testMergeUpdate() {
        ...
        Assert.assertEquals("Identifier of merged object not the same as identifier of original object", merged.getId(),
                id);
        Assert.assertTrue("Version for 'OperatorType' failed to increment on merge and flush directive",
                (currentVersion != null && obj.getVersion() > currentVersion) || !modified);
    }
    ...
    public void testRemove() {
        ...
        obj.remove();
        obj.flush();
        Assert.assertNull("Failed to remove 'OperatorType' with identifier '" + id + "'",
                OperatorType.findOperatorType(id));
    }
}
