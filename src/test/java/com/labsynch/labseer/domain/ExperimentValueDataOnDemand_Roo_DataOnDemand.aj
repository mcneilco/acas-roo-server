...
privileged aspect ExperimentValueDataOnDemand_Roo_DataOnDemand {
    
    declare @type: ExperimentValueDataOnDemand: @Component;
    
    private Random ExperimentValueDataOnDemand.rnd = new SecureRandom();
    
    private List<ExperimentValue> ExperimentValueDataOnDemand.data;
    
    @Autowired
    ExperimentStateDataOnDemand ExperimentValueDataOnDemand.experimentStateDataOnDemand;
    
    public ExperimentValue ExperimentValueDataOnDemand.getNewTransientExperimentValue(int index) {
    ...
    public void ExperimentValueDataOnDemand.setBlobValue(ExperimentValue obj, int index) {
        byte[] blobValue = String.valueOf(index).getBytes();
        obj.setBlobValue(blobValue);
    }
    
    public void ExperimentValueDataOnDemand.setClobValue(ExperimentValue obj, int index) {
        String clobValue = "clobValue_" + index;
        obj.setClobValue(clobValue);
    }
    
    public void ExperimentValueDataOnDemand.setCodeKind(ExperimentValue obj, int index) {
    ...
    public void ExperimentValueDataOnDemand.setCodeTypeAndKind(ExperimentValue obj, int index) {
    ...
    public void ExperimentValueDataOnDemand.setCodeValue(ExperimentValue obj, int index) {
    ...
    public void ExperimentValueDataOnDemand.setComments(ExperimentValue obj, int index) {
    ...
    public void ExperimentValueDataOnDemand.setConcUnit(ExperimentValue obj, int index) {
    ...
    public void ExperimentValueDataOnDemand.setConcentration(ExperimentValue obj, int index) {
        Double concentration = new Integer(index).doubleValue();
        obj.setConcentration(concentration);
    }
    
    public void ExperimentValueDataOnDemand.setDateValue(ExperimentValue obj, int index) {
    ...
    public void ExperimentValueDataOnDemand.setDeleted(ExperimentValue obj, int index) {
        Boolean deleted = true;
        obj.setDeleted(deleted);
    }
    
    public void ExperimentValueDataOnDemand.setFileValue(ExperimentValue obj, int index) {
    ...
    public void ExperimentValueDataOnDemand.setIgnored(ExperimentValue obj, int index) {
        Boolean ignored = true;
        obj.setIgnored(ignored);
    }
    
    public void ExperimentValueDataOnDemand.setLsKind(ExperimentValue obj, int index) {
    ...
    public void ExperimentValueDataOnDemand.setLsState(ExperimentValue obj, int index) {
        ExperimentState lsState = experimentStateDataOnDemand.getRandomExperimentState();
        obj.setLsState(lsState);
    }
    
    public void ExperimentValueDataOnDemand.setLsTransaction(ExperimentValue obj, int index) {
        Long lsTransaction = new Integer(index).longValue();
        obj.setLsTransaction(lsTransaction);
    }
    
    public void ExperimentValueDataOnDemand.setLsType(ExperimentValue obj, int index) {
    ...
    public void ExperimentValueDataOnDemand.setLsTypeAndKind(ExperimentValue obj, int index) {
    ...
    public void ExperimentValueDataOnDemand.setModifiedBy(ExperimentValue obj, int index) {
    ...
    public void ExperimentValueDataOnDemand.setModifiedDate(ExperimentValue obj, int index) {
        Date modifiedDate = new GregorianCalendar(Calendar.getInstance().get(Calendar.YEAR), Calendar.getInstance().get(Calendar.MONTH), Calendar.getInstance().get(Calendar.DAY_OF_MONTH), Calendar.getInstance().get(Calendar.HOUR_OF_DAY), Calendar.getInstance().get(Calendar.MINUTE), Calendar.getInstance().get(Calendar.SECOND) + new Double(Math.random() * 1000).intValue()).getTime();
        obj.setModifiedDate(modifiedDate);
    }
    
    public void ExperimentValueDataOnDemand.setNumberOfReplicates(ExperimentValue obj, int index) {
        Integer numberOfReplicates = new Integer(index);
        obj.setNumberOfReplicates(numberOfReplicates);
    }
    
    public void ExperimentValueDataOnDemand.setNumericValue(ExperimentValue obj, int index) {
    ...
    public void ExperimentValueDataOnDemand.setOperatorKind(ExperimentValue obj, int index) {
    ...
    public void ExperimentValueDataOnDemand.setOperatorType(ExperimentValue obj, int index) {
    ...
    public void ExperimentValueDataOnDemand.setOperatorTypeAndKind(ExperimentValue obj, int index) {
    ...
    public void ExperimentValueDataOnDemand.setPublicData(ExperimentValue obj, int index) {
        Boolean publicData = true;
        obj.setPublicData(publicData);
    }
    
    public void ExperimentValueDataOnDemand.setRecordedBy(ExperimentValue obj, int index) {
    ...
    public void ExperimentValueDataOnDemand.setRecordedDate(ExperimentValue obj, int index) {
        Date recordedDate = new GregorianCalendar(Calendar.getInstance().get(Calendar.YEAR), Calendar.getInstance().get(Calendar.MONTH), Calendar.getInstance().get(Calendar.DAY_OF_MONTH), Calendar.getInstance().get(Calendar.HOUR_OF_DAY), Calendar.getInstance().get(Calendar.MINUTE), Calendar.getInstance().get(Calendar.SECOND) + new Double(Math.random() * 1000).intValue()).getTime();
        obj.setRecordedDate(recordedDate);
    }
    
    public void ExperimentValueDataOnDemand.setSigFigs(ExperimentValue obj, int index) {
        Integer sigFigs = new Integer(index);
        obj.setSigFigs(sigFigs);
    }
    
    public void ExperimentValueDataOnDemand.setStringValue(ExperimentValue obj, int index) {
    ...
    public void ExperimentValueDataOnDemand.setUncertainty(ExperimentValue obj, int index) {
    ...
    public void ExperimentValueDataOnDemand.setUncertaintyType(ExperimentValue obj, int index) {
    ...
    public void ExperimentValueDataOnDemand.setUnitKind(ExperimentValue obj, int index) {
    ...
    public void ExperimentValueDataOnDemand.setUnitType(ExperimentValue obj, int index) {
    ...
    public void ExperimentValueDataOnDemand.setUnitTypeAndKind(ExperimentValue obj, int index) {
    ...
    public void ExperimentValueDataOnDemand.setUrlValue(ExperimentValue obj, int index) {
    ...
    public ExperimentValue ExperimentValueDataOnDemand.getSpecificExperimentValue(int index) {
        init();
        if (index < 0) {
            index = 0;
        }
    ...
    public ExperimentValue ExperimentValueDataOnDemand.getRandomExperimentValue() {
        init();
    ...
    public boolean ExperimentValueDataOnDemand.modifyExperimentValue(ExperimentValue obj) {
        return false;
    }
    
    public void ExperimentValueDataOnDemand.init() {
        int from = 0;
        int to = 10;
