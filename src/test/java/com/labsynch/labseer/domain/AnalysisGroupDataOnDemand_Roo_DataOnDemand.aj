...
privileged aspect AnalysisGroupDataOnDemand_Roo_DataOnDemand {
    ...
    declare @type: AnalysisGroupDataOnDemand: @Component;
    
    private Random AnalysisGroupDataOnDemand.rnd = new SecureRandom();
    ...
    public void AnalysisGroupDataOnDemand.setCodeName(AnalysisGroup obj, int index) {
    ...
    public void AnalysisGroupDataOnDemand.setLsKind(AnalysisGroup obj, int index) {
    ...
    public void AnalysisGroupDataOnDemand.setLsTransaction(AnalysisGroup obj, int index) {
        Long lsTransaction = new Integer(index).longValue();
        obj.setLsTransaction(lsTransaction);
    }
    
    public void AnalysisGroupDataOnDemand.setLsType(AnalysisGroup obj, int index) {
    ...
    public void AnalysisGroupDataOnDemand.setLsTypeAndKind(AnalysisGroup obj, int index) {
    ...
    public void AnalysisGroupDataOnDemand.setModifiedBy(AnalysisGroup obj, int index) {
    ...
    public void AnalysisGroupDataOnDemand.setModifiedDate(AnalysisGroup obj, int index) {
        Date modifiedDate = new GregorianCalendar(Calendar.getInstance().get(Calendar.YEAR), Calendar.getInstance().get(Calendar.MONTH), Calendar.getInstance().get(Calendar.DAY_OF_MONTH), Calendar.getInstance().get(Calendar.HOUR_OF_DAY), Calendar.getInstance().get(Calendar.MINUTE), Calendar.getInstance().get(Calendar.SECOND) + new Double(Math.random() * 1000).intValue()).getTime();
        obj.setModifiedDate(modifiedDate);
    }
    
    public void AnalysisGroupDataOnDemand.setRecordedBy(AnalysisGroup obj, int index) {
    ...
    public void AnalysisGroupDataOnDemand.setRecordedDate(AnalysisGroup obj, int index) {
        Date recordedDate = new GregorianCalendar(Calendar.getInstance().get(Calendar.YEAR), Calendar.getInstance().get(Calendar.MONTH), Calendar.getInstance().get(Calendar.DAY_OF_MONTH), Calendar.getInstance().get(Calendar.HOUR_OF_DAY), Calendar.getInstance().get(Calendar.MINUTE), Calendar.getInstance().get(Calendar.SECOND) + new Double(Math.random() * 1000).intValue()).getTime();
        obj.setRecordedDate(recordedDate);
    }
    
    public AnalysisGroup AnalysisGroupDataOnDemand.getSpecificAnalysisGroup(int index) {
        init();
        if (index < 0) {
            index = 0;
        }
    ...
    public AnalysisGroup AnalysisGroupDataOnDemand.getRandomAnalysisGroup() {
        init();
    ...
    public boolean AnalysisGroupDataOnDemand.modifyAnalysisGroup(AnalysisGroup obj) {
        return false;
    }
    
    public void AnalysisGroupDataOnDemand.init() {
        int from = 0;
        int to = 10;
