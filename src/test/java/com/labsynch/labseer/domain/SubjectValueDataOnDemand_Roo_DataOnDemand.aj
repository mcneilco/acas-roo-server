...
privileged aspect SubjectValueDataOnDemand_Roo_DataOnDemand {
    
    declare @type: SubjectValueDataOnDemand: @Component;
    
    private Random SubjectValueDataOnDemand.rnd = new SecureRandom();
    
    private List<SubjectValue> SubjectValueDataOnDemand.data;
    
    @Autowired
    SubjectStateDataOnDemand SubjectValueDataOnDemand.subjectStateDataOnDemand;
    
    public SubjectValue SubjectValueDataOnDemand.getNewTransientSubjectValue(int index) {
    ...
    public void SubjectValueDataOnDemand.setBlobValue(SubjectValue obj, int index) {
        byte[] blobValue = String.valueOf(index).getBytes();
        obj.setBlobValue(blobValue);
    }
    
    public void SubjectValueDataOnDemand.setClobValue(SubjectValue obj, int index) {
        String clobValue = "clobValue_" + index;
        obj.setClobValue(clobValue);
    }
    
    public void SubjectValueDataOnDemand.setCodeKind(SubjectValue obj, int index) {
    ...
    public void SubjectValueDataOnDemand.setCodeOrigin(SubjectValue obj, int index) {
    ...
    public void SubjectValueDataOnDemand.setCodeType(SubjectValue obj, int index) {
    ...
    public void SubjectValueDataOnDemand.setCodeTypeAndKind(SubjectValue obj, int index) {
    ...
    public void SubjectValueDataOnDemand.setCodeValue(SubjectValue obj, int index) {
    ...
    public void SubjectValueDataOnDemand.setComments(SubjectValue obj, int index) {
    ...
    public void SubjectValueDataOnDemand.setConcUnit(SubjectValue obj, int index) {
    ...
    public void SubjectValueDataOnDemand.setConcentration(SubjectValue obj, int index) {
        Double concentration = new Integer(index).doubleValue();
        obj.setConcentration(concentration);
    }
    
    public void SubjectValueDataOnDemand.setDateValue(SubjectValue obj, int index) {
    ...
    public void SubjectValueDataOnDemand.setDeleted(SubjectValue obj, int index) {
        Boolean deleted = true;
        obj.setDeleted(deleted);
    }
    
    public void SubjectValueDataOnDemand.setFileValue(SubjectValue obj, int index) {
    ...
    public void SubjectValueDataOnDemand.setIgnored(SubjectValue obj, int index) {
        Boolean ignored = true;
        obj.setIgnored(ignored);
    }
    
    public void SubjectValueDataOnDemand.setLsKind(SubjectValue obj, int index) {
    ...
    public void SubjectValueDataOnDemand.setLsState(SubjectValue obj, int index) {
        SubjectState lsState = subjectStateDataOnDemand.getRandomSubjectState();
        obj.setLsState(lsState);
    }
    
    public void SubjectValueDataOnDemand.setLsTransaction(SubjectValue obj, int index) {
        Long lsTransaction = new Integer(index).longValue();
        obj.setLsTransaction(lsTransaction);
    }
    
    public void SubjectValueDataOnDemand.setLsType(SubjectValue obj, int index) {
    ...
    public void SubjectValueDataOnDemand.setLsTypeAndKind(SubjectValue obj, int index) {
    ...
    public void SubjectValueDataOnDemand.setModifiedBy(SubjectValue obj, int index) {
    ...
    public void SubjectValueDataOnDemand.setModifiedDate(SubjectValue obj, int index) {
        Date modifiedDate = new GregorianCalendar(Calendar.getInstance().get(Calendar.YEAR), Calendar.getInstance().get(Calendar.MONTH), Calendar.getInstance().get(Calendar.DAY_OF_MONTH), Calendar.getInstance().get(Calendar.HOUR_OF_DAY), Calendar.getInstance().get(Calendar.MINUTE), Calendar.getInstance().get(Calendar.SECOND) + new Double(Math.random() * 1000).intValue()).getTime();
        obj.setModifiedDate(modifiedDate);
    }
    
    public void SubjectValueDataOnDemand.setNumberOfReplicates(SubjectValue obj, int index) {
        Integer numberOfReplicates = new Integer(index);
        obj.setNumberOfReplicates(numberOfReplicates);
    }
    
    public void SubjectValueDataOnDemand.setNumericValue(SubjectValue obj, int index) {
    ...
    public void SubjectValueDataOnDemand.setOperatorKind(SubjectValue obj, int index) {
    ...
    public void SubjectValueDataOnDemand.setOperatorType(SubjectValue obj, int index) {
    ...
    public void SubjectValueDataOnDemand.setOperatorTypeAndKind(SubjectValue obj, int index) {
    ...
    public void SubjectValueDataOnDemand.setPublicData(SubjectValue obj, int index) {
        Boolean publicData = true;
        obj.setPublicData(publicData);
    }
    
    public void SubjectValueDataOnDemand.setRecordedBy(SubjectValue obj, int index) {
    ...
    public void SubjectValueDataOnDemand.setRecordedDate(SubjectValue obj, int index) {
        Date recordedDate = new GregorianCalendar(Calendar.getInstance().get(Calendar.YEAR), Calendar.getInstance().get(Calendar.MONTH), Calendar.getInstance().get(Calendar.DAY_OF_MONTH), Calendar.getInstance().get(Calendar.HOUR_OF_DAY), Calendar.getInstance().get(Calendar.MINUTE), Calendar.getInstance().get(Calendar.SECOND) + new Double(Math.random() * 1000).intValue()).getTime();
        obj.setRecordedDate(recordedDate);
    }
    
    public void SubjectValueDataOnDemand.setSigFigs(SubjectValue obj, int index) {
        Integer sigFigs = new Integer(index);
        obj.setSigFigs(sigFigs);
    }
    
    public void SubjectValueDataOnDemand.setStringValue(SubjectValue obj, int index) {
    ...
    public void SubjectValueDataOnDemand.setUncertainty(SubjectValue obj, int index) {
    ...
    public void SubjectValueDataOnDemand.setUncertaintyType(SubjectValue obj, int index) {
    ...
    public void SubjectValueDataOnDemand.setUnitKind(SubjectValue obj, int index) {
    ...
    public void SubjectValueDataOnDemand.setUnitType(SubjectValue obj, int index) {
    ...
    public void SubjectValueDataOnDemand.setUnitTypeAndKind(SubjectValue obj, int index) {
    ...
    public void SubjectValueDataOnDemand.setUrlValue(SubjectValue obj, int index) {
    ...
    public SubjectValue SubjectValueDataOnDemand.getSpecificSubjectValue(int index) {
        init();
        if (index < 0) {
            index = 0;
        }
    ...
    public SubjectValue SubjectValueDataOnDemand.getRandomSubjectValue() {
        init();
    ...
    public boolean SubjectValueDataOnDemand.modifySubjectValue(SubjectValue obj) {
        return false;
    }
    
    public void SubjectValueDataOnDemand.init() {
        int from = 0;
        int to = 10;
