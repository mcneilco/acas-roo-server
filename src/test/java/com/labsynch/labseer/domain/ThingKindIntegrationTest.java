...
public class ThingKindIntegrationTest {
    ...
    public void testFindAllThingKinds() {
        Assert.assertNotNull("Data on demand for 'ThingKind' failed to initialize correctly", dod.getRandomThingKind());
        long count = ThingKind.countThingKinds();
        Assert.assertTrue("Too expensive to perform a find all test for 'ThingKind', as there are " + count
    ...
    public void testFindThingKindEntries() {
        ...
        Assert.assertEquals("Find entries method for 'ThingKind' returned an incorrect number of entries", count,
                result.size());
    }
    ...
    public void testFlush() {
        ...
        obj.flush();
        Assert.assertTrue("Version for 'ThingKind' failed to increment on flush directive",
    ...
    public void testMergeUpdate() {
        ...
        Assert.assertEquals("Identifier of merged object not the same as identifier of original object", merged.getId(),
                id);
        Assert.assertTrue("Version for 'ThingKind' failed to increment on merge and flush directive",
                (currentVersion != null && obj.getVersion() > currentVersion) || !modified);
    }
