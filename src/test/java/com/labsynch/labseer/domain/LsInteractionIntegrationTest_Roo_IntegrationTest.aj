...
import com.labsynch.labseer.domain.LsInteractionIntegrationTest;
...
privileged aspect LsInteractionIntegrationTest_Roo_IntegrationTest {
    
    declare @type: LsInteractionIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: LsInteractionIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: LsInteractionIntegrationTest: @Transactional;
    
    @Autowired
    LsInteractionDataOnDemand LsInteractionIntegrationTest.dod;
    
    @Test
    public void LsInteractionIntegrationTest.testCountLsInteractions() {
    ...
    @Test
    public void LsInteractionIntegrationTest.testFindLsInteraction() {
    ...
    @Test
    public void LsInteractionIntegrationTest.testFindAllLsInteractions() {
        Assert.assertNotNull("Data on demand for 'LsInteraction' failed to initialize correctly", dod.getRandomLsInteraction());
        long count = LsInteraction.countLsInteractions();
    ...
    @Test
    public void LsInteractionIntegrationTest.testFindLsInteractionEntries() {
        Assert.assertNotNull("Data on demand for 'LsInteraction' failed to initialize correctly", dod.getRandomLsInteraction());
        long count = LsInteraction.countLsInteractions();
    ...
    @Test
    public void LsInteractionIntegrationTest.testFlush() {
        LsInteraction obj = dod.getRandomLsInteraction();
        Assert.assertNotNull("Data on demand for 'LsInteraction' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'LsInteraction' failed to provide an identifier", id);
    ...
    @Test
    public void LsInteractionIntegrationTest.testMergeUpdate() {
        LsInteraction obj = dod.getRandomLsInteraction();
        Assert.assertNotNull("Data on demand for 'LsInteraction' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'LsInteraction' failed to provide an identifier", id);
    ...
    @Test
    public void LsInteractionIntegrationTest.testPersist() {
        Assert.assertNotNull("Data on demand for 'LsInteraction' failed to initialize correctly", dod.getRandomLsInteraction());
    ...
    @Test
    public void LsInteractionIntegrationTest.testRemove() {
        LsInteraction obj = dod.getRandomLsInteraction();
        Assert.assertNotNull("Data on demand for 'LsInteraction' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'LsInteraction' failed to provide an identifier", id);
