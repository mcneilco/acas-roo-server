...
public class TreatmentGroupStateIntegrationTest {
    ...
    public void testCountTreatmentGroupStates() {
        Assert.assertNotNull("Data on demand for 'TreatmentGroupState' failed to initialize correctly",
                dod.getRandomTreatmentGroupState());
    ...
    public void testFindAllTreatmentGroupStates() {
        Assert.assertNotNull("Data on demand for 'TreatmentGroupState' failed to initialize correctly",
                dod.getRandomTreatmentGroupState());
        long count = TreatmentGroupState.countTreatmentGroupStates();
        Assert.assertTrue("Too expensive to perform a find all test for 'TreatmentGroupState', as there are " + count
    ...
    public void testFindTreatmentGroupStateEntries() {
        ...
        Assert.assertEquals("Find entries method for 'TreatmentGroupState' returned an incorrect number of entries",
                count, result.size());
    }
    ...
    public void testFlush() {
        ...
        obj.flush();
        Assert.assertTrue("Version for 'TreatmentGroupState' failed to increment on flush directive",
    ...
    public void testMergeUpdate() {
        ...
        Assert.assertEquals("Identifier of merged object not the same as identifier of original object", merged.getId(),
                id);
        Assert.assertTrue("Version for 'TreatmentGroupState' failed to increment on merge and flush directive",
                (currentVersion != null && obj.getVersion() > currentVersion) || !modified);
    }
    ...
    public void testRemove() {
        ...
        obj.remove();
        obj.flush();
        Assert.assertNull("Failed to remove 'TreatmentGroupState' with identifier '" + id + "'",
                TreatmentGroupState.findTreatmentGroupState(id));
    }
}
