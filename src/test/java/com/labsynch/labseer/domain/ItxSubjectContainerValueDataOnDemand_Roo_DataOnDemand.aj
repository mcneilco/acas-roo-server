...
privileged aspect ItxSubjectContainerValueDataOnDemand_Roo_DataOnDemand {
    
    declare @type: ItxSubjectContainerValueDataOnDemand: @Component;
    
    private Random ItxSubjectContainerValueDataOnDemand.rnd = new SecureRandom();
    
    private List<ItxSubjectContainerValue> ItxSubjectContainerValueDataOnDemand.data;
    
    @Autowired
    ItxSubjectContainerStateDataOnDemand ItxSubjectContainerValueDataOnDemand.itxSubjectContainerStateDataOnDemand;
    
    public ItxSubjectContainerValue ItxSubjectContainerValueDataOnDemand.getNewTransientItxSubjectContainerValue(int index) {
    ...
    public void ItxSubjectContainerValueDataOnDemand.setBlobValue(ItxSubjectContainerValue obj, int index) {
        byte[] blobValue = String.valueOf(index).getBytes();
        obj.setBlobValue(blobValue);
    }
    
    public void ItxSubjectContainerValueDataOnDemand.setClobValue(ItxSubjectContainerValue obj, int index) {
        String clobValue = "clobValue_" + index;
        obj.setClobValue(clobValue);
    }
    
    public void ItxSubjectContainerValueDataOnDemand.setCodeKind(ItxSubjectContainerValue obj, int index) {
    ...
    public void ItxSubjectContainerValueDataOnDemand.setCodeOrigin(ItxSubjectContainerValue obj, int index) {
    ...
    public void ItxSubjectContainerValueDataOnDemand.setCodeType(ItxSubjectContainerValue obj, int index) {
    ...
    public void ItxSubjectContainerValueDataOnDemand.setCodeTypeAndKind(ItxSubjectContainerValue obj, int index) {
    ...
    public void ItxSubjectContainerValueDataOnDemand.setCodeValue(ItxSubjectContainerValue obj, int index) {
    ...
    public void ItxSubjectContainerValueDataOnDemand.setComments(ItxSubjectContainerValue obj, int index) {
    ...
    public void ItxSubjectContainerValueDataOnDemand.setIgnored(ItxSubjectContainerValue obj, int index) {
        Boolean ignored = true;
        obj.setIgnored(ignored);
    }
    
    public void ItxSubjectContainerValueDataOnDemand.setLsKind(ItxSubjectContainerValue obj, int index) {
    ...
    public void ItxSubjectContainerValueDataOnDemand.setLsTransaction(ItxSubjectContainerValue obj, int index) {
        Long lsTransaction = new Integer(index).longValue();
        obj.setLsTransaction(lsTransaction);
    }
    
    public void ItxSubjectContainerValueDataOnDemand.setLsType(ItxSubjectContainerValue obj, int index) {
    ...
    public void ItxSubjectContainerValueDataOnDemand.setLsTypeAndKind(ItxSubjectContainerValue obj, int index) {
    ...
    public void ItxSubjectContainerValueDataOnDemand.setModifiedBy(ItxSubjectContainerValue obj, int index) {
    ...
    public void ItxSubjectContainerValueDataOnDemand.setModifiedDate(ItxSubjectContainerValue obj, int index) {
        Date modifiedDate = new GregorianCalendar(Calendar.getInstance().get(Calendar.YEAR), Calendar.getInstance().get(Calendar.MONTH), Calendar.getInstance().get(Calendar.DAY_OF_MONTH), Calendar.getInstance().get(Calendar.HOUR_OF_DAY), Calendar.getInstance().get(Calendar.MINUTE), Calendar.getInstance().get(Calendar.SECOND) + new Double(Math.random() * 1000).intValue()).getTime();
        obj.setModifiedDate(modifiedDate);
    }
    
    public void ItxSubjectContainerValueDataOnDemand.setNumberOfReplicates(ItxSubjectContainerValue obj, int index) {
    ...
    public void ItxSubjectContainerValueDataOnDemand.setOperatorKind(ItxSubjectContainerValue obj, int index) {
    ...
    public void ItxSubjectContainerValueDataOnDemand.setOperatorType(ItxSubjectContainerValue obj, int index) {
    ...
    public void ItxSubjectContainerValueDataOnDemand.setOperatorTypeAndKind(ItxSubjectContainerValue obj, int index) {
    ...
    public void ItxSubjectContainerValueDataOnDemand.setPublicData(ItxSubjectContainerValue obj, int index) {
        Boolean publicData = true;
        obj.setPublicData(publicData);
    }
    
    public void ItxSubjectContainerValueDataOnDemand.setRecordedBy(ItxSubjectContainerValue obj, int index) {
    ...
    public void ItxSubjectContainerValueDataOnDemand.setRecordedDate(ItxSubjectContainerValue obj, int index) {
        Date recordedDate = new GregorianCalendar(Calendar.getInstance().get(Calendar.YEAR), Calendar.getInstance().get(Calendar.MONTH), Calendar.getInstance().get(Calendar.DAY_OF_MONTH), Calendar.getInstance().get(Calendar.HOUR_OF_DAY), Calendar.getInstance().get(Calendar.MINUTE), Calendar.getInstance().get(Calendar.SECOND) + new Double(Math.random() * 1000).intValue()).getTime();
        obj.setRecordedDate(recordedDate);
    }
    
    public void ItxSubjectContainerValueDataOnDemand.setSigFigs(ItxSubjectContainerValue obj, int index) {
        Integer sigFigs = new Integer(index);
        obj.setSigFigs(sigFigs);
    }
    
    public void ItxSubjectContainerValueDataOnDemand.setStringValue(ItxSubjectContainerValue obj, int index) {
    ...
    public void ItxSubjectContainerValueDataOnDemand.setUncertaintyType(ItxSubjectContainerValue obj, int index) {
    ...
    public void ItxSubjectContainerValueDataOnDemand.setUnitKind(ItxSubjectContainerValue obj, int index) {
    ...
    public void ItxSubjectContainerValueDataOnDemand.setUnitType(ItxSubjectContainerValue obj, int index) {
    ...
    public void ItxSubjectContainerValueDataOnDemand.setUnitTypeAndKind(ItxSubjectContainerValue obj, int index) {
    ...
    public void ItxSubjectContainerValueDataOnDemand.setUrlValue(ItxSubjectContainerValue obj, int index) {
    ...
    public ItxSubjectContainerValue ItxSubjectContainerValueDataOnDemand.getSpecificItxSubjectContainerValue(int index) {
        init();
        if (index < 0) {
            index = 0;
        }
    ...
    public ItxSubjectContainerValue ItxSubjectContainerValueDataOnDemand.getRandomItxSubjectContainerValue() {
        init();
    ...
    public boolean ItxSubjectContainerValueDataOnDemand.modifyItxSubjectContainerValue(ItxSubjectContainerValue obj) {
        return false;
    }
    
    public void ItxSubjectContainerValueDataOnDemand.init() {
        int from = 0;
        int to = 10;
