...
public class AnalysisGroupValueIntegrationTest {
    ...
    public void testCountAnalysisGroupValues() {
        Assert.assertNotNull("Data on demand for 'AnalysisGroupValue' failed to initialize correctly",
                dod.getRandomAnalysisGroupValue());
    ...
    public void testFindAllAnalysisGroupValues() {
        Assert.assertNotNull("Data on demand for 'AnalysisGroupValue' failed to initialize correctly",
                dod.getRandomAnalysisGroupValue());
        long count = AnalysisGroupValue.countAnalysisGroupValues();
        Assert.assertTrue("Too expensive to perform a find all test for 'AnalysisGroupValue', as there are " + count
    ...
    public void testFindAnalysisGroupValueEntries() {
        ...
        Assert.assertEquals("Find entries method for 'AnalysisGroupValue' returned an incorrect number of entries",
                count, result.size());
    }
    ...
    public void testFlush() {
        ...
        obj.flush();
        Assert.assertTrue("Version for 'AnalysisGroupValue' failed to increment on flush directive",
    ...
    public void testMergeUpdate() {
        ...
        Assert.assertEquals("Identifier of merged object not the same as identifier of original object", merged.getId(),
                id);
        Assert.assertTrue("Version for 'AnalysisGroupValue' failed to increment on merge and flush directive",
                (currentVersion != null && obj.getVersion() > currentVersion) || !modified);
    }
    ...
    public void testRemove() {
        ...
        obj.remove();
        obj.flush();
        Assert.assertNull("Failed to remove 'AnalysisGroupValue' with identifier '" + id + "'",
                AnalysisGroupValue.findAnalysisGroupValue(id));
    }
}
