...
import com.labsynch.labseer.domain.StateKindIntegrationTest;
...
privileged aspect StateKindIntegrationTest_Roo_IntegrationTest {
    
    declare @type: StateKindIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: StateKindIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: StateKindIntegrationTest: @Transactional;
    
    @Autowired
    StateKindDataOnDemand StateKindIntegrationTest.dod;
    
    @Test
    public void StateKindIntegrationTest.testCountStateKinds() {
    ...
    @Test
    public void StateKindIntegrationTest.testFindStateKind() {
    ...
    @Test
    public void StateKindIntegrationTest.testFindAllStateKinds() {
        Assert.assertNotNull("Data on demand for 'StateKind' failed to initialize correctly", dod.getRandomStateKind());
        long count = StateKind.countStateKinds();
    ...
    @Test
    public void StateKindIntegrationTest.testFindStateKindEntries() {
        Assert.assertNotNull("Data on demand for 'StateKind' failed to initialize correctly", dod.getRandomStateKind());
        long count = StateKind.countStateKinds();
    ...
    @Test
    public void StateKindIntegrationTest.testFlush() {
        StateKind obj = dod.getRandomStateKind();
        Assert.assertNotNull("Data on demand for 'StateKind' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'StateKind' failed to provide an identifier", id);
    ...
    @Test
    public void StateKindIntegrationTest.testMergeUpdate() {
        StateKind obj = dod.getRandomStateKind();
        Assert.assertNotNull("Data on demand for 'StateKind' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'StateKind' failed to provide an identifier", id);
    ...
    @Test
    public void StateKindIntegrationTest.testPersist() {
        Assert.assertNotNull("Data on demand for 'StateKind' failed to initialize correctly", dod.getRandomStateKind());
    ...
    @Test
    public void StateKindIntegrationTest.testRemove() {
        StateKind obj = dod.getRandomStateKind();
        Assert.assertNotNull("Data on demand for 'StateKind' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'StateKind' failed to provide an identifier", id);
