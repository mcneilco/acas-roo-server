...
import com.labsynch.labseer.domain.TreatmentGroupStateIntegrationTest;
...
privileged aspect TreatmentGroupStateIntegrationTest_Roo_IntegrationTest {
    
    declare @type: TreatmentGroupStateIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: TreatmentGroupStateIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: TreatmentGroupStateIntegrationTest: @Transactional;
    
    @Autowired
    TreatmentGroupStateDataOnDemand TreatmentGroupStateIntegrationTest.dod;
    
    @Test
    public void TreatmentGroupStateIntegrationTest.testCountTreatmentGroupStates() {
    ...
    @Test
    public void TreatmentGroupStateIntegrationTest.testFindTreatmentGroupState() {
    ...
    @Test
    public void TreatmentGroupStateIntegrationTest.testFindAllTreatmentGroupStates() {
        Assert.assertNotNull("Data on demand for 'TreatmentGroupState' failed to initialize correctly", dod.getRandomTreatmentGroupState());
        long count = TreatmentGroupState.countTreatmentGroupStates();
    ...
    @Test
    public void TreatmentGroupStateIntegrationTest.testFindTreatmentGroupStateEntries() {
        Assert.assertNotNull("Data on demand for 'TreatmentGroupState' failed to initialize correctly", dod.getRandomTreatmentGroupState());
        long count = TreatmentGroupState.countTreatmentGroupStates();
    ...
    @Test
    public void TreatmentGroupStateIntegrationTest.testFlush() {
        TreatmentGroupState obj = dod.getRandomTreatmentGroupState();
        Assert.assertNotNull("Data on demand for 'TreatmentGroupState' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'TreatmentGroupState' failed to provide an identifier", id);
    ...
    @Test
    public void TreatmentGroupStateIntegrationTest.testMergeUpdate() {
        TreatmentGroupState obj = dod.getRandomTreatmentGroupState();
        Assert.assertNotNull("Data on demand for 'TreatmentGroupState' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'TreatmentGroupState' failed to provide an identifier", id);
    ...
    @Test
    public void TreatmentGroupStateIntegrationTest.testPersist() {
        Assert.assertNotNull("Data on demand for 'TreatmentGroupState' failed to initialize correctly", dod.getRandomTreatmentGroupState());
    ...
    @Test
    public void TreatmentGroupStateIntegrationTest.testRemove() {
        TreatmentGroupState obj = dod.getRandomTreatmentGroupState();
        Assert.assertNotNull("Data on demand for 'TreatmentGroupState' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'TreatmentGroupState' failed to provide an identifier", id);
