...
public class ContainerStateIntegrationTest {
    ...
    public void testCountContainerStates() {
        Assert.assertNotNull("Data on demand for 'ContainerState' failed to initialize correctly",
                dod.getRandomContainerState());
    ...
    public void testFindAllContainerStates() {
        Assert.assertNotNull("Data on demand for 'ContainerState' failed to initialize correctly",
                dod.getRandomContainerState());
        long count = ContainerState.countContainerStates();
        Assert.assertTrue("Too expensive to perform a find all test for 'ContainerState', as there are " + count
    ...
    public void testFindContainerStateEntries() {
        ...
        Assert.assertEquals("Find entries method for 'ContainerState' returned an incorrect number of entries", count,
                result.size());
    }
    ...
    public void testFlush() {
        ...
        obj.flush();
        Assert.assertTrue("Version for 'ContainerState' failed to increment on flush directive",
    ...
    public void testMergeUpdate() {
        ...
        Assert.assertEquals("Identifier of merged object not the same as identifier of original object", merged.getId(),
                id);
        Assert.assertTrue("Version for 'ContainerState' failed to increment on merge and flush directive",
                (currentVersion != null && obj.getVersion() > currentVersion) || !modified);
    }
    ...
    public void testRemove() {
        ...
        obj.remove();
        obj.flush();
        Assert.assertNull("Failed to remove 'ContainerState' with identifier '" + id + "'",
                ContainerState.findContainerState(id));
    }
}
