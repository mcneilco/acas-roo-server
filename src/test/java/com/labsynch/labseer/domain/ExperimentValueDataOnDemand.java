...
@Component
@Configurable
@RooDataOnDemand(entity = ExperimentValue.class)
public class ExperimentValueDataOnDemand {

	private Random rnd = new SecureRandom();

	private List<ExperimentValue> data;

	@Autowired
    ExperimentStateDataOnDemand experimentStateDataOnDemand;

	public ExperimentValue getNewTransientExperimentValue(int index) {
        ExperimentValue obj = new ExperimentValue();
	...
	public void setBlobValue(ExperimentValue obj, int index) {
        byte[] blobValue = String.valueOf(index).getBytes();
        obj.setBlobValue(blobValue);
    }

	public void setClobValue(ExperimentValue obj, int index) {
        String clobValue = "clobValue_" + index;
        obj.setClobValue(clobValue);
    }

	public void setCodeKind(ExperimentValue obj, int index) {
	...
	public void setCodeOrigin(ExperimentValue obj, int index) {
	...
	public void setCodeType(ExperimentValue obj, int index) {
	...
	public void setCodeTypeAndKind(ExperimentValue obj, int index) {
	...
	public void setCodeValue(ExperimentValue obj, int index) {
	...
	public void setComments(ExperimentValue obj, int index) {
	...
	public void setConcUnit(ExperimentValue obj, int index) {
	...
	public void setConcentration(ExperimentValue obj, int index) {
        Double concentration = new Integer(index).doubleValue();
        obj.setConcentration(concentration);
    }

	public void setDateValue(ExperimentValue obj, int index) {
	...
	public void setDeleted(ExperimentValue obj, int index) {
        Boolean deleted = true;
        obj.setDeleted(deleted);
    }

	public void setFileValue(ExperimentValue obj, int index) {
	...
	public void setIgnored(ExperimentValue obj, int index) {
        Boolean ignored = true;
        obj.setIgnored(ignored);
    }

	public void setLsKind(ExperimentValue obj, int index) {
	...
	public void setLsState(ExperimentValue obj, int index) {
        ExperimentState lsState = experimentStateDataOnDemand.getRandomExperimentState();
        obj.setLsState(lsState);
    }

	public void setLsTransaction(ExperimentValue obj, int index) {
        Long lsTransaction = new Integer(index).longValue();
        obj.setLsTransaction(lsTransaction);
    }

	public void setLsType(ExperimentValue obj, int index) {
	...
	public void setLsTypeAndKind(ExperimentValue obj, int index) {
	...
	public void setModifiedBy(ExperimentValue obj, int index) {
	...
	public void setModifiedDate(ExperimentValue obj, int index) {
        Date modifiedDate = new GregorianCalendar(Calendar.getInstance().get(Calendar.YEAR), Calendar.getInstance().get(Calendar.MONTH), Calendar.getInstance().get(Calendar.DAY_OF_MONTH), Calendar.getInstance().get(Calendar.HOUR_OF_DAY), Calendar.getInstance().get(Calendar.MINUTE), Calendar.getInstance().get(Calendar.SECOND) + new Double(Math.random() * 1000).intValue()).getTime();
        obj.setModifiedDate(modifiedDate);
    }

	public void setNumberOfReplicates(ExperimentValue obj, int index) {
        Integer numberOfReplicates = new Integer(index);
        obj.setNumberOfReplicates(numberOfReplicates);
    }

	public void setNumericValue(ExperimentValue obj, int index) {
	...
	public void setOperatorKind(ExperimentValue obj, int index) {
	...
	public void setOperatorType(ExperimentValue obj, int index) {
	...
	public void setOperatorTypeAndKind(ExperimentValue obj, int index) {
	...
	public void setPublicData(ExperimentValue obj, int index) {
        Boolean publicData = true;
        obj.setPublicData(publicData);
    }

	public void setRecordedBy(ExperimentValue obj, int index) {
	...
	public void setRecordedDate(ExperimentValue obj, int index) {
        Date recordedDate = new GregorianCalendar(Calendar.getInstance().get(Calendar.YEAR), Calendar.getInstance().get(Calendar.MONTH), Calendar.getInstance().get(Calendar.DAY_OF_MONTH), Calendar.getInstance().get(Calendar.HOUR_OF_DAY), Calendar.getInstance().get(Calendar.MINUTE), Calendar.getInstance().get(Calendar.SECOND) + new Double(Math.random() * 1000).intValue()).getTime();
        obj.setRecordedDate(recordedDate);
    }

	public void setSigFigs(ExperimentValue obj, int index) {
        Integer sigFigs = new Integer(index);
        obj.setSigFigs(sigFigs);
    }

	public void setStringValue(ExperimentValue obj, int index) {
	...
	public void setUncertainty(ExperimentValue obj, int index) {
	...
	public void setUncertaintyType(ExperimentValue obj, int index) {
	...
	public void setUnitKind(ExperimentValue obj, int index) {
	...
	public void setUnitType(ExperimentValue obj, int index) {
	...
	public void setUnitTypeAndKind(ExperimentValue obj, int index) {
	...
	public void setUrlValue(ExperimentValue obj, int index) {
	...
	public ExperimentValue getSpecificExperimentValue(int index) {
        init();
        if (index < 0) {
            index = 0;
        }
        ...
        ExperimentValue obj = data.get(index);
        Long id = obj.getId();
        return ExperimentValue.findExperimentValue(id);
    }

	public ExperimentValue getRandomExperimentValue() {
        init();
        ExperimentValue obj = data.get(rnd.nextInt(data.size()));
        Long id = obj.getId();
        return ExperimentValue.findExperimentValue(id);
    }

	public boolean modifyExperimentValue(ExperimentValue obj) {
        return false;
    }
	...
	public void init() {
        int from = 0;
        int to = 10;
        data = ExperimentValue.findExperimentValueEntries(from, to);
        if (data == null) {
            throw new IllegalStateException("Find entries implementation for 'ExperimentValue' illegally returned null");
        }
        if (!data.isEmpty()) {
            return;
        }
        
        data = new ArrayList<ExperimentValue>();
        for (int i = 0; i < 10; i++) {
            ExperimentValue obj = getNewTransientExperimentValue(i);
            try {
                obj.persist();
