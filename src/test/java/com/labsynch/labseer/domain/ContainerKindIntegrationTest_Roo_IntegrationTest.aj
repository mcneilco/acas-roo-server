...
privileged aspect ContainerKindIntegrationTest_Roo_IntegrationTest {
    
    declare @type: ContainerKindIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: ContainerKindIntegrationTest: @ContextConfiguration(locations = "classpath:/META-INF/spring/applicationContext*.xml");
    
    declare @type: ContainerKindIntegrationTest: @Transactional;
    
    @Autowired
    ContainerKindDataOnDemand ContainerKindIntegrationTest.dod;
    
    @Test
    public void ContainerKindIntegrationTest.testCountContainerKinds() {
    ...
    @Test
    public void ContainerKindIntegrationTest.testFindContainerKind() {
    ...
    @Test
    public void ContainerKindIntegrationTest.testFindAllContainerKinds() {
        Assert.assertNotNull("Data on demand for 'ContainerKind' failed to initialize correctly", dod.getRandomContainerKind());
        long count = ContainerKind.countContainerKinds();
    ...
    @Test
    public void ContainerKindIntegrationTest.testFindContainerKindEntries() {
        Assert.assertNotNull("Data on demand for 'ContainerKind' failed to initialize correctly", dod.getRandomContainerKind());
        long count = ContainerKind.countContainerKinds();
    ...
    @Test
    public void ContainerKindIntegrationTest.testFlush() {
        ContainerKind obj = dod.getRandomContainerKind();
        Assert.assertNotNull("Data on demand for 'ContainerKind' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'ContainerKind' failed to provide an identifier", id);
    ...
    @Test
    public void ContainerKindIntegrationTest.testMergeUpdate() {
        ContainerKind obj = dod.getRandomContainerKind();
        Assert.assertNotNull("Data on demand for 'ContainerKind' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'ContainerKind' failed to provide an identifier", id);
    ...
    @Test
    public void ContainerKindIntegrationTest.testPersist() {
        Assert.assertNotNull("Data on demand for 'ContainerKind' failed to initialize correctly", dod.getRandomContainerKind());
    ...
    @Test
    public void ContainerKindIntegrationTest.testRemove() {
        ContainerKind obj = dod.getRandomContainerKind();
        Assert.assertNotNull("Data on demand for 'ContainerKind' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'ContainerKind' failed to provide an identifier", id);
