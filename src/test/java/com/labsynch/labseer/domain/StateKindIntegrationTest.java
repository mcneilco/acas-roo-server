...
public class StateKindIntegrationTest {
    ...
    public void testFindAllStateKinds() {
        Assert.assertNotNull("Data on demand for 'StateKind' failed to initialize correctly", dod.getRandomStateKind());
        long count = StateKind.countStateKinds();
        Assert.assertTrue("Too expensive to perform a find all test for 'StateKind', as there are " + count
    ...
    public void testFindStateKindEntries() {
        ...
        Assert.assertEquals("Find entries method for 'StateKind' returned an incorrect number of entries", count,
                result.size());
    }
    ...
    public void testFlush() {
        ...
        obj.flush();
        Assert.assertTrue("Version for 'StateKind' failed to increment on flush directive",
    ...
    public void testMergeUpdate() {
        ...
        Assert.assertEquals("Identifier of merged object not the same as identifier of original object", merged.getId(),
                id);
        Assert.assertTrue("Version for 'StateKind' failed to increment on merge and flush directive",
                (currentVersion != null && obj.getVersion() > currentVersion) || !modified);
    }
