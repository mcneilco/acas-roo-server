...
@Component
@Configurable
@RooDataOnDemand(entity = ContainerValue.class)
public class ContainerValueDataOnDemand {

	private Random rnd = new SecureRandom();

	private List<ContainerValue> data;

	@Autowired
    ContainerStateDataOnDemand containerStateDataOnDemand;

	public ContainerValue getNewTransientContainerValue(int index) {
	...
	public void setBlobValue(ContainerValue obj, int index) {
        byte[] blobValue = String.valueOf(index).getBytes();
        obj.setBlobValue(blobValue);
    }

	public void setClobValue(ContainerValue obj, int index) {
        String clobValue = "clobValue_" + index;
        obj.setClobValue(clobValue);
    }

	public void setCodeKind(ContainerValue obj, int index) {
	...
	public void setCodeOrigin(ContainerValue obj, int index) {
	...
	public void setCodeType(ContainerValue obj, int index) {
	...
	public void setCodeTypeAndKind(ContainerValue obj, int index) {
	...
	public void setCodeValue(ContainerValue obj, int index) {
	...
	public void setComments(ContainerValue obj, int index) {
	...
	public void setConcUnit(ContainerValue obj, int index) {
	...
	public void setConcentration(ContainerValue obj, int index) {
        Double concentration = new Integer(index).doubleValue();
        obj.setConcentration(concentration);
    }

	public void setDateValue(ContainerValue obj, int index) {
	...
	public void setDeleted(ContainerValue obj, int index) {
        Boolean deleted = true;
        obj.setDeleted(deleted);
    }

	public void setFileValue(ContainerValue obj, int index) {
	...
	public void setIgnored(ContainerValue obj, int index) {
        Boolean ignored = true;
        obj.setIgnored(ignored);
    }

	public void setLsKind(ContainerValue obj, int index) {
	...
	public void setLsTypeAndKind(ContainerValue obj, int index) {
	...
	public void setModifiedBy(ContainerValue obj, int index) {
	...
	public void setModifiedDate(ContainerValue obj, int index) {
        Date modifiedDate = new GregorianCalendar(Calendar.getInstance().get(Calendar.YEAR), Calendar.getInstance().get(Calendar.MONTH), Calendar.getInstance().get(Calendar.DAY_OF_MONTH), Calendar.getInstance().get(Calendar.HOUR_OF_DAY), Calendar.getInstance().get(Calendar.MINUTE), Calendar.getInstance().get(Calendar.SECOND) + new Double(Math.random() * 1000).intValue()).getTime();
        obj.setModifiedDate(modifiedDate);
    }

	public void setNumberOfReplicates(ContainerValue obj, int index) {
        Integer numberOfReplicates = new Integer(index);
        obj.setNumberOfReplicates(numberOfReplicates);
    }

	public void setNumericValue(ContainerValue obj, int index) {
	...
	public void setOperatorKind(ContainerValue obj, int index) {
	...
	public void setOperatorType(ContainerValue obj, int index) {
	...
	public void setOperatorTypeAndKind(ContainerValue obj, int index) {
	...
	public void setPublicData(ContainerValue obj, int index) {
        Boolean publicData = true;
        obj.setPublicData(publicData);
    }

	public void setRecordedBy(ContainerValue obj, int index) {
	...
	public void setRecordedDate(ContainerValue obj, int index) {
        Date recordedDate = new GregorianCalendar(Calendar.getInstance().get(Calendar.YEAR), Calendar.getInstance().get(Calendar.MONTH), Calendar.getInstance().get(Calendar.DAY_OF_MONTH), Calendar.getInstance().get(Calendar.HOUR_OF_DAY), Calendar.getInstance().get(Calendar.MINUTE), Calendar.getInstance().get(Calendar.SECOND) + new Double(Math.random() * 1000).intValue()).getTime();
        obj.setRecordedDate(recordedDate);
    }

	public void setSigFigs(ContainerValue obj, int index) {
        Integer sigFigs = new Integer(index);
        obj.setSigFigs(sigFigs);
    }

	public void setStringValue(ContainerValue obj, int index) {
	...
	public void setUncertainty(ContainerValue obj, int index) {
	...
	public void setUncertaintyType(ContainerValue obj, int index) {
	...
	public void setUnitKind(ContainerValue obj, int index) {
	...
	public void setUnitType(ContainerValue obj, int index) {
	...
	public void setUnitTypeAndKind(ContainerValue obj, int index) {
	...
	public void setUrlValue(ContainerValue obj, int index) {
	...
	public ContainerValue getSpecificContainerValue(int index) {
        init();
        if (index < 0) {
            index = 0;
        }
	...
	public ContainerValue getRandomContainerValue() {
        init();
	...
	public boolean modifyContainerValue(ContainerValue obj) {
        return false;
    }
