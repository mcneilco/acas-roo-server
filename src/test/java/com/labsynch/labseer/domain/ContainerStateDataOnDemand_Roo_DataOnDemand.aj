...
privileged aspect ContainerStateDataOnDemand_Roo_DataOnDemand {
    
    declare @type: ContainerStateDataOnDemand: @Component;
    
    private Random ContainerStateDataOnDemand.rnd = new SecureRandom();
    
    private List<ContainerState> ContainerStateDataOnDemand.data;
    
    @Autowired
    ContainerDataOnDemand ContainerStateDataOnDemand.containerDataOnDemand;
    
    public ContainerState ContainerStateDataOnDemand.getNewTransientContainerState(int index) {
    ...
    public void ContainerStateDataOnDemand.setComments(ContainerState obj, int index) {
    ...
    public void ContainerStateDataOnDemand.setLsKind(ContainerState obj, int index) {
    ...
    public void ContainerStateDataOnDemand.setLsTransaction(ContainerState obj, int index) {
        Long lsTransaction = new Integer(index).longValue();
        obj.setLsTransaction(lsTransaction);
    }
    
    public void ContainerStateDataOnDemand.setLsType(ContainerState obj, int index) {
    ...
    public void ContainerStateDataOnDemand.setLsTypeAndKind(ContainerState obj, int index) {
    ...
    public void ContainerStateDataOnDemand.setModifiedBy(ContainerState obj, int index) {
    ...
    public void ContainerStateDataOnDemand.setModifiedDate(ContainerState obj, int index) {
        Date modifiedDate = new GregorianCalendar(Calendar.getInstance().get(Calendar.YEAR), Calendar.getInstance().get(Calendar.MONTH), Calendar.getInstance().get(Calendar.DAY_OF_MONTH), Calendar.getInstance().get(Calendar.HOUR_OF_DAY), Calendar.getInstance().get(Calendar.MINUTE), Calendar.getInstance().get(Calendar.SECOND) + new Double(Math.random() * 1000).intValue()).getTime();
        obj.setModifiedDate(modifiedDate);
    }
    
    public void ContainerStateDataOnDemand.setRecordedBy(ContainerState obj, int index) {
    ...
    public void ContainerStateDataOnDemand.setRecordedDate(ContainerState obj, int index) {
        Date recordedDate = new GregorianCalendar(Calendar.getInstance().get(Calendar.YEAR), Calendar.getInstance().get(Calendar.MONTH), Calendar.getInstance().get(Calendar.DAY_OF_MONTH), Calendar.getInstance().get(Calendar.HOUR_OF_DAY), Calendar.getInstance().get(Calendar.MINUTE), Calendar.getInstance().get(Calendar.SECOND) + new Double(Math.random() * 1000).intValue()).getTime();
        obj.setRecordedDate(recordedDate);
    }
    
    public ContainerState ContainerStateDataOnDemand.getSpecificContainerState(int index) {
        init();
        if (index < 0) {
            index = 0;
        }
    ...
    public ContainerState ContainerStateDataOnDemand.getRandomContainerState() {
        init();
    ...
    public boolean ContainerStateDataOnDemand.modifyContainerState(ContainerState obj) {
        return false;
    }
    
    public void ContainerStateDataOnDemand.init() {
        int from = 0;
        int to = 10;
