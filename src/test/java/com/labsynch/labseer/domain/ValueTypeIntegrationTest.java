...
public class ValueTypeIntegrationTest {
    ...
    public void testFindAllValueTypes() {
        Assert.assertNotNull("Data on demand for 'ValueType' failed to initialize correctly", dod.getRandomValueType());
        long count = ValueType.countValueTypes();
        Assert.assertTrue("Too expensive to perform a find all test for 'ValueType', as there are " + count
    ...
    public void testFindValueTypeEntries() {
        ...
        Assert.assertEquals("Find entries method for 'ValueType' returned an incorrect number of entries", count,
                result.size());
    }
    ...
    public void testFlush() {
        ...
        obj.flush();
        Assert.assertTrue("Version for 'ValueType' failed to increment on flush directive",
    ...
    public void testMergeUpdate() {
        ...
        Assert.assertEquals("Identifier of merged object not the same as identifier of original object", merged.getId(),
                id);
        Assert.assertTrue("Version for 'ValueType' failed to increment on merge and flush directive",
                (currentVersion != null && obj.getVersion() > currentVersion) || !modified);
    }
