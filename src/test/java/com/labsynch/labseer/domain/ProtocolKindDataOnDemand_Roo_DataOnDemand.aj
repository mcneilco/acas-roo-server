...
privileged aspect ProtocolKindDataOnDemand_Roo_DataOnDemand {
    
    declare @type: ProtocolKindDataOnDemand: @Component;
    
    private Random ProtocolKindDataOnDemand.rnd = new SecureRandom();
    
    private List<ProtocolKind> ProtocolKindDataOnDemand.data;
    
    @Autowired
    ProtocolTypeDataOnDemand ProtocolKindDataOnDemand.protocolTypeDataOnDemand;
    
    public ProtocolKind ProtocolKindDataOnDemand.getNewTransientProtocolKind(int index) {
    ...
    public void ProtocolKindDataOnDemand.setKindName(ProtocolKind obj, int index) {
    ...
    public void ProtocolKindDataOnDemand.setLsType(ProtocolKind obj, int index) {
        ProtocolType lsType = protocolTypeDataOnDemand.getRandomProtocolType();
        obj.setLsType(lsType);
    }
    
    public void ProtocolKindDataOnDemand.setLsTypeAndKind(ProtocolKind obj, int index) {
    ...
    public ProtocolKind ProtocolKindDataOnDemand.getSpecificProtocolKind(int index) {
        init();
        if (index < 0) {
            index = 0;
        }
    ...
    public ProtocolKind ProtocolKindDataOnDemand.getRandomProtocolKind() {
        init();
    ...
    public boolean ProtocolKindDataOnDemand.modifyProtocolKind(ProtocolKind obj) {
        return false;
    }
    
    public void ProtocolKindDataOnDemand.init() {
        int from = 0;
        int to = 10;
