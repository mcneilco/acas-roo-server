...
public class ItxContainerContainerIntegrationTest {
    ...
    public void testCountItxContainerContainers() {
        Assert.assertNotNull("Data on demand for 'ItxContainerContainer' failed to initialize correctly",
                dod.getRandomItxContainerContainer());
    ...
    public void testFindItxContainerContainer() {
        ...
        Assert.assertNotNull("Find method for 'ItxContainerContainer' illegally returned null for id '" + id + "'",
                obj);
        Assert.assertEquals("Find method for 'ItxContainerContainer' returned the incorrect identifier", id,
                obj.getId());
    }
    ...
    public void testFindAllItxContainerContainers() {
        Assert.assertNotNull("Data on demand for 'ItxContainerContainer' failed to initialize correctly",
                dod.getRandomItxContainerContainer());
        long count = ItxContainerContainer.countItxContainerContainers();
        Assert.assertTrue("Too expensive to perform a find all test for 'ItxContainerContainer', as there are " + count
    ...
    public void testFindItxContainerContainerEntries() {
        ...
        List<ItxContainerContainer> result = ItxContainerContainer.findItxContainerContainerEntries(firstResult,
                maxResults);
        Assert.assertNotNull("Find entries method for 'ItxContainerContainer' illegally returned null", result);
        Assert.assertEquals("Find entries method for 'ItxContainerContainer' returned an incorrect number of entries",
                count, result.size());
    }
    ...
    public void testFlush() {
        ...
        obj.flush();
        Assert.assertTrue("Version for 'ItxContainerContainer' failed to increment on flush directive",
    ...
    public void testMergeUpdate() {
        ...
        Assert.assertEquals("Identifier of merged object not the same as identifier of original object", merged.getId(),
                id);
        Assert.assertTrue("Version for 'ItxContainerContainer' failed to increment on merge and flush directive",
                (currentVersion != null && obj.getVersion() > currentVersion) || !modified);
    }
    ...
    public void testPersist() {
        ...
        Assert.assertNotNull("Data on demand for 'ItxContainerContainer' failed to provide a new transient entity",
                obj);
    ...
    public void testRemove() {
        ...
        obj.remove();
        obj.flush();
        Assert.assertNull("Failed to remove 'ItxContainerContainer' with identifier '" + id + "'",
                ItxContainerContainer.findItxContainerContainer(id));
    }
}
