...
privileged aspect ProtocolValueDataOnDemand_Roo_DataOnDemand {
    
    declare @type: ProtocolValueDataOnDemand: @Component;
    
    private Random ProtocolValueDataOnDemand.rnd = new SecureRandom();
    
    private List<ProtocolValue> ProtocolValueDataOnDemand.data;
    
    @Autowired
    ProtocolStateDataOnDemand ProtocolValueDataOnDemand.protocolStateDataOnDemand;
    
    public ProtocolValue ProtocolValueDataOnDemand.getNewTransientProtocolValue(int index) {
    ...
    public void ProtocolValueDataOnDemand.setBlobValue(ProtocolValue obj, int index) {
        byte[] blobValue = String.valueOf(index).getBytes();
        obj.setBlobValue(blobValue);
    }
    
    public void ProtocolValueDataOnDemand.setClobValue(ProtocolValue obj, int index) {
        String clobValue = "clobValue_" + index;
        obj.setClobValue(clobValue);
    }
    
    public void ProtocolValueDataOnDemand.setCodeKind(ProtocolValue obj, int index) {
    ...
    public void ProtocolValueDataOnDemand.setCodeOrigin(ProtocolValue obj, int index) {
    ...
    public void ProtocolValueDataOnDemand.setCodeType(ProtocolValue obj, int index) {
    ...
    public void ProtocolValueDataOnDemand.setCodeTypeAndKind(ProtocolValue obj, int index) {
    ...
    public void ProtocolValueDataOnDemand.setCodeValue(ProtocolValue obj, int index) {
    ...
    public void ProtocolValueDataOnDemand.setComments(ProtocolValue obj, int index) {
    ...
    public void ProtocolValueDataOnDemand.setConcUnit(ProtocolValue obj, int index) {
    ...
    public void ProtocolValueDataOnDemand.setConcentration(ProtocolValue obj, int index) {
        Double concentration = new Integer(index).doubleValue();
        obj.setConcentration(concentration);
    }
    
    public void ProtocolValueDataOnDemand.setDateValue(ProtocolValue obj, int index) {
    ...
    public void ProtocolValueDataOnDemand.setDeleted(ProtocolValue obj, int index) {
        Boolean deleted = true;
        obj.setDeleted(deleted);
    }
    
    public void ProtocolValueDataOnDemand.setFileValue(ProtocolValue obj, int index) {
    ...
    public void ProtocolValueDataOnDemand.setIgnored(ProtocolValue obj, int index) {
        Boolean ignored = true;
        obj.setIgnored(ignored);
    }
    
    public void ProtocolValueDataOnDemand.setLsKind(ProtocolValue obj, int index) {
    ...
    public void ProtocolValueDataOnDemand.setLsState(ProtocolValue obj, int index) {
        ProtocolState lsState = protocolStateDataOnDemand.getRandomProtocolState();
        obj.setLsState(lsState);
    }
    
    public void ProtocolValueDataOnDemand.setLsTransaction(ProtocolValue obj, int index) {
        Long lsTransaction = new Integer(index).longValue();
        obj.setLsTransaction(lsTransaction);
    }
    
    public void ProtocolValueDataOnDemand.setLsType(ProtocolValue obj, int index) {
    ...
    public void ProtocolValueDataOnDemand.setLsTypeAndKind(ProtocolValue obj, int index) {
    ...
    public void ProtocolValueDataOnDemand.setModifiedBy(ProtocolValue obj, int index) {
    ...
    public void ProtocolValueDataOnDemand.setModifiedDate(ProtocolValue obj, int index) {
        Date modifiedDate = new GregorianCalendar(Calendar.getInstance().get(Calendar.YEAR), Calendar.getInstance().get(Calendar.MONTH), Calendar.getInstance().get(Calendar.DAY_OF_MONTH), Calendar.getInstance().get(Calendar.HOUR_OF_DAY), Calendar.getInstance().get(Calendar.MINUTE), Calendar.getInstance().get(Calendar.SECOND) + new Double(Math.random() * 1000).intValue()).getTime();
        obj.setModifiedDate(modifiedDate);
    }
    
    public void ProtocolValueDataOnDemand.setNumberOfReplicates(ProtocolValue obj, int index) {
    ...
    public void ProtocolValueDataOnDemand.setOperatorKind(ProtocolValue obj, int index) {
    ...
    public void ProtocolValueDataOnDemand.setOperatorType(ProtocolValue obj, int index) {
    ...
    public void ProtocolValueDataOnDemand.setOperatorTypeAndKind(ProtocolValue obj, int index) {
    ...
    public void ProtocolValueDataOnDemand.setPublicData(ProtocolValue obj, int index) {
        Boolean publicData = true;
        obj.setPublicData(publicData);
    }
    
    public void ProtocolValueDataOnDemand.setRecordedBy(ProtocolValue obj, int index) {
    ...
    public void ProtocolValueDataOnDemand.setRecordedDate(ProtocolValue obj, int index) {
        Date recordedDate = new GregorianCalendar(Calendar.getInstance().get(Calendar.YEAR), Calendar.getInstance().get(Calendar.MONTH), Calendar.getInstance().get(Calendar.DAY_OF_MONTH), Calendar.getInstance().get(Calendar.HOUR_OF_DAY), Calendar.getInstance().get(Calendar.MINUTE), Calendar.getInstance().get(Calendar.SECOND) + new Double(Math.random() * 1000).intValue()).getTime();
        obj.setRecordedDate(recordedDate);
    }
    
    public void ProtocolValueDataOnDemand.setSigFigs(ProtocolValue obj, int index) {
        Integer sigFigs = new Integer(index);
        obj.setSigFigs(sigFigs);
    }
    
    public void ProtocolValueDataOnDemand.setStringValue(ProtocolValue obj, int index) {
    ...
    public void ProtocolValueDataOnDemand.setUncertaintyType(ProtocolValue obj, int index) {
    ...
    public void ProtocolValueDataOnDemand.setUnitKind(ProtocolValue obj, int index) {
    ...
    public void ProtocolValueDataOnDemand.setUnitType(ProtocolValue obj, int index) {
    ...
    public void ProtocolValueDataOnDemand.setUnitTypeAndKind(ProtocolValue obj, int index) {
    ...
    public void ProtocolValueDataOnDemand.setUrlValue(ProtocolValue obj, int index) {
    ...
    public ProtocolValue ProtocolValueDataOnDemand.getSpecificProtocolValue(int index) {
        init();
        if (index < 0) {
            index = 0;
        }
    ...
    public ProtocolValue ProtocolValueDataOnDemand.getRandomProtocolValue() {
        init();
    ...
    public boolean ProtocolValueDataOnDemand.modifyProtocolValue(ProtocolValue obj) {
        return false;
    }
    
    public void ProtocolValueDataOnDemand.init() {
        int from = 0;
        int to = 10;
