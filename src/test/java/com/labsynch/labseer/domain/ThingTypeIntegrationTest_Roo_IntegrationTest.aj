...
import com.labsynch.labseer.domain.ThingTypeIntegrationTest;
...
privileged aspect ThingTypeIntegrationTest_Roo_IntegrationTest {
    
    declare @type: ThingTypeIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: ThingTypeIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: ThingTypeIntegrationTest: @Transactional;
    
    @Autowired
    ThingTypeDataOnDemand ThingTypeIntegrationTest.dod;
    
    @Test
    public void ThingTypeIntegrationTest.testCountThingTypes() {
    ...
    @Test
    public void ThingTypeIntegrationTest.testFindThingType() {
    ...
    @Test
    public void ThingTypeIntegrationTest.testFindAllThingTypes() {
        Assert.assertNotNull("Data on demand for 'ThingType' failed to initialize correctly", dod.getRandomThingType());
        long count = ThingType.countThingTypes();
    ...
    @Test
    public void ThingTypeIntegrationTest.testFindThingTypeEntries() {
        Assert.assertNotNull("Data on demand for 'ThingType' failed to initialize correctly", dod.getRandomThingType());
        long count = ThingType.countThingTypes();
    ...
    @Test
    public void ThingTypeIntegrationTest.testFlush() {
        ThingType obj = dod.getRandomThingType();
        Assert.assertNotNull("Data on demand for 'ThingType' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'ThingType' failed to provide an identifier", id);
    ...
    @Test
    public void ThingTypeIntegrationTest.testMergeUpdate() {
        ThingType obj = dod.getRandomThingType();
        Assert.assertNotNull("Data on demand for 'ThingType' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'ThingType' failed to provide an identifier", id);
    ...
    @Test
    public void ThingTypeIntegrationTest.testPersist() {
        Assert.assertNotNull("Data on demand for 'ThingType' failed to initialize correctly", dod.getRandomThingType());
    ...
    @Test
    public void ThingTypeIntegrationTest.testRemove() {
        ThingType obj = dod.getRandomThingType();
        Assert.assertNotNull("Data on demand for 'ThingType' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'ThingType' failed to provide an identifier", id);
