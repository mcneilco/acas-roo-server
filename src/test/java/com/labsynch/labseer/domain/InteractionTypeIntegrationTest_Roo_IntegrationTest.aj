...
import com.labsynch.labseer.domain.InteractionTypeIntegrationTest;
...
privileged aspect InteractionTypeIntegrationTest_Roo_IntegrationTest {
    
    declare @type: InteractionTypeIntegrationTest: @RunWith(SpringJUnit4ClassRunner.class);
    
    declare @type: InteractionTypeIntegrationTest: @ContextConfiguration(locations = "classpath*:/META-INF/spring/applicationContext*.xml");
    
    declare @type: InteractionTypeIntegrationTest: @Transactional;
    
    @Autowired
    InteractionTypeDataOnDemand InteractionTypeIntegrationTest.dod;
    
    @Test
    public void InteractionTypeIntegrationTest.testCountInteractionTypes() {
    ...
    @Test
    public void InteractionTypeIntegrationTest.testFindInteractionType() {
    ...
    @Test
    public void InteractionTypeIntegrationTest.testFindAllInteractionTypes() {
        Assert.assertNotNull("Data on demand for 'InteractionType' failed to initialize correctly", dod.getRandomInteractionType());
        long count = InteractionType.countInteractionTypes();
    ...
    @Test
    public void InteractionTypeIntegrationTest.testFindInteractionTypeEntries() {
        Assert.assertNotNull("Data on demand for 'InteractionType' failed to initialize correctly", dod.getRandomInteractionType());
        long count = InteractionType.countInteractionTypes();
    ...
    @Test
    public void InteractionTypeIntegrationTest.testFlush() {
        InteractionType obj = dod.getRandomInteractionType();
        Assert.assertNotNull("Data on demand for 'InteractionType' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'InteractionType' failed to provide an identifier", id);
    ...
    @Test
    public void InteractionTypeIntegrationTest.testMergeUpdate() {
        InteractionType obj = dod.getRandomInteractionType();
        Assert.assertNotNull("Data on demand for 'InteractionType' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'InteractionType' failed to provide an identifier", id);
    ...
    @Test
    public void InteractionTypeIntegrationTest.testPersist() {
        Assert.assertNotNull("Data on demand for 'InteractionType' failed to initialize correctly", dod.getRandomInteractionType());
    ...
    @Test
    public void InteractionTypeIntegrationTest.testRemove() {
        InteractionType obj = dod.getRandomInteractionType();
        Assert.assertNotNull("Data on demand for 'InteractionType' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'InteractionType' failed to provide an identifier", id);
