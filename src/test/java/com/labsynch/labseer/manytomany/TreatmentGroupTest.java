...
public class TreatmentGroupTest {
	...
	public void findTreatmentGroupsByAnalysisGroupsTest() {
		...
		List<TreatmentGroup> checkList = TreatmentGroup.findTreatmentGroupsByAnalysisGroups(analysisGroups)
				.getResultList();
		...
		// TreatmentGroup check =
		// TreatmentGroup.findTreatmentGroupsByAnalysisGroups(analysisgroups).getSingleResult();
	...
	public void findTreatmentGroupsByLsTransactionEqualsTest() {
		...
		List<TreatmentGroup> check = TreatmentGroup.findTreatmentGroupsByLsTransactionEquals(lstransaction)
				.getResultList();
	...
	public void deleteByExperimentIdTest() {
		...
		Long experimentid = treatmentgroup.getAnalysisGroups().iterator().next().getExperiments().iterator().next()
				.getId();
	...
	public void SimpleTest4() {
		...
		TreatmentGroup treatmentGroup = treatmentGroupService
				.saveLsTreatmentGroup(inputTreatmentGroup.getAnalysisGroups(), inputTreatmentGroup, recordedDate);
		logger.debug(treatmentGroup.toJson());
	}
