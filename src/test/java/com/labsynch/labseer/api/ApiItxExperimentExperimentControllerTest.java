...
public class ApiItxExperimentExperimentControllerTest {
	...
	public void findByFirstExperiment() throws Exception {
		...
		MockHttpServletResponse response = this.mockMvc
				.perform(get("/api/v1/itxexperimentexperiments/findByFirstExperiment/" + id)
						.contentType(MediaType.APPLICATION_JSON)
						.accept(MediaType.APPLICATION_JSON))
		...
		String responseJson = response.getContentAsString();
		logger.info(responseJson);
		Collection<ItxExperimentExperiment> foundItxs = ItxExperimentExperiment
				.fromJsonArrayToItxExperimentExperiments(responseJson);
	...
	public void createFromJsonArray() throws Exception {
		...
		String responseJson = response.getContentAsString();
		logger.info(responseJson);
		Collection<ItxExperimentExperiment> results = ItxExperimentExperiment
				.fromJsonArrayToItxExperimentExperiments(responseJson);
